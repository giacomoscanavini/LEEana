...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-184.6154,-4.84,1353.846,535.2021);
   pad1->SetFillColor(0);
   ...
   hmc__13->SetBinContent(1,90.72551);
   hmc__13->SetBinContent(2,238.1819);
   hmc__13->SetBinContent(3,139.3397);
   hmc__13->SetBinContent(4,71.38399);
   hmc__13->SetBinContent(5,41.60232);
   hmc__13->SetBinContent(6,25.4062);
   hmc__13->SetBinContent(7,14.9046);
   hmc__13->SetBinContent(8,12.64464);
   hmc__13->SetBinContent(9,8.676987);
   hmc__13->SetBinContent(10,8.939147);
   hmc__13->SetBinContent(11,5.927767);
   hmc__13->SetBinContent(12,6.44593);
   hmc__13->SetBinContent(13,59.76479);
   hmc__13->SetBinError(1,38.23778);
   hmc__13->SetBinError(2,117.7023);
   hmc__13->SetBinError(3,58.87826);
   hmc__13->SetBinError(4,26.7209);
   hmc__13->SetBinError(5,16.99747);
   hmc__13->SetBinError(6,14.51042);
   hmc__13->SetBinError(7,12.19442);
   hmc__13->SetBinError(8,7.844838);
   hmc__13->SetBinError(9,5.300141);
   hmc__13->SetBinError(10,6.627215);
   hmc__13->SetBinError(11,5.25249);
   hmc__13->SetBinError(12,5.942972);
   hmc__13->SetBinError(13,25.82075);
   hmc__13->SetMinimum(-4.84);
   hmc__13->SetMaximum(508.2);
   ...
   hs5_stack_5->SetMaximum(250.091);
   ...
   hbadmatch_stack_1->SetBinContent(1,3.224964);
   hbadmatch_stack_1->SetBinContent(2,5.353628);
   hbadmatch_stack_1->SetBinContent(3,2.391523);
   hbadmatch_stack_1->SetBinContent(4,1.5966);
   hbadmatch_stack_1->SetBinContent(5,0.5526793);
   hbadmatch_stack_1->SetBinContent(6,0.3824354);
   hbadmatch_stack_1->SetBinContent(7,0.9658955);
   hbadmatch_stack_1->SetBinContent(8,0.4232006);
   hbadmatch_stack_1->SetBinContent(9,0.1326562);
   hbadmatch_stack_1->SetBinContent(10,0.5268296);
   hbadmatch_stack_1->SetBinContent(12,0.6386516);
   hbadmatch_stack_1->SetBinContent(13,1.268811);
   hbadmatch_stack_1->SetBinError(1,0.9619872);
   hbadmatch_stack_1->SetBinError(2,1.165594);
   hbadmatch_stack_1->SetBinError(3,0.7191209);
   hbadmatch_stack_1->SetBinError(4,0.5510715);
   hbadmatch_stack_1->SetBinError(5,0.2846486);
   hbadmatch_stack_1->SetBinError(6,0.3824122);
   hbadmatch_stack_1->SetBinError(7,0.5594415);
   hbadmatch_stack_1->SetBinError(8,0.4232007);
   hbadmatch_stack_1->SetBinError(9,0.1326562);
   hbadmatch_stack_1->SetBinError(10,0.4313337);
   ...
   houtFV_stack_4->SetBinContent(1,2.914051);
   houtFV_stack_4->SetBinContent(2,4.320372);
   houtFV_stack_4->SetBinContent(3,5.228333);
   houtFV_stack_4->SetBinContent(4,3.597281);
   houtFV_stack_4->SetBinContent(5,1.797875);
   houtFV_stack_4->SetBinContent(6,1.46456);
   houtFV_stack_4->SetBinContent(7,0.8662646);
   houtFV_stack_4->SetBinContent(9,0.8753801);
   houtFV_stack_4->SetBinContent(10,0.4672679);
   houtFV_stack_4->SetBinContent(11,0.536893);
   houtFV_stack_4->SetBinContent(12,0.7968029);
   houtFV_stack_4->SetBinContent(13,4.384538);
   houtFV_stack_4->SetBinError(1,0.8663784);
   houtFV_stack_4->SetBinError(2,1.023686);
   houtFV_stack_4->SetBinError(3,1.09652);
   houtFV_stack_4->SetBinError(4,0.9686161);
   houtFV_stack_4->SetBinError(5,0.6254446);
   houtFV_stack_4->SetBinError(6,0.5577402);
   houtFV_stack_4->SetBinError(7,0.4590341);
   houtFV_stack_4->SetBinError(9,0.5191111);
   houtFV_stack_4->SetBinError(10,0.2871168);
   houtFV_stack_4->SetBinError(11,0.3929602);
   houtFV_stack_4->SetBinError(12,0.5167767);
   houtFV_stack_4->SetBinError(13,1.05326);
   ...
   hNCpi0inFVcoh_stack_5->SetBinContent(3,0.2825219);
   ...
   hNCpi0inFVcoh_stack_5->SetBinContent(13,0.05583043);
   hNCpi0inFVcoh_stack_5->SetBinError(1,0.04315819);
   hNCpi0inFVcoh_stack_5->SetBinError(3,0.1997732);
   ...
   hNCpi0inFVcoh_stack_5->SetBinError(13,0.04192405);
   ...
   hNCpi0inFVqe_stack_6->SetBinContent(1,0.6314518);
   hNCpi0inFVqe_stack_6->SetBinContent(2,1.044933);
   hNCpi0inFVqe_stack_6->SetBinContent(3,0.3933662);
   hNCpi0inFVqe_stack_6->SetBinContent(4,0.81883);
   hNCpi0inFVqe_stack_6->SetBinContent(5,0.06358271);
   hNCpi0inFVqe_stack_6->SetBinContent(6,0.01841896);
   hNCpi0inFVqe_stack_6->SetBinContent(7,0.03635368);
   hNCpi0inFVqe_stack_6->SetBinContent(9,0.02862678);
   hNCpi0inFVqe_stack_6->SetBinContent(10,0.05203545);
   hNCpi0inFVqe_stack_6->SetBinContent(12,0.03635368);
   hNCpi0inFVqe_stack_6->SetBinContent(13,0.08393472);
   hNCpi0inFVqe_stack_6->SetBinError(1,0.1574263);
   hNCpi0inFVqe_stack_6->SetBinError(2,0.3088073);
   hNCpi0inFVqe_stack_6->SetBinError(3,0.1572925);
   hNCpi0inFVqe_stack_6->SetBinError(4,0.3145237);
   hNCpi0inFVqe_stack_6->SetBinError(5,0.06358271);
   hNCpi0inFVqe_stack_6->SetBinError(6,0.01841896);
   hNCpi0inFVqe_stack_6->SetBinError(7,0.03635368);
   hNCpi0inFVqe_stack_6->SetBinError(9,0.02862678);
   hNCpi0inFVqe_stack_6->SetBinError(10,0.05203545);
   hNCpi0inFVqe_stack_6->SetBinError(12,0.03635368);
   hNCpi0inFVqe_stack_6->SetBinError(13,0.06813276);
   ...
   hNCpi0inFVres_stack_7->SetBinContent(1,31.63124);
   hNCpi0inFVres_stack_7->SetBinContent(2,106.5213);
   hNCpi0inFVres_stack_7->SetBinContent(3,59.7061);
   hNCpi0inFVres_stack_7->SetBinContent(4,21.45498);
   hNCpi0inFVres_stack_7->SetBinContent(5,10.87962);
   hNCpi0inFVres_stack_7->SetBinContent(6,5.365734);
   hNCpi0inFVres_stack_7->SetBinContent(7,3.302541);
   hNCpi0inFVres_stack_7->SetBinContent(8,2.228799);
   hNCpi0inFVres_stack_7->SetBinContent(9,2.083882);
   hNCpi0inFVres_stack_7->SetBinContent(10,1.511808);
   hNCpi0inFVres_stack_7->SetBinContent(11,1.700469);
   hNCpi0inFVres_stack_7->SetBinContent(12,1.188572);
   hNCpi0inFVres_stack_7->SetBinContent(13,15.95281);
   hNCpi0inFVres_stack_7->SetBinError(1,1.62177);
   hNCpi0inFVres_stack_7->SetBinError(2,2.878091);
   hNCpi0inFVres_stack_7->SetBinError(3,2.218989);
   hNCpi0inFVres_stack_7->SetBinError(4,1.43021);
   hNCpi0inFVres_stack_7->SetBinError(5,1.176885);
   hNCpi0inFVres_stack_7->SetBinError(6,0.7440654);
   hNCpi0inFVres_stack_7->SetBinError(7,0.6258617);
   hNCpi0inFVres_stack_7->SetBinError(8,0.4691199);
   hNCpi0inFVres_stack_7->SetBinError(9,0.5169435);
   hNCpi0inFVres_stack_7->SetBinError(10,0.4129104);
   hNCpi0inFVres_stack_7->SetBinError(11,0.453113);
   hNCpi0inFVres_stack_7->SetBinError(12,0.3574847);
   hNCpi0inFVres_stack_7->SetBinError(13,1.50515);
   ...
   hNCpi0inFVdis_stack_8->SetBinContent(1,7.268044);
   hNCpi0inFVdis_stack_8->SetBinContent(2,17.23065);
   hNCpi0inFVdis_stack_8->SetBinContent(3,10.08239);
   hNCpi0inFVdis_stack_8->SetBinContent(4,4.670125);
   hNCpi0inFVdis_stack_8->SetBinContent(5,3.000701);
   hNCpi0inFVdis_stack_8->SetBinContent(6,0.7479963);
   hNCpi0inFVdis_stack_8->SetBinContent(7,0.9529234);
   hNCpi0inFVdis_stack_8->SetBinContent(8,0.9136943);
   hNCpi0inFVdis_stack_8->SetBinContent(9,0.369955);
   hNCpi0inFVdis_stack_8->SetBinContent(10,0.3796176);
   hNCpi0inFVdis_stack_8->SetBinContent(11,0.1881204);
   hNCpi0inFVdis_stack_8->SetBinContent(12,0.7826027);
   hNCpi0inFVdis_stack_8->SetBinContent(13,4.341513);
   hNCpi0inFVdis_stack_8->SetBinError(1,0.8535853);
   hNCpi0inFVdis_stack_8->SetBinError(2,1.16822);
   hNCpi0inFVdis_stack_8->SetBinError(3,0.9523129);
   hNCpi0inFVdis_stack_8->SetBinError(4,0.7057871);
   hNCpi0inFVdis_stack_8->SetBinError(5,0.5771232);
   hNCpi0inFVdis_stack_8->SetBinError(6,0.2064278);
   hNCpi0inFVdis_stack_8->SetBinError(7,0.2827962);
   hNCpi0inFVdis_stack_8->SetBinError(8,0.2669722);
   hNCpi0inFVdis_stack_8->SetBinError(9,0.1236274);
   hNCpi0inFVdis_stack_8->SetBinError(10,0.1862135);
   hNCpi0inFVdis_stack_8->SetBinError(11,0.09933818);
   hNCpi0inFVdis_stack_8->SetBinError(12,0.3066472);
   hNCpi0inFVdis_stack_8->SetBinError(13,0.659841);
   ...
   hNCinFV_stack_11->SetBinContent(1,10.30062);
   hNCinFV_stack_11->SetBinContent(2,20.76981);
   hNCinFV_stack_11->SetBinContent(3,9.834644);
   hNCinFV_stack_11->SetBinContent(4,6.005632);
   hNCinFV_stack_11->SetBinContent(5,4.07379);
   hNCinFV_stack_11->SetBinContent(6,4.234466);
   hNCinFV_stack_11->SetBinContent(7,1.478448);
   hNCinFV_stack_11->SetBinContent(8,1.795917);
   hNCinFV_stack_11->SetBinContent(9,0.1950248);
   hNCinFV_stack_11->SetBinContent(10,1.67073);
   hNCinFV_stack_11->SetBinContent(11,0.8490856);
   hNCinFV_stack_11->SetBinContent(12,0.772487);
   hNCinFV_stack_11->SetBinContent(13,7.980768);
   hNCinFV_stack_11->SetBinError(1,1.553671);
   hNCinFV_stack_11->SetBinError(2,2.462209);
   hNCinFV_stack_11->SetBinError(3,1.503324);
   hNCinFV_stack_11->SetBinError(4,1.197699);
   hNCinFV_stack_11->SetBinError(5,0.9973802);
   hNCinFV_stack_11->SetBinError(6,1.227856);
   hNCinFV_stack_11->SetBinError(7,0.6502061);
   hNCinFV_stack_11->SetBinError(8,0.7036922);
   hNCinFV_stack_11->SetBinError(9,0.1950249);
   hNCinFV_stack_11->SetBinError(10,0.6124835);
   hNCinFV_stack_11->SetBinError(11,0.3865275);
   hNCinFV_stack_11->SetBinError(12,0.3863405);
   hNCinFV_stack_11->SetBinError(13,1.487253);
   ...
   hmcerror__14->SetBinContent(1,90.72551);
   hmcerror__14->SetBinContent(2,238.1819);
   hmcerror__14->SetBinContent(3,139.3397);
   hmcerror__14->SetBinContent(4,71.38399);
   hmcerror__14->SetBinContent(5,41.60232);
   hmcerror__14->SetBinContent(6,25.4062);
   hmcerror__14->SetBinContent(7,14.9046);
   hmcerror__14->SetBinContent(8,12.64464);
   hmcerror__14->SetBinContent(9,8.676987);
   hmcerror__14->SetBinContent(10,8.939147);
   hmcerror__14->SetBinContent(11,5.927767);
   hmcerror__14->SetBinContent(12,6.44593);
   hmcerror__14->SetBinContent(13,59.76479);
   hmcerror__14->SetBinError(1,38.23778);
   hmcerror__14->SetBinError(2,117.7023);
   hmcerror__14->SetBinError(3,58.87826);
   hmcerror__14->SetBinError(4,26.7209);
   hmcerror__14->SetBinError(5,16.99747);
   hmcerror__14->SetBinError(6,14.51042);
   hmcerror__14->SetBinError(7,12.19442);
   hmcerror__14->SetBinError(8,7.844838);
   hmcerror__14->SetBinError(9,5.300141);
   hmcerror__14->SetBinError(10,6.627215);
   hmcerror__14->SetBinError(11,5.25249);
   hmcerror__14->SetBinError(12,5.942972);
   hmcerror__14->SetBinError(13,25.82075);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=0.92#pm0.35","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hbadmatch_stack_1","Cosmic, 16.2","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("houtFV_stack_4","Out FV, 22.9","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  247.6","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVdis_stack_8","NC#pi^{0} DIS,  46.6","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 62.0","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3020->SetMinimum(0.1329085);
   Graph_Graph3020->SetMaximum(1.708695);
