...
// ------------>Primitives in pad: pad1
   ...
   hmc__10->SetBinContent(1,72.59366);
   hmc__10->SetBinContent(2,147.8019);
   hmc__10->SetBinContent(3,162.8435);
   hmc__10->SetBinContent(4,135.7555);
   hmc__10->SetBinContent(5,99.27817);
   hmc__10->SetBinContent(6,66.70978);
   hmc__10->SetBinContent(7,44.87015);
   hmc__10->SetBinContent(8,23.11601);
   hmc__10->SetBinContent(9,20.3569);
   hmc__10->SetBinContent(10,10.66741);
   hmc__10->SetBinContent(11,11.46537);
   hmc__10->SetBinContent(12,9.112807);
   hmc__10->SetBinContent(13,74.92854);
   hmc__10->SetBinError(1,20.48255);
   hmc__10->SetBinError(2,42.02205);
   hmc__10->SetBinError(3,43.75266);
   hmc__10->SetBinError(4,45.3005);
   hmc__10->SetBinError(5,33.38942);
   hmc__10->SetBinError(6,23.67782);
   hmc__10->SetBinError(7,19.17996);
   hmc__10->SetBinError(8,9.152902);
   hmc__10->SetBinError(9,10.22719);
   hmc__10->SetBinError(10,7.109705);
   hmc__10->SetBinError(11,9.191637);
   hmc__10->SetBinError(12,6.414382);
   hmc__10->SetBinError(13,31.80641);
   ...
   hs4_stack_4->SetMaximum(170.9857);
   ...
   hbadmatch_stack_1->SetBinContent(1,2.147361);
   hbadmatch_stack_1->SetBinContent(2,4.065645);
   hbadmatch_stack_1->SetBinContent(3,3.445745);
   hbadmatch_stack_1->SetBinContent(4,2.420204);
   hbadmatch_stack_1->SetBinContent(5,1.775122);
   hbadmatch_stack_1->SetBinContent(6,0.3917402);
   hbadmatch_stack_1->SetBinContent(7,0.128524);
   ...
   hbadmatch_stack_1->SetBinContent(12,0.5111141);
   hbadmatch_stack_1->SetBinContent(13,1.624383);
   hbadmatch_stack_1->SetBinError(1,1.041416);
   hbadmatch_stack_1->SetBinError(2,1.213593);
   hbadmatch_stack_1->SetBinError(3,0.9610319);
   hbadmatch_stack_1->SetBinError(4,0.8301647);
   hbadmatch_stack_1->SetBinError(5,0.737214);
   hbadmatch_stack_1->SetBinError(6,0.2770047);
   hbadmatch_stack_1->SetBinError(7,0.128524);
   ...
   hbadmatch_stack_1->SetBinError(12,0.415489);
   hbadmatch_stack_1->SetBinError(13,0.682276);
   ...
   houtFV_stack_4->SetBinContent(1,10.44237);
   houtFV_stack_4->SetBinContent(2,14.97952);
   houtFV_stack_4->SetBinContent(3,9.049723);
   houtFV_stack_4->SetBinContent(4,5.074288);
   houtFV_stack_4->SetBinContent(5,3.797226);
   houtFV_stack_4->SetBinContent(6,4.333995);
   houtFV_stack_4->SetBinContent(7,3.319567);
   houtFV_stack_4->SetBinContent(8,1.422127);
   houtFV_stack_4->SetBinContent(9,1.779275);
   houtFV_stack_4->SetBinContent(10,0.5577985);
   houtFV_stack_4->SetBinContent(11,0.4918894);
   houtFV_stack_4->SetBinContent(12,1.993307);
   houtFV_stack_4->SetBinContent(13,4.281634);
   houtFV_stack_4->SetBinError(1,1.630737);
   houtFV_stack_4->SetBinError(2,1.90267);
   houtFV_stack_4->SetBinError(3,1.530517);
   houtFV_stack_4->SetBinError(4,1.04533);
   houtFV_stack_4->SetBinError(5,0.9152237);
   houtFV_stack_4->SetBinError(6,1.046766);
   houtFV_stack_4->SetBinError(7,0.8557093);
   houtFV_stack_4->SetBinError(8,0.5825024);
   houtFV_stack_4->SetBinError(9,0.7517215);
   houtFV_stack_4->SetBinError(10,0.301677);
   houtFV_stack_4->SetBinError(11,0.3547177);
   houtFV_stack_4->SetBinError(12,0.7843784);
   houtFV_stack_4->SetBinError(13,1.072885);
   ...
   hNCpi0inFVcoh_stack_5->SetBinContent(1,1.716003);
   hNCpi0inFVcoh_stack_5->SetBinContent(2,7.178644);
   hNCpi0inFVcoh_stack_5->SetBinContent(3,14.06554);
   hNCpi0inFVcoh_stack_5->SetBinContent(4,13.97949);
   hNCpi0inFVcoh_stack_5->SetBinContent(5,9.309078);
   hNCpi0inFVcoh_stack_5->SetBinContent(6,4.966927);
   hNCpi0inFVcoh_stack_5->SetBinContent(7,4.054883);
   hNCpi0inFVcoh_stack_5->SetBinContent(8,2.450972);
   hNCpi0inFVcoh_stack_5->SetBinContent(9,1.446843);
   hNCpi0inFVcoh_stack_5->SetBinContent(10,0.9876288);
   hNCpi0inFVcoh_stack_5->SetBinContent(11,0.4735437);
   hNCpi0inFVcoh_stack_5->SetBinContent(12,0.8350519);
   hNCpi0inFVcoh_stack_5->SetBinContent(13,7.11155);
   hNCpi0inFVcoh_stack_5->SetBinError(1,0.461282);
   hNCpi0inFVcoh_stack_5->SetBinError(2,1.029399);
   hNCpi0inFVcoh_stack_5->SetBinError(3,1.410187);
   hNCpi0inFVcoh_stack_5->SetBinError(4,1.422634);
   hNCpi0inFVcoh_stack_5->SetBinError(5,1.111735);
   hNCpi0inFVcoh_stack_5->SetBinError(6,0.8216275);
   hNCpi0inFVcoh_stack_5->SetBinError(7,0.9384325);
   hNCpi0inFVcoh_stack_5->SetBinError(8,0.6255149);
   hNCpi0inFVcoh_stack_5->SetBinError(9,0.444494);
   hNCpi0inFVcoh_stack_5->SetBinError(10,0.383663);
   hNCpi0inFVcoh_stack_5->SetBinError(11,0.175126);
   hNCpi0inFVcoh_stack_5->SetBinError(12,0.2837393);
   hNCpi0inFVcoh_stack_5->SetBinError(13,0.9365817);
   ...
   hNCpi0inFVqe_stack_6->SetBinContent(1,0.1297738);
   hNCpi0inFVqe_stack_6->SetBinContent(2,0.3584316);
   hNCpi0inFVqe_stack_6->SetBinContent(3,0.592944);
   hNCpi0inFVqe_stack_6->SetBinContent(4,0.1012553);
   hNCpi0inFVqe_stack_6->SetBinContent(5,0.08044619);
   hNCpi0inFVqe_stack_6->SetBinContent(6,0.2496527);
   hNCpi0inFVqe_stack_6->SetBinContent(7,0.2683149);
   hNCpi0inFVqe_stack_6->SetBinContent(8,0.03507804);
   hNCpi0inFVqe_stack_6->SetBinContent(11,0.08308727);
   hNCpi0inFVqe_stack_6->SetBinContent(13,0.06996304);
   hNCpi0inFVqe_stack_6->SetBinError(1,0.05673131);
   hNCpi0inFVqe_stack_6->SetBinError(2,0.1527533);
   hNCpi0inFVqe_stack_6->SetBinError(3,0.2269494);
   hNCpi0inFVqe_stack_6->SetBinError(4,0.04407832);
   hNCpi0inFVqe_stack_6->SetBinError(5,0.05427844);
   hNCpi0inFVqe_stack_6->SetBinError(6,0.1435485);
   hNCpi0inFVqe_stack_6->SetBinError(7,0.2198664);
   hNCpi0inFVqe_stack_6->SetBinError(8,0.02482773);
   hNCpi0inFVqe_stack_6->SetBinError(11,0.08308727);
   hNCpi0inFVqe_stack_6->SetBinError(13,0.03840464);
   ...
   hNCpi0inFVres_stack_7->SetBinContent(1,15.88709);
   hNCpi0inFVres_stack_7->SetBinContent(2,43.88522);
   hNCpi0inFVres_stack_7->SetBinContent(3,66.57881);
   hNCpi0inFVres_stack_7->SetBinContent(4,58.60507);
   hNCpi0inFVres_stack_7->SetBinContent(5,34.44867);
   hNCpi0inFVres_stack_7->SetBinContent(6,23.4656);
   hNCpi0inFVres_stack_7->SetBinContent(7,16.92317);
   hNCpi0inFVres_stack_7->SetBinContent(8,7.247415);
   hNCpi0inFVres_stack_7->SetBinContent(9,7.671455);
   hNCpi0inFVres_stack_7->SetBinContent(10,3.254081);
   hNCpi0inFVres_stack_7->SetBinContent(11,3.393143);
   hNCpi0inFVres_stack_7->SetBinContent(12,2.024523);
   hNCpi0inFVres_stack_7->SetBinContent(13,22.66926);
   hNCpi0inFVres_stack_7->SetBinError(1,1.347134);
   hNCpi0inFVres_stack_7->SetBinError(2,2.198739);
   hNCpi0inFVres_stack_7->SetBinError(3,2.920153);
   hNCpi0inFVres_stack_7->SetBinError(4,2.716889);
   hNCpi0inFVres_stack_7->SetBinError(5,1.80364);
   hNCpi0inFVres_stack_7->SetBinError(6,1.532269);
   hNCpi0inFVres_stack_7->SetBinError(7,1.627941);
   hNCpi0inFVres_stack_7->SetBinError(8,0.8531077);
   hNCpi0inFVres_stack_7->SetBinError(9,1.020951);
   hNCpi0inFVres_stack_7->SetBinError(10,0.5525818);
   hNCpi0inFVres_stack_7->SetBinError(11,0.5751333);
   hNCpi0inFVres_stack_7->SetBinError(12,0.3774326);
   hNCpi0inFVres_stack_7->SetBinError(13,1.831767);
   ...
   hNCpi0inFVdis_stack_8->SetBinContent(1,4.597693);
   hNCpi0inFVdis_stack_8->SetBinContent(2,11.9006);
   hNCpi0inFVdis_stack_8->SetBinContent(3,12.10267);
   hNCpi0inFVdis_stack_8->SetBinContent(4,12.3008);
   hNCpi0inFVdis_stack_8->SetBinContent(5,9.051688);
   hNCpi0inFVdis_stack_8->SetBinContent(6,8.533779);
   hNCpi0inFVdis_stack_8->SetBinContent(7,4.880382);
   hNCpi0inFVdis_stack_8->SetBinContent(8,3.088988);
   hNCpi0inFVdis_stack_8->SetBinContent(9,2.180334);
   hNCpi0inFVdis_stack_8->SetBinContent(10,1.005176);
   hNCpi0inFVdis_stack_8->SetBinContent(11,1.628961);
   hNCpi0inFVdis_stack_8->SetBinContent(12,1.276615);
   hNCpi0inFVdis_stack_8->SetBinContent(13,7.466909);
   hNCpi0inFVdis_stack_8->SetBinError(1,0.7176207);
   hNCpi0inFVdis_stack_8->SetBinError(2,1.069635);
   hNCpi0inFVdis_stack_8->SetBinError(3,1.269709);
   hNCpi0inFVdis_stack_8->SetBinError(4,1.16937);
   hNCpi0inFVdis_stack_8->SetBinError(5,0.9581406);
   hNCpi0inFVdis_stack_8->SetBinError(6,1.078975);
   hNCpi0inFVdis_stack_8->SetBinError(7,0.8851386);
   hNCpi0inFVdis_stack_8->SetBinError(8,0.6682113);
   hNCpi0inFVdis_stack_8->SetBinError(9,0.6062186);
   hNCpi0inFVdis_stack_8->SetBinError(10,0.2307559);
   hNCpi0inFVdis_stack_8->SetBinError(11,0.5082163);
   hNCpi0inFVdis_stack_8->SetBinError(12,0.4417857);
   hNCpi0inFVdis_stack_8->SetBinError(13,0.9948796);
   ...
   hNCinFV_stack_11->SetBinContent(1,7.455959);
   hNCinFV_stack_11->SetBinContent(2,16.73365);
   hNCinFV_stack_11->SetBinContent(3,12.8881);
   hNCinFV_stack_11->SetBinContent(4,9.692206);
   hNCinFV_stack_11->SetBinContent(5,12.78868);
   hNCinFV_stack_11->SetBinContent(6,6.346388);
   hNCinFV_stack_11->SetBinContent(7,2.718984);
   hNCinFV_stack_11->SetBinContent(8,2.033149);
   hNCinFV_stack_11->SetBinContent(9,2.308185);
   hNCinFV_stack_11->SetBinContent(10,1.37309);
   hNCinFV_stack_11->SetBinContent(11,1.467217);
   hNCinFV_stack_11->SetBinContent(12,0.1950248);
   hNCinFV_stack_11->SetBinContent(13,5.549026);
   hNCinFV_stack_11->SetBinError(1,1.352451);
   hNCinFV_stack_11->SetBinError(2,2.335046);
   hNCinFV_stack_11->SetBinError(3,1.907754);
   hNCinFV_stack_11->SetBinError(4,1.633408);
   hNCinFV_stack_11->SetBinError(5,2.317739);
   hNCinFV_stack_11->SetBinError(6,1.214936);
   hNCinFV_stack_11->SetBinError(7,0.8613509);
   hNCinFV_stack_11->SetBinError(8,0.6594345);
   hNCinFV_stack_11->SetBinError(9,0.8112621);
   hNCinFV_stack_11->SetBinError(10,0.5981173);
   hNCinFV_stack_11->SetBinError(11,0.6214735);
   hNCinFV_stack_11->SetBinError(12,0.1950249);
   hNCinFV_stack_11->SetBinError(13,1.332104);
   ...
   hmcerror__11->SetBinContent(1,72.59366);
   hmcerror__11->SetBinContent(2,147.8019);
   hmcerror__11->SetBinContent(3,162.8435);
   hmcerror__11->SetBinContent(4,135.7555);
   hmcerror__11->SetBinContent(5,99.27817);
   hmcerror__11->SetBinContent(6,66.70978);
   hmcerror__11->SetBinContent(7,44.87015);
   hmcerror__11->SetBinContent(8,23.11601);
   hmcerror__11->SetBinContent(9,20.3569);
   hmcerror__11->SetBinContent(10,10.66741);
   hmcerror__11->SetBinContent(11,11.46537);
   hmcerror__11->SetBinContent(12,9.112807);
   hmcerror__11->SetBinContent(13,74.92854);
   hmcerror__11->SetBinError(1,20.48255);
   hmcerror__11->SetBinError(2,42.02205);
   hmcerror__11->SetBinError(3,43.75266);
   hmcerror__11->SetBinError(4,45.3005);
   hmcerror__11->SetBinError(5,33.38942);
   hmcerror__11->SetBinError(6,23.67782);
   hmcerror__11->SetBinError(7,19.17996);
   hmcerror__11->SetBinError(8,9.152902);
   hmcerror__11->SetBinError(9,10.22719);
   hmcerror__11->SetBinError(10,7.109705);
   hmcerror__11->SetBinError(11,9.191637);
   hmcerror__11->SetBinError(12,6.414382);
   hmcerror__11->SetBinError(13,31.80641);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=1.07#pm0.26","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVcoh_stack_5","NC#pi^{0} COH,  61.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  283.4","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVdis_stack_8","NC#pi^{0} DIS,  72.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 76.0","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3016->SetMinimum(0.1336942);
   Graph_Graph3016->SetMaximum(1.980515);
