...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinContent(1,71.71552);
   hmc__1->SetBinContent(2,59.8583);
   hmc__1->SetBinContent(3,58.17279);
   hmc__1->SetBinContent(4,54.25903);
   hmc__1->SetBinContent(5,58.67828);
   hmc__1->SetBinContent(6,57.36079);
   hmc__1->SetBinContent(7,49.9712);
   hmc__1->SetBinContent(8,61.09049);
   hmc__1->SetBinContent(9,76.32533);
   hmc__1->SetBinContent(10,76.499);
   hmc__1->SetBinContent(11,86.15666);
   hmc__1->SetBinContent(12,104.6468);
   hmc__1->SetBinContent(13,127.3321);
   hmc__1->SetBinContent(14,148.8665);
   hmc__1->SetBinContent(15,188.0977);
   hmc__1->SetBinContent(16,261.1981);
   hmc__1->SetBinContent(17,328.8232);
   hmc__1->SetBinContent(18,391.3398);
   hmc__1->SetBinContent(19,563.0567);
   hmc__1->SetBinContent(20,859.5571);
   hmc__1->SetBinError(1,23.77878);
   hmc__1->SetBinError(2,21.41531);
   hmc__1->SetBinError(3,22.07123);
   hmc__1->SetBinError(4,19.94461);
   hmc__1->SetBinError(5,21.65253);
   hmc__1->SetBinError(6,22.37943);
   hmc__1->SetBinError(7,18.0349);
   hmc__1->SetBinError(8,20.43586);
   hmc__1->SetBinError(9,24.1449);
   hmc__1->SetBinError(10,27.14378);
   hmc__1->SetBinError(11,27.22765);
   hmc__1->SetBinError(12,34.21974);
   hmc__1->SetBinError(13,38.6033);
   hmc__1->SetBinError(14,45.29686);
   hmc__1->SetBinError(15,55.35166);
   hmc__1->SetBinError(16,74.20738);
   hmc__1->SetBinError(17,99.52958);
   hmc__1->SetBinError(18,108.8733);
   hmc__1->SetBinError(19,135.7351);
   hmc__1->SetBinError(20,213.6417);
   hmc__1->SetBinError(21,0.3895343);
   hmc__1->SetMinimum(-17.19114);
   hmc__1->SetMaximum(1805.07);
   ...
   hs1_stack_1->SetMaximum(902.5351);
   ...
   hmcerror__2->SetBinContent(1,71.71552);
   hmcerror__2->SetBinContent(2,59.8583);
   hmcerror__2->SetBinContent(3,58.17279);
   hmcerror__2->SetBinContent(4,54.25903);
   hmcerror__2->SetBinContent(5,58.67828);
   hmcerror__2->SetBinContent(6,57.36079);
   hmcerror__2->SetBinContent(7,49.9712);
   hmcerror__2->SetBinContent(8,61.09049);
   hmcerror__2->SetBinContent(9,76.32533);
   hmcerror__2->SetBinContent(10,76.499);
   hmcerror__2->SetBinContent(11,86.15666);
   hmcerror__2->SetBinContent(12,104.6468);
   hmcerror__2->SetBinContent(13,127.3321);
   hmcerror__2->SetBinContent(14,148.8665);
   hmcerror__2->SetBinContent(15,188.0977);
   hmcerror__2->SetBinContent(16,261.1981);
   hmcerror__2->SetBinContent(17,328.8232);
   hmcerror__2->SetBinContent(18,391.3398);
   hmcerror__2->SetBinContent(19,563.0567);
   hmcerror__2->SetBinContent(20,859.5571);
   hmcerror__2->SetBinError(1,23.77878);
   hmcerror__2->SetBinError(2,21.41531);
   hmcerror__2->SetBinError(3,22.07123);
   hmcerror__2->SetBinError(4,19.94461);
   hmcerror__2->SetBinError(5,21.65253);
   hmcerror__2->SetBinError(6,22.37943);
   hmcerror__2->SetBinError(7,18.0349);
   hmcerror__2->SetBinError(8,20.43586);
   hmcerror__2->SetBinError(9,24.1449);
   hmcerror__2->SetBinError(10,27.14378);
   hmcerror__2->SetBinError(11,27.22765);
   hmcerror__2->SetBinError(12,34.21974);
   hmcerror__2->SetBinError(13,38.6033);
   hmcerror__2->SetBinError(14,45.29686);
   hmcerror__2->SetBinError(15,55.35166);
   hmcerror__2->SetBinError(16,74.20738);
   hmcerror__2->SetBinError(17,99.52958);
   hmcerror__2->SetBinError(18,108.8733);
   hmcerror__2->SetBinError(19,135.7351);
   hmcerror__2->SetBinError(20,213.6417);
   ...
   Graph_Graph3001->SetMinimum(37.68138);
   Graph_Graph3001->SetMaximum(910.2842);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3004->SetMinimum(0.6942494);
   Graph_Graph3004->SetMaximum(1.622884);
