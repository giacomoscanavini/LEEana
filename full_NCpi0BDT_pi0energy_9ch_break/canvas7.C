...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-184.6154,-12.19355,1353.846,1348.35);
   pad1->SetFillColor(0);
   ...
   TH1F *hmc__19 = new TH1F("hmc__19","NCpi0BDT_FC_Np_bnb_12_pi0_energy_all",20,0,1200);
   hmc__19->SetBinContent(1,32.25943);
   hmc__19->SetBinContent(2,181.7977);
   hmc__19->SetBinContent(3,494.4527);
   hmc__19->SetBinContent(4,609.6775);
   hmc__19->SetBinContent(5,450.9702);
   hmc__19->SetBinContent(6,292.8874);
   hmc__19->SetBinContent(7,220.8416);
   hmc__19->SetBinContent(8,154.003);
   hmc__19->SetBinContent(9,96.25777);
   hmc__19->SetBinContent(10,59.72469);
   hmc__19->SetBinContent(11,43.72098);
   hmc__19->SetBinContent(12,26.95542);
   hmc__19->SetBinContent(13,20.14871);
   hmc__19->SetBinContent(14,14.06456);
   hmc__19->SetBinContent(15,11.12385);
   hmc__19->SetBinContent(16,7.723914);
   hmc__19->SetBinContent(17,4.65522);
   hmc__19->SetBinContent(18,3.512641);
   hmc__19->SetBinContent(19,2.664618);
   hmc__19->SetBinContent(20,2.464885);
   hmc__19->SetBinContent(21,13.20452);
   hmc__19->SetBinError(1,7.970602);
   hmc__19->SetBinError(2,35.2827);
   hmc__19->SetBinError(3,101.1356);
   hmc__19->SetBinError(4,143.7081);
   hmc__19->SetBinError(5,119.5201);
   hmc__19->SetBinError(6,81.67761);
   hmc__19->SetBinError(7,61.03765);
   hmc__19->SetBinError(8,45.28147);
   hmc__19->SetBinError(9,28.989);
   hmc__19->SetBinError(10,17.92102);
   hmc__19->SetBinError(11,14.49997);
   hmc__19->SetBinError(12,8.349587);
   hmc__19->SetBinError(13,8.176414);
   hmc__19->SetBinError(14,5.931439);
   hmc__19->SetBinError(15,4.912256);
   hmc__19->SetBinError(16,4.468736);
   hmc__19->SetBinError(17,2.896935);
   hmc__19->SetBinError(18,2.556411);
   hmc__19->SetBinError(19,2.024473);
   hmc__19->SetBinError(20,1.749856);
   hmc__19->SetBinError(21,10.13916);
   hmc__19->SetMinimum(-12.19355);
   hmc__19->SetMaximum(1280.323);
   ...
   TH1F *hs7_stack_7 = new TH1F("hs7_stack_7","",20,0,1200);
   hs7_stack_7->SetMinimum(-1.150846e-08);
   hs7_stack_7->SetMaximum(640.1614);
   ...
   hext_stack_2->SetBinContent(1,8.000648);
   hext_stack_2->SetBinContent(2,22.90025);
   hext_stack_2->SetBinContent(3,45.48486);
   hext_stack_2->SetBinContent(4,40.76012);
   hext_stack_2->SetBinContent(5,30.78279);
   hext_stack_2->SetBinContent(6,12.37944);
   hext_stack_2->SetBinContent(7,8.489448);
   hext_stack_2->SetBinContent(8,7.359033);
   hext_stack_2->SetBinContent(9,8.698513);
   ...
   hext_stack_2->SetBinError(1,1.961378);
   hext_stack_2->SetBinError(2,3.177912);
   hext_stack_2->SetBinError(3,4.657647);
   hext_stack_2->SetBinError(4,4.513037);
   hext_stack_2->SetBinError(5,3.859022);
   hext_stack_2->SetBinError(6,2.3815);
   hext_stack_2->SetBinError(7,2.018023);
   hext_stack_2->SetBinError(8,1.853466);
   hext_stack_2->SetBinError(9,2.187977);
   ...
   hdirt_stack_3->SetBinContent(1,0.6447001);
   hdirt_stack_3->SetBinContent(2,1.897838);
   hdirt_stack_3->SetBinContent(3,2.798509);
   hdirt_stack_3->SetBinContent(4,3.585883);
   hdirt_stack_3->SetBinContent(5,1.47774);
   hdirt_stack_3->SetBinContent(6,0.3569671);
   hdirt_stack_3->SetBinContent(7,0.4762587);
   hdirt_stack_3->SetBinContent(11,0.2188956);
   hdirt_stack_3->SetBinError(1,0.3782924);
   hdirt_stack_3->SetBinError(2,0.678984);
   hdirt_stack_3->SetBinError(3,0.8558754);
   hdirt_stack_3->SetBinError(4,1.225645);
   hdirt_stack_3->SetBinError(5,0.6272311);
   ...
   TH1F *hmcerror__20 = new TH1F("hmcerror__20","NCpi0BDT_FC_Np_bnb_12_pi0_energy_all",20,0,1200);
   hmcerror__20->SetBinContent(1,32.25943);
   hmcerror__20->SetBinContent(2,181.7977);
   hmcerror__20->SetBinContent(3,494.4527);
   hmcerror__20->SetBinContent(4,609.6775);
   hmcerror__20->SetBinContent(5,450.9702);
   hmcerror__20->SetBinContent(6,292.8874);
   hmcerror__20->SetBinContent(7,220.8416);
   hmcerror__20->SetBinContent(8,154.003);
   hmcerror__20->SetBinContent(9,96.25777);
   hmcerror__20->SetBinContent(10,59.72469);
   hmcerror__20->SetBinContent(11,43.72098);
   hmcerror__20->SetBinContent(12,26.95542);
   hmcerror__20->SetBinContent(13,20.14871);
   hmcerror__20->SetBinContent(14,14.06456);
   hmcerror__20->SetBinContent(15,11.12385);
   hmcerror__20->SetBinContent(16,7.723914);
   hmcerror__20->SetBinContent(17,4.65522);
   hmcerror__20->SetBinContent(18,3.512641);
   hmcerror__20->SetBinContent(19,2.664618);
   hmcerror__20->SetBinContent(20,2.464885);
   hmcerror__20->SetBinContent(21,13.20452);
   hmcerror__20->SetBinError(1,7.970602);
   hmcerror__20->SetBinError(2,35.2827);
   hmcerror__20->SetBinError(3,101.1356);
   hmcerror__20->SetBinError(4,143.7081);
   hmcerror__20->SetBinError(5,119.5201);
   hmcerror__20->SetBinError(6,81.67761);
   hmcerror__20->SetBinError(7,61.03765);
   hmcerror__20->SetBinError(8,45.28147);
   hmcerror__20->SetBinError(9,28.989);
   hmcerror__20->SetBinError(10,17.92102);
   hmcerror__20->SetBinError(11,14.49997);
   hmcerror__20->SetBinError(12,8.349587);
   hmcerror__20->SetBinError(13,8.176414);
   hmcerror__20->SetBinError(14,5.931439);
   hmcerror__20->SetBinError(15,4.912256);
   hmcerror__20->SetBinError(16,4.468736);
   hmcerror__20->SetBinError(17,2.896935);
   hmcerror__20->SetBinError(18,2.556411);
   hmcerror__20->SetBinError(19,2.024473);
   hmcerror__20->SetBinError(20,1.749856);
   hmcerror__20->SetBinError(21,10.13916);
   ...
   Graph_Graph3025->SetMaximum(532.9692);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=9.1/20","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("","BNB Data, 2024.0","lp");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hext_stack_2","EXT, 188.1","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3026->GetXaxis()->SetTitle("#pi^{0} Total Energy [MeV]");
   ...
   Graph_Graph3028->SetMaximum(2.976675);
   ...
   TH1F *hist__21 = new TH1F("hist__21","NCpi0BDT_FC_Np_bnb_12_pi0_energy_all",20,0,1200);
