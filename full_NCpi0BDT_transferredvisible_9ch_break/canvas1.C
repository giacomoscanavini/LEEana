...
//=========  (Sun Jun  5 00:24:16 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hmc__1 = new TH1F("hmc__1","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   hmc__1->SetBinContent(2,13.02281);
   hmc__1->SetBinContent(3,350.1371);
   hmc__1->SetBinContent(4,796.8124);
   hmc__1->SetBinContent(5,946.6638);
   hmc__1->SetBinContent(6,966.2816);
   hmc__1->SetBinContent(7,880.015);
   hmc__1->SetBinContent(8,732.7663);
   hmc__1->SetBinContent(9,625.5494);
   hmc__1->SetBinContent(10,465.2771);
   hmc__1->SetBinContent(11,362.782);
   hmc__1->SetBinContent(12,266.5583);
   hmc__1->SetBinContent(13,199.871);
   hmc__1->SetBinContent(14,156.5103);
   hmc__1->SetBinContent(15,107.483);
   hmc__1->SetBinContent(16,77.23801);
   hmc__1->SetBinContent(17,68.55099);
   hmc__1->SetBinContent(18,51.15833);
   hmc__1->SetBinContent(19,38.60855);
   hmc__1->SetBinContent(20,30.49935);
   hmc__1->SetBinContent(21,128.8132);
   hmc__1->SetBinError(1,0.3895343);
   hmc__1->SetBinError(2,4.945153);
   hmc__1->SetBinError(3,71.45989);
   hmc__1->SetBinError(4,169.4398);
   hmc__1->SetBinError(5,193.7296);
   hmc__1->SetBinError(6,201.9227);
   hmc__1->SetBinError(7,184.8807);
   hmc__1->SetBinError(8,157.5215);
   hmc__1->SetBinError(9,136.3201);
   hmc__1->SetBinError(10,105.119);
   hmc__1->SetBinError(11,84.75379);
   hmc__1->SetBinError(12,65.66774);
   hmc__1->SetBinError(13,50.46204);
   hmc__1->SetBinError(14,44.98845);
   hmc__1->SetBinError(15,32.93937);
   hmc__1->SetBinError(16,24.22554);
   hmc__1->SetBinError(17,22.09941);
   hmc__1->SetBinError(18,20.04545);
   hmc__1->SetBinError(19,12.83823);
   hmc__1->SetBinError(20,14.50097);
   hmc__1->SetBinError(21,32.89216);
   hmc__1->SetMinimum(-19.32563);
   hmc__1->SetMaximum(2029.191);
   ...
   hs1_stack_1->SetMinimum(-5.916779e-09);
   hs1_stack_1->SetMaximum(1014.596);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   hext_stack_2->SetBinContent(2,2.592407);
   hext_stack_2->SetBinContent(3,86.82921);
   hext_stack_2->SetBinContent(4,124.4587);
   hext_stack_2->SetBinContent(5,122.8653);
   hext_stack_2->SetBinContent(6,86.48843);
   hext_stack_2->SetBinContent(7,74.15529);
   hext_stack_2->SetBinContent(8,49.07086);
   hext_stack_2->SetBinContent(9,47.22382);
   hext_stack_2->SetBinContent(10,29.51392);
   hext_stack_2->SetBinContent(11,31.991);
   hext_stack_2->SetBinContent(12,22.68558);
   hext_stack_2->SetBinContent(13,15.62783);
   hext_stack_2->SetBinContent(14,8.929177);
   hext_stack_2->SetBinContent(15,5.269787);
   hext_stack_2->SetBinContent(16,8.731644);
   hext_stack_2->SetBinContent(17,8.07844);
   hext_stack_2->SetBinContent(18,4.468179);
   hext_stack_2->SetBinContent(19,3.56119);
   hext_stack_2->SetBinContent(20,1.137595);
   hext_stack_2->SetBinContent(21,20.65977);
   hext_stack_2->SetBinError(2,1.085446);
   hext_stack_2->SetBinError(3,6.538505);
   hext_stack_2->SetBinError(4,7.552889);
   hext_stack_2->SetBinError(5,7.552852);
   hext_stack_2->SetBinError(6,6.215926);
   hext_stack_2->SetBinError(7,5.83372);
   hext_stack_2->SetBinError(8,4.8365);
   hext_stack_2->SetBinError(9,4.699116);
   hext_stack_2->SetBinError(10,3.696797);
   hext_stack_2->SetBinError(11,3.93117);
   hext_stack_2->SetBinError(12,3.374516);
   hext_stack_2->SetBinError(13,2.61897);
   hext_stack_2->SetBinError(14,1.88893);
   hext_stack_2->SetBinError(15,1.442273);
   hext_stack_2->SetBinError(16,2.029177);
   hext_stack_2->SetBinError(17,1.942156);
   hext_stack_2->SetBinError(18,1.297469);
   hext_stack_2->SetBinError(19,1.165664);
   hext_stack_2->SetBinError(20,0.6602113);
   hext_stack_2->SetBinError(21,3.218624);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   hdirt_stack_3->SetBinContent(2,0.15957);
   hdirt_stack_3->SetBinContent(3,12.42358);
   hdirt_stack_3->SetBinContent(4,17.07708);
   hdirt_stack_3->SetBinContent(5,12.59151);
   hdirt_stack_3->SetBinContent(6,9.467113);
   hdirt_stack_3->SetBinContent(7,6.41122);
   hdirt_stack_3->SetBinContent(8,5.445436);
   hdirt_stack_3->SetBinContent(9,2.995478);
   hdirt_stack_3->SetBinContent(10,3.569383);
   hdirt_stack_3->SetBinContent(11,0.9305139);
   hdirt_stack_3->SetBinContent(12,0.4244012);
   hdirt_stack_3->SetBinContent(14,0.6699317);
   ...
   hdirt_stack_3->SetBinError(3,1.932106);
   hdirt_stack_3->SetBinError(4,2.050028);
   hdirt_stack_3->SetBinError(5,1.871275);
   hdirt_stack_3->SetBinError(6,1.771897);
   hdirt_stack_3->SetBinError(7,1.294182);
   hdirt_stack_3->SetBinError(8,1.414481);
   hdirt_stack_3->SetBinError(9,0.9574338);
   hdirt_stack_3->SetBinError(10,1.392302);
   hdirt_stack_3->SetBinError(11,0.5107657);
   hdirt_stack_3->SetBinError(12,0.2451693);
   hdirt_stack_3->SetBinError(14,0.4395418);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVcoh_stack_5 = new TH1F("hNCpi0inFVcoh_stack_5","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVqe_stack_6 = new TH1F("hNCpi0inFVqe_stack_6","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVres_stack_7 = new TH1F("hNCpi0inFVres_stack_7","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVdis_stack_8 = new TH1F("hNCpi0inFVdis_stack_8","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVmec_stack_9 = new TH1F("hNCpi0inFVmec_stack_9","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVother_stack_10 = new TH1F("hNCpi0inFVother_stack_10","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hCCpi0inFV_stack_11 = new TH1F("hCCpi0inFV_stack_11","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hNCinFV_stack_12 = new TH1F("hNCinFV_stack_12","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hnumuCCinFV_stack_13 = new TH1F("hnumuCCinFV_stack_13","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hnueCCinFV_stack_14 = new TH1F("hnueCCinFV_stack_14","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   ...
   TH1F *hmcerror__2 = new TH1F("hmcerror__2","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
   hmcerror__2->SetBinContent(2,13.02281);
   hmcerror__2->SetBinContent(3,350.1371);
   hmcerror__2->SetBinContent(4,796.8124);
   hmcerror__2->SetBinContent(5,946.6638);
   hmcerror__2->SetBinContent(6,966.2816);
   hmcerror__2->SetBinContent(7,880.015);
   hmcerror__2->SetBinContent(8,732.7663);
   hmcerror__2->SetBinContent(9,625.5494);
   hmcerror__2->SetBinContent(10,465.2771);
   hmcerror__2->SetBinContent(11,362.782);
   hmcerror__2->SetBinContent(12,266.5583);
   hmcerror__2->SetBinContent(13,199.871);
   hmcerror__2->SetBinContent(14,156.5103);
   hmcerror__2->SetBinContent(15,107.483);
   hmcerror__2->SetBinContent(16,77.23801);
   hmcerror__2->SetBinContent(17,68.55099);
   hmcerror__2->SetBinContent(18,51.15833);
   hmcerror__2->SetBinContent(19,38.60855);
   hmcerror__2->SetBinContent(20,30.49935);
   hmcerror__2->SetBinContent(21,128.8132);
   hmcerror__2->SetBinError(1,0.3895343);
   hmcerror__2->SetBinError(2,4.945153);
   hmcerror__2->SetBinError(3,71.45989);
   hmcerror__2->SetBinError(4,169.4398);
   hmcerror__2->SetBinError(5,193.7296);
   hmcerror__2->SetBinError(6,201.9227);
   hmcerror__2->SetBinError(7,184.8807);
   hmcerror__2->SetBinError(8,157.5215);
   hmcerror__2->SetBinError(9,136.3201);
   hmcerror__2->SetBinError(10,105.119);
   hmcerror__2->SetBinError(11,84.75379);
   hmcerror__2->SetBinError(12,65.66774);
   hmcerror__2->SetBinError(13,50.46204);
   hmcerror__2->SetBinError(14,44.98845);
   hmcerror__2->SetBinError(15,32.93937);
   hmcerror__2->SetBinError(16,24.22554);
   hmcerror__2->SetBinError(17,22.09941);
   hmcerror__2->SetBinError(18,20.04545);
   hmcerror__2->SetBinError(19,12.83823);
   hmcerror__2->SetBinError(20,14.50097);
   hmcerror__2->SetBinError(21,32.89216);
   ...
   Graph_Graph3001->SetMaximum(1058.782);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hext_stack_2","EXT, 733.7","F");
   ...
   pt->SetLineWidth(2);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("NCpi0BDT_bnb_12_transferred_visible_all");
   pt->Draw();
   pad1->Modified();
   canvas1->cd();
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3002->GetXaxis()->SetTitle("Transferred Visible Energy [MeV]");
   ...
   Graph_Graph3004->SetMinimum(0.4417974);
   Graph_Graph3004->SetMaximum(10.95091);
   ...
   TH1F *hist__3 = new TH1F("hist__3","NCpi0BDT_bnb_12_transferred_visible_all",20,0,1500);
