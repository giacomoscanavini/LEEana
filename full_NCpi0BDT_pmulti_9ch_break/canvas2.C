...
// ------------>Primitives in pad: pad1
   ...
   hmc__4->SetBinContent(1,2878.377);
   hmc__4->SetBinContent(2,2033.921);
   hmc__4->SetBinContent(3,531.3887);
   hmc__4->SetBinContent(4,133.8584);
   hmc__4->SetBinContent(5,34.4797);
   hmc__4->SetBinContent(6,9.463362);
   hmc__4->SetBinError(1,617.3848);
   hmc__4->SetBinError(2,473.7802);
   hmc__4->SetBinError(3,147.9396);
   hmc__4->SetBinError(4,48.07214);
   hmc__4->SetBinError(5,17.31393);
   hmc__4->SetBinError(6,6.9139);
   ...
   hs2_stack_2->SetMaximum(3022.296);
   ...
   TH1F *hNCpi0inFVother_stack_10 = new TH1F("hNCpi0inFVother_stack_10","NCpi0BDT_FC_bnb_12_p_multi_all",5,0,5);
   ...
   TH1F *hCCpi0inFV_stack_11 = new TH1F("hCCpi0inFV_stack_11","NCpi0BDT_FC_bnb_12_p_multi_all",5,0,5);
   hCCpi0inFV_stack_11->SetBinContent(1,423.9973);
   ...
   hCCpi0inFV_stack_11->SetBinError(1,10.29146);
   ...
   TH1F *hNCinFV_stack_12 = new TH1F("hNCinFV_stack_12","NCpi0BDT_FC_bnb_12_p_multi_all",5,0,5);
   hNCinFV_stack_12->SetBinContent(1,130.2271);
   ...
   hNCinFV_stack_12->SetBinError(1,5.757067);
   ...
   TH1F *hnumuCCinFV_stack_13 = new TH1F("hnumuCCinFV_stack_13","NCpi0BDT_FC_bnb_12_p_multi_all",5,0,5);
   hnumuCCinFV_stack_13->SetBinContent(1,137.1568);
   ...
   hnumuCCinFV_stack_13->SetBinError(1,6.892714);
   ...
   TH1F *hnueCCinFV_stack_14 = new TH1F("hnueCCinFV_stack_14","NCpi0BDT_FC_bnb_12_p_multi_all",5,0,5);
   hnueCCinFV_stack_14->SetBinContent(1,27.95727);
   ...
   hnueCCinFV_stack_14->SetBinError(1,3.61003);
   ...
   hmcerror__5->SetBinContent(1,2878.377);
   hmcerror__5->SetBinContent(2,2033.921);
   hmcerror__5->SetBinContent(3,531.3887);
   hmcerror__5->SetBinContent(4,133.8584);
   hmcerror__5->SetBinContent(5,34.4797);
   hmcerror__5->SetBinContent(6,9.463362);
   hmcerror__5->SetBinError(1,617.3848);
   hmcerror__5->SetBinError(2,473.7802);
   hmcerror__5->SetBinError(3,147.9396);
   hmcerror__5->SetBinError(4,48.07214);
   hmcerror__5->SetBinError(5,17.31393);
   hmcerror__5->SetBinError(6,6.9139);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=0.89#pm0.19","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=9.3/5","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  2468.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hCCpi0inFV_stack_11","CC#pi^{0}, 837.0","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_12","NC Other, 270.7","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hnumuCCinFV_stack_13","CC Other, 374.5","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3008->SetMinimum(0.5333211);
   Graph_Graph3008->SetMaximum(1.085566);
