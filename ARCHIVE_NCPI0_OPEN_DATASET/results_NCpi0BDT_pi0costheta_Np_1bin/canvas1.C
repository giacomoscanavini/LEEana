...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.307692,-6.510254,1.25641,548.5746);
   pad1->SetFillColor(0);
   ...
   TH1F *hmc__1 = new TH1F("hmc__1","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hmc__1->SetBinContent(1,325.5127);
   hmc__1->SetBinError(1,67.66079);
   hmc__1->SetBinError(2,0.125509);
   hmc__1->SetMinimum(-6.510254);
   hmc__1->SetMaximum(520.8203);
   ...
   hs1_stack_1->SetMaximum(341.7883);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hbadmatch_stack_1->SetBinContent(1,7.851487);
   hbadmatch_stack_1->SetBinError(1,0.7636408);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hext_stack_2->SetBinContent(1,28.79518);
   hext_stack_2->SetBinError(1,2.16009);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hdirt_stack_3->SetBinContent(1,4.550302);
   hdirt_stack_3->SetBinError(1,0.4636014);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   houtFV_stack_4->SetBinContent(1,43.41844);
   houtFV_stack_4->SetBinError(1,1.540637);
   ...
   TH1F *hNCpi0inFV_stack_5 = new TH1F("hNCpi0inFV_stack_5","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hNCpi0inFV_stack_5->SetBinContent(1,155.4978);
   hNCpi0inFV_stack_5->SetBinError(1,2.901611);
   ...
   TH1F *hCCpi0inFV_stack_6 = new TH1F("hCCpi0inFV_stack_6","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hCCpi0inFV_stack_6->SetBinContent(1,53.54144);
   hCCpi0inFV_stack_6->SetBinError(1,1.70129);
   ...
   TH1F *hNCinFV_stack_7 = new TH1F("hNCinFV_stack_7","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hNCinFV_stack_7->SetBinContent(1,11.95663);
   hNCinFV_stack_7->SetBinError(1,0.7963243);
   ...
   TH1F *hnumuCCinFV_stack_8 = new TH1F("hnumuCCinFV_stack_8","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hnumuCCinFV_stack_8->SetBinContent(1,17.48592);
   hnumuCCinFV_stack_8->SetBinError(1,1.230902);
   ...
   TH1F *hnueCCinFV_stack_9 = new TH1F("hnueCCinFV_stack_9","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hnueCCinFV_stack_9->SetBinContent(1,2.415477);
   hnueCCinFV_stack_9->SetBinError(1,0.5764992);
   ...
   TH1F *hmcerror__2 = new TH1F("hmcerror__2","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
   hmcerror__2->SetBinContent(1,325.5127);
   hmcerror__2->SetBinError(1,67.66079);
   ...
   Graph_Graph3001->SetMinimum(285.0086);
   Graph_Graph3001->SetMaximum(326.9914);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=0.08/1","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3004->SetMinimum(0.8755682);
   Graph_Graph3004->SetMaximum(1.004543);
   ...
   TH1F *hist__3 = new TH1F("hist__3","NCpi0BDT_0p_bnb_10_pi0_costheta_all",1,-1,1);
