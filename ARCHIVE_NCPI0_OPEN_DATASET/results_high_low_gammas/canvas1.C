...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinError(1,2.491469);
   hmc__1->SetBinError(2,3.698232);
   hmc__1->SetBinError(3,7.202341);
   hmc__1->SetBinError(4,12.65254);
   hmc__1->SetBinError(5,13.94644);
   hmc__1->SetBinError(6,15.41488);
   hmc__1->SetBinError(7,18.30944);
   hmc__1->SetBinError(8,13.41796);
   hmc__1->SetBinError(9,11.04149);
   hmc__1->SetBinError(10,10.40717);
   hmc__1->SetBinError(11,8.784121);
   hmc__1->SetBinError(12,8.408493);
   hmc__1->SetBinError(13,6.065454);
   hmc__1->SetBinError(14,5.791001);
   hmc__1->SetBinError(15,4.602356);
   hmc__1->SetBinError(16,3.961347);
   hmc__1->SetBinError(17,3.30599);
   hmc__1->SetBinError(18,3.742087);
   hmc__1->SetBinError(19,3.076935);
   hmc__1->SetBinError(20,2.538921);
   hmc__1->SetBinError(21,2.951048);
   hmc__1->SetBinError(22,1.55836);
   hmc__1->SetBinError(23,1.62879);
   hmc__1->SetBinError(24,2.120698);
   hmc__1->SetBinError(25,4.744919);
   ...
   hmcerror__2->SetBinError(1,2.491469);
   hmcerror__2->SetBinError(2,3.698232);
   hmcerror__2->SetBinError(3,7.202341);
   hmcerror__2->SetBinError(4,12.65254);
   hmcerror__2->SetBinError(5,13.94644);
   hmcerror__2->SetBinError(6,15.41488);
   hmcerror__2->SetBinError(7,18.30944);
   hmcerror__2->SetBinError(8,13.41796);
   hmcerror__2->SetBinError(9,11.04149);
   hmcerror__2->SetBinError(10,10.40717);
   hmcerror__2->SetBinError(11,8.784121);
   hmcerror__2->SetBinError(12,8.408493);
   hmcerror__2->SetBinError(13,6.065454);
   hmcerror__2->SetBinError(14,5.791001);
   hmcerror__2->SetBinError(15,4.602356);
   hmcerror__2->SetBinError(16,3.961347);
   hmcerror__2->SetBinError(17,3.30599);
   hmcerror__2->SetBinError(18,3.742087);
   hmcerror__2->SetBinError(19,3.076935);
   hmcerror__2->SetBinError(20,2.538921);
   hmcerror__2->SetBinError(21,2.951048);
   hmcerror__2->SetBinError(22,1.55836);
   hmcerror__2->SetBinError(23,1.62879);
   hmcerror__2->SetBinError(24,2.120698);
   hmcerror__2->SetBinError(25,4.744919);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=14.24/24","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
