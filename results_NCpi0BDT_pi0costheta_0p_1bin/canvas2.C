...
//=========  (Fri Apr  8 13:07:45 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.307692,-6.110502,1.25641,514.8902);
   pad1->SetFillColor(0);
   ...
   TH1F *hmc__4 = new TH1F("hmc__4","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hmc__4->SetBinContent(1,305.5251);
   hmc__4->SetBinError(1,67.83488);
   hmc__4->SetBinError(2,0.125509);
   hmc__4->SetMinimum(-6.110502);
   hmc__4->SetMaximum(488.8402);
   ...
   TH1F *hs2_stack_2 = new TH1F("hs2_stack_2","",1,-1,1);
   hs2_stack_2->SetMinimum(0);
   hs2_stack_2->SetMaximum(320.8014);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hbadmatch_stack_1->SetBinContent(1,5.881529);
   hbadmatch_stack_1->SetBinError(1,0.6516832);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hext_stack_2->SetBinContent(1,18.95731);
   hext_stack_2->SetBinError(1,1.801122);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hdirt_stack_3->SetBinContent(1,1.571374);
   hdirt_stack_3->SetBinError(1,0.372753);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   houtFV_stack_4->SetBinContent(1,19.68428);
   houtFV_stack_4->SetBinError(1,1.045345);
   ...
   TH1F *hNCpi0inFV_stack_5 = new TH1F("hNCpi0inFV_stack_5","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hNCpi0inFV_stack_5->SetBinContent(1,165.0872);
   hNCpi0inFV_stack_5->SetBinError(1,2.980325);
   ...
   TH1F *hCCpi0inFV_stack_6 = new TH1F("hCCpi0inFV_stack_6","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hCCpi0inFV_stack_6->SetBinContent(1,50.81395);
   hCCpi0inFV_stack_6->SetBinError(1,1.666136);
   ...
   TH1F *hNCinFV_stack_7 = new TH1F("hNCinFV_stack_7","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hNCinFV_stack_7->SetBinContent(1,13.78421);
   hNCinFV_stack_7->SetBinError(1,0.8600744);
   ...
   TH1F *hnumuCCinFV_stack_8 = new TH1F("hnumuCCinFV_stack_8","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hnumuCCinFV_stack_8->SetBinContent(1,28.56123);
   hnumuCCinFV_stack_8->SetBinError(1,1.588861);
   ...
   TH1F *hnueCCinFV_stack_9 = new TH1F("hnueCCinFV_stack_9","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hnueCCinFV_stack_9->SetBinContent(1,1.184008);
   hnueCCinFV_stack_9->SetBinError(1,0.2517912);
   ...
   TH1F *hmcerror__5 = new TH1F("hmcerror__5","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hmcerror__5->SetBinContent(1,305.5251);
   hmcerror__5->SetBinError(1,67.83488);
   ...
   Graph_Graph3005->SetMinimum(190.6934);
   Graph_Graph3005->SetMaximum(225.3066);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=1.94/1","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3008->SetMinimum(0.6241495);
   Graph_Graph3008->SetMaximum(0.7374407);
   ...
   TH1F *hist__6 = new TH1F("hist__6","NCpi0BDT_Np_bnb_10_pi0_costheta_all",1,-1,1);
