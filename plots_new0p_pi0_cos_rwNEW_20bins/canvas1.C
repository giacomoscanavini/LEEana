...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.307692,-28.56839,1.25641,3159.062);
   pad1->SetFillColor(0);
   ...
   hmc__1->SetBinContent(1,216.3358);
   hmc__1->SetBinContent(2,175.1373);
   hmc__1->SetBinContent(3,160.3127);
   hmc__1->SetBinContent(4,153.4906);
   hmc__1->SetBinContent(5,157.6904);
   hmc__1->SetBinContent(6,163.3582);
   hmc__1->SetBinContent(7,148.6641);
   hmc__1->SetBinContent(8,162.7453);
   hmc__1->SetBinContent(9,191.8333);
   hmc__1->SetBinContent(10,208.6673);
   hmc__1->SetBinContent(11,231.2776);
   hmc__1->SetBinContent(12,256.0867);
   hmc__1->SetBinContent(13,284.5935);
   hmc__1->SetBinContent(14,316.5192);
   hmc__1->SetBinContent(15,373.437);
   hmc__1->SetBinContent(16,473.0031);
   hmc__1->SetBinContent(17,591.5845);
   hmc__1->SetBinContent(18,700.8833);
   hmc__1->SetBinContent(19,940.2661);
   hmc__1->SetBinContent(20,1428.419);
   hmc__1->SetBinError(1,56.75546);
   hmc__1->SetBinError(2,53.284);
   hmc__1->SetBinError(3,44.88224);
   hmc__1->SetBinError(4,48.8567);
   hmc__1->SetBinError(5,45.29171);
   hmc__1->SetBinError(6,42.79109);
   hmc__1->SetBinError(7,45.7361);
   hmc__1->SetBinError(8,47.0553);
   hmc__1->SetBinError(9,55.57641);
   hmc__1->SetBinError(10,56.90796);
   hmc__1->SetBinError(11,63.00935);
   hmc__1->SetBinError(12,71.23816);
   hmc__1->SetBinError(13,79.92094);
   hmc__1->SetBinError(14,90.0366);
   hmc__1->SetBinError(15,107.0525);
   hmc__1->SetBinError(16,135.7892);
   hmc__1->SetBinError(17,163.1383);
   hmc__1->SetBinError(18,183.8875);
   hmc__1->SetBinError(19,227.8131);
   hmc__1->SetBinError(20,336.8306);
   hmc__1->SetBinError(21,0.3895343);
   hmc__1->SetMinimum(-28.56839);
   hmc__1->SetMaximum(2999.681);
   ...
   hs1_stack_1->SetMaximum(1499.84);
   ...
   hext_stack_2->SetBinContent(1,14.509);
   hext_stack_2->SetBinContent(2,13.21418);
   hext_stack_2->SetBinContent(3,11.68158);
   hext_stack_2->SetBinContent(4,13.91205);
   hext_stack_2->SetBinContent(5,13.20259);
   hext_stack_2->SetBinContent(6,21.19165);
   hext_stack_2->SetBinContent(7,13.938);
   hext_stack_2->SetBinContent(8,16.60379);
   hext_stack_2->SetBinContent(9,27.23438);
   hext_stack_2->SetBinContent(10,27.19684);
   hext_stack_2->SetBinContent(11,27.56873);
   hext_stack_2->SetBinContent(12,28.56668);
   hext_stack_2->SetBinContent(13,33.53638);
   hext_stack_2->SetBinContent(14,32.06885);
   hext_stack_2->SetBinContent(15,35.93126);
   hext_stack_2->SetBinContent(16,46.41345);
   hext_stack_2->SetBinContent(17,48.12041);
   hext_stack_2->SetBinContent(18,51.31418);
   hext_stack_2->SetBinContent(19,64.35791);
   hext_stack_2->SetBinContent(20,74.27068);
   hext_stack_2->SetBinError(1,2.481097);
   hext_stack_2->SetBinError(2,2.323485);
   hext_stack_2->SetBinError(3,2.175156);
   hext_stack_2->SetBinError(4,2.517702);
   hext_stack_2->SetBinError(5,2.337662);
   hext_stack_2->SetBinError(6,3.062311);
   hext_stack_2->SetBinError(7,2.422879);
   hext_stack_2->SetBinError(8,2.615029);
   hext_stack_2->SetBinError(9,3.36586);
   hext_stack_2->SetBinError(10,3.444354);
   hext_stack_2->SetBinError(11,3.301019);
   hext_stack_2->SetBinError(12,3.589168);
   hext_stack_2->SetBinError(13,3.730565);
   hext_stack_2->SetBinError(14,3.748153);
   hext_stack_2->SetBinError(15,3.955352);
   hext_stack_2->SetBinError(16,4.481553);
   hext_stack_2->SetBinError(17,4.509351);
   hext_stack_2->SetBinError(18,4.632988);
   hext_stack_2->SetBinError(19,5.112379);
   hext_stack_2->SetBinError(20,5.665005);
   ...
   hmcerror__2->SetBinContent(1,216.3358);
   hmcerror__2->SetBinContent(2,175.1373);
   hmcerror__2->SetBinContent(3,160.3127);
   hmcerror__2->SetBinContent(4,153.4906);
   hmcerror__2->SetBinContent(5,157.6904);
   hmcerror__2->SetBinContent(6,163.3582);
   hmcerror__2->SetBinContent(7,148.6641);
   hmcerror__2->SetBinContent(8,162.7453);
   hmcerror__2->SetBinContent(9,191.8333);
   hmcerror__2->SetBinContent(10,208.6673);
   hmcerror__2->SetBinContent(11,231.2776);
   hmcerror__2->SetBinContent(12,256.0867);
   hmcerror__2->SetBinContent(13,284.5935);
   hmcerror__2->SetBinContent(14,316.5192);
   hmcerror__2->SetBinContent(15,373.437);
   hmcerror__2->SetBinContent(16,473.0031);
   hmcerror__2->SetBinContent(17,591.5845);
   hmcerror__2->SetBinContent(18,700.8833);
   hmcerror__2->SetBinContent(19,940.2661);
   hmcerror__2->SetBinContent(20,1428.419);
   hmcerror__2->SetBinError(1,56.75546);
   hmcerror__2->SetBinError(2,53.284);
   hmcerror__2->SetBinError(3,44.88224);
   hmcerror__2->SetBinError(4,48.8567);
   hmcerror__2->SetBinError(5,45.29171);
   hmcerror__2->SetBinError(6,42.79109);
   hmcerror__2->SetBinError(7,45.7361);
   hmcerror__2->SetBinError(8,47.0553);
   hmcerror__2->SetBinError(9,55.57641);
   hmcerror__2->SetBinError(10,56.90796);
   hmcerror__2->SetBinError(11,63.00935);
   hmcerror__2->SetBinError(12,71.23816);
   hmcerror__2->SetBinError(13,79.92094);
   hmcerror__2->SetBinError(14,90.0366);
   hmcerror__2->SetBinError(15,107.0525);
   hmcerror__2->SetBinError(16,135.7892);
   hmcerror__2->SetBinError(17,163.1383);
   hmcerror__2->SetBinError(18,183.8875);
   hmcerror__2->SetBinError(19,227.8131);
   hmcerror__2->SetBinError(20,336.8306);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3004->SetMinimum(0.6507115);
   Graph_Graph3004->SetMaximum(1.230394);
