...
//=========  (Thu Jun  2 18:07:18 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hmc__4 = new TH1F("hmc__4","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   hmc__4->SetBinContent(19,27.83144);
   hmc__4->SetBinContent(20,21.05034);
   hmc__4->SetBinContent(21,89.81636);
   hmc__4->SetBinError(1,0.3895343);
   hmc__4->SetBinError(2,0.2222744);
   hmc__4->SetBinError(3,7.20054);
   hmc__4->SetBinError(4,35.60717);
   hmc__4->SetBinError(5,71.65924);
   hmc__4->SetBinError(6,102.3426);
   hmc__4->SetBinError(7,105.1964);
   hmc__4->SetBinError(8,98.82491);
   hmc__4->SetBinError(9,93.04933);
   hmc__4->SetBinError(10,72.91498);
   hmc__4->SetBinError(11,63.19327);
   hmc__4->SetBinError(12,46.15127);
   hmc__4->SetBinError(13,40.4767);
   hmc__4->SetBinError(14,30.69185);
   hmc__4->SetBinError(15,25.61279);
   hmc__4->SetBinError(16,19.75941);
   hmc__4->SetBinError(17,17.55074);
   hmc__4->SetBinError(18,15.36909);
   hmc__4->SetBinError(19,10.26724);
   hmc__4->SetBinError(20,10.16577);
   hmc__4->SetBinError(21,28.39001);
   hmc__4->SetMinimum(-8.735665);
   hmc__4->SetMaximum(917.2448);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   hext_stack_2->SetBinContent(3,0.4247338);
   hext_stack_2->SetBinContent(4,1.184374);
   hext_stack_2->SetBinContent(5,3.577902);
   hext_stack_2->SetBinContent(6,3.181329);
   hext_stack_2->SetBinContent(7,2.41108);
   hext_stack_2->SetBinContent(8,2.13641);
   hext_stack_2->SetBinContent(9,0.9099599);
   hext_stack_2->SetBinContent(10,1.180891);
   hext_stack_2->SetBinContent(11,0.2188956);
   hext_stack_2->SetBinContent(14,0.2761429);
   hext_stack_2->SetBinContent(18,0.1380715);
   hext_stack_2->SetBinContent(19,0.3381872);
   hext_stack_2->SetBinError(3,0.4247338);
   hext_stack_2->SetBinError(4,0.4939299);
   hext_stack_2->SetBinError(5,0.9787727);
   hext_stack_2->SetBinError(6,1.216167);
   hext_stack_2->SetBinError(7,0.7385812);
   hext_stack_2->SetBinError(8,0.7405108);
   hext_stack_2->SetBinError(9,0.5081362);
   hext_stack_2->SetBinError(10,0.6116823);
   hext_stack_2->SetBinError(11,0.2188956);
   hext_stack_2->SetBinError(14,0.1952625);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   hdirt_stack_3->SetBinContent(3,1.379791);
   hdirt_stack_3->SetBinContent(4,21.8652);
   hdirt_stack_3->SetBinContent(5,34.29649);
   hdirt_stack_3->SetBinContent(6,26.19329);
   hdirt_stack_3->SetBinContent(7,32.28944);
   hdirt_stack_3->SetBinContent(8,24.09132);
   hdirt_stack_3->SetBinContent(9,27.70599);
   hdirt_stack_3->SetBinContent(10,17.03074);
   hdirt_stack_3->SetBinContent(11,21.47297);
   hdirt_stack_3->SetBinContent(12,19.8438);
   hdirt_stack_3->SetBinContent(13,9.820168);
   hdirt_stack_3->SetBinContent(14,5.191995);
   hdirt_stack_3->SetBinContent(15,2.759582);
   hdirt_stack_3->SetBinContent(16,6.538654);
   hdirt_stack_3->SetBinContent(17,3.083979);
   hdirt_stack_3->SetBinContent(18,2.923985);
   hdirt_stack_3->SetBinContent(19,2.587998);
   hdirt_stack_3->SetBinContent(20,0.7309963);
   hdirt_stack_3->SetBinContent(21,17.08699);
   hdirt_stack_3->SetBinError(3,0.6935586);
   hdirt_stack_3->SetBinError(4,3.355282);
   hdirt_stack_3->SetBinError(5,4.162079);
   hdirt_stack_3->SetBinError(6,3.446917);
   hdirt_stack_3->SetBinError(7,4.003475);
   hdirt_stack_3->SetBinError(8,3.376374);
   hdirt_stack_3->SetBinError(9,3.691011);
   hdirt_stack_3->SetBinError(10,2.922034);
   hdirt_stack_3->SetBinError(11,3.269585);
   hdirt_stack_3->SetBinError(12,3.219506);
   hdirt_stack_3->SetBinError(13,1.95542);
   hdirt_stack_3->SetBinError(14,1.468055);
   hdirt_stack_3->SetBinError(15,0.98084);
   hdirt_stack_3->SetBinError(16,1.818211);
   hdirt_stack_3->SetBinError(17,1.033093);
   hdirt_stack_3->SetBinError(18,1.040301);
   hdirt_stack_3->SetBinError(19,1.021308);
   hdirt_stack_3->SetBinError(20,0.5201503);
   hdirt_stack_3->SetBinError(21,3.011121);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVcoh_stack_5 = new TH1F("hNCpi0inFVcoh_stack_5","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVqe_stack_6 = new TH1F("hNCpi0inFVqe_stack_6","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVres_stack_7 = new TH1F("hNCpi0inFVres_stack_7","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVdis_stack_8 = new TH1F("hNCpi0inFVdis_stack_8","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVmec_stack_9 = new TH1F("hNCpi0inFVmec_stack_9","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVother_stack_10 = new TH1F("hNCpi0inFVother_stack_10","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hCCpi0inFV_stack_11 = new TH1F("hCCpi0inFV_stack_11","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCinFV_stack_12 = new TH1F("hNCinFV_stack_12","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hnumuCCinFV_stack_13 = new TH1F("hnumuCCinFV_stack_13","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hnueCCinFV_stack_14 = new TH1F("hnueCCinFV_stack_14","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hmcerror__5 = new TH1F("hmcerror__5","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   hmcerror__5->SetBinContent(19,27.83144);
   hmcerror__5->SetBinContent(20,21.05034);
   hmcerror__5->SetBinContent(21,89.81636);
   hmcerror__5->SetBinError(1,0.3895343);
   hmcerror__5->SetBinError(2,0.2222744);
   hmcerror__5->SetBinError(3,7.20054);
   hmcerror__5->SetBinError(4,35.60717);
   hmcerror__5->SetBinError(5,71.65924);
   hmcerror__5->SetBinError(6,102.3426);
   hmcerror__5->SetBinError(7,105.1964);
   hmcerror__5->SetBinError(8,98.82491);
   hmcerror__5->SetBinError(9,93.04933);
   hmcerror__5->SetBinError(10,72.91498);
   hmcerror__5->SetBinError(11,63.19327);
   hmcerror__5->SetBinError(12,46.15127);
   hmcerror__5->SetBinError(13,40.4767);
   hmcerror__5->SetBinError(14,30.69185);
   hmcerror__5->SetBinError(15,25.61279);
   hmcerror__5->SetBinError(16,19.75941);
   hmcerror__5->SetBinError(17,17.55074);
   hmcerror__5->SetBinError(18,15.36909);
   hmcerror__5->SetBinError(19,10.26724);
   hmcerror__5->SetBinError(20,10.16577);
   hmcerror__5->SetBinError(21,28.39001);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hdirt_stack_3","Dirt, 259.8","F");
   ...
   pt->SetLineWidth(2);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("NCpi0BDT_Np_bnb_12_corrected_visible_energy_all");
   pt->Draw();
   pad1->Modified();
   canvas2->cd();
...
// ------------>Primitives in pad: pad2
   ...
   TH1F *hist__6 = new TH1F("hist__6","NCpi0BDT_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
