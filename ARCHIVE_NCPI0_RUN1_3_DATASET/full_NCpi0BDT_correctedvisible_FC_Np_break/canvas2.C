...
//=========  (Thu Jun  2 17:40:33 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hmc__4 = new TH1F("hmc__4","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   hmc__4->SetBinContent(3,18.38057);
   hmc__4->SetBinContent(4,123.759);
   hmc__4->SetBinContent(5,265.9851);
   hmc__4->SetBinContent(6,355.1314);
   hmc__4->SetBinContent(7,369.3515);
   hmc__4->SetBinContent(8,325.6635);
   hmc__4->SetBinContent(9,297.3157);
   hmc__4->SetBinContent(10,229.5107);
   hmc__4->SetBinContent(11,188.4933);
   hmc__4->SetBinContent(12,136.4703);
   hmc__4->SetBinContent(13,102.3822);
   hmc__4->SetBinContent(14,83.09233);
   hmc__4->SetBinContent(15,54.21477);
   hmc__4->SetBinContent(16,44.81942);
   hmc__4->SetBinContent(17,35.21712);
   hmc__4->SetBinContent(18,29.93476);
   hmc__4->SetBinContent(19,18.46378);
   hmc__4->SetBinContent(20,16.08291);
   hmc__4->SetBinContent(21,48.84295);
   hmc__4->SetBinError(1,0.3895343);
   hmc__4->SetBinError(2,0.3895343);
   hmc__4->SetBinError(3,5.881207);
   hmc__4->SetBinError(4,30.40408);
   hmc__4->SetBinError(5,60.72344);
   hmc__4->SetBinError(6,87.0378);
   hmc__4->SetBinError(7,90.56668);
   hmc__4->SetBinError(8,82.18397);
   hmc__4->SetBinError(9,75.3152);
   hmc__4->SetBinError(10,60.61406);
   hmc__4->SetBinError(11,51.65811);
   hmc__4->SetBinError(12,37.06803);
   hmc__4->SetBinError(13,30.9408);
   hmc__4->SetBinError(14,24.49809);
   hmc__4->SetBinError(15,20.24515);
   hmc__4->SetBinError(16,16.04723);
   hmc__4->SetBinError(17,13.77452);
   hmc__4->SetBinError(18,11.16426);
   hmc__4->SetBinError(19,7.495432);
   hmc__4->SetBinError(20,8.546613);
   hmc__4->SetBinError(21,19.86179);
   hmc__4->SetMinimum(-7.387029);
   hmc__4->SetMaximum(775.6381);
   ...
   hs2_stack_2->SetMaximum(387.819);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   hext_stack_2->SetBinContent(3,0.4247338);
   hext_stack_2->SetBinContent(4,0.9220302);
   hext_stack_2->SetBinContent(5,2.746344);
   hext_stack_2->SetBinContent(6,2.581139);
   hext_stack_2->SetBinContent(7,1.759581);
   hext_stack_2->SetBinContent(8,1.39498);
   hext_stack_2->SetBinContent(9,0.4950385);
   hext_stack_2->SetBinContent(10,0.4377912);
   hext_stack_2->SetBinContent(11,0.2188956);
   hext_stack_2->SetBinContent(14,0.1380715);
   hext_stack_2->SetBinContent(19,0.3381872);
   hext_stack_2->SetBinError(3,0.4247338);
   hext_stack_2->SetBinError(4,0.4185005);
   hext_stack_2->SetBinError(5,0.8276296);
   hext_stack_2->SetBinError(6,1.13844);
   hext_stack_2->SetBinError(7,0.6595295);
   hext_stack_2->SetBinError(8,0.5880834);
   hext_stack_2->SetBinError(9,0.2933304);
   hext_stack_2->SetBinError(10,0.3095651);
   hext_stack_2->SetBinError(11,0.2188956);
   hext_stack_2->SetBinError(14,0.1380715);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   hdirt_stack_3->SetBinContent(3,1.379791);
   hdirt_stack_3->SetBinContent(4,11.01401);
   hdirt_stack_3->SetBinContent(5,27.34406);
   hdirt_stack_3->SetBinContent(6,20.94946);
   hdirt_stack_3->SetBinContent(7,27.10904);
   hdirt_stack_3->SetBinContent(8,19.47033);
   hdirt_stack_3->SetBinContent(9,18.5937);
   hdirt_stack_3->SetBinContent(10,10.25707);
   hdirt_stack_3->SetBinContent(11,16.77695);
   hdirt_stack_3->SetBinContent(12,9.772676);
   hdirt_stack_3->SetBinContent(13,6.578966);
   hdirt_stack_3->SetBinContent(14,3.088388);
   hdirt_stack_3->SetBinContent(15,2.028585);
   hdirt_stack_3->SetBinContent(16,4.352847);
   hdirt_stack_3->SetBinContent(17,0.7309963);
   hdirt_stack_3->SetBinContent(18,2.599588);
   hdirt_stack_3->SetBinContent(19,0.973192);
   hdirt_stack_3->SetBinContent(20,0.7309963);
   hdirt_stack_3->SetBinContent(21,4.677244);
   hdirt_stack_3->SetBinError(3,0.6935586);
   hdirt_stack_3->SetBinError(4,2.188177);
   hdirt_stack_3->SetBinError(5,3.748719);
   hdirt_stack_3->SetBinError(6,3.054931);
   hdirt_stack_3->SetBinError(7,3.715716);
   hdirt_stack_3->SetBinError(8,3.087105);
   hdirt_stack_3->SetBinError(9,2.978624);
   hdirt_stack_3->SetBinError(10,2.232945);
   hdirt_stack_3->SetBinError(11,2.925613);
   hdirt_stack_3->SetBinError(12,2.212635);
   hdirt_stack_3->SetBinError(13,1.560451);
   hdirt_stack_3->SetBinError(14,1.096541);
   hdirt_stack_3->SetBinError(15,0.8315593);
   hdirt_stack_3->SetBinError(16,1.514272);
   hdirt_stack_3->SetBinError(17,0.5201503);
   hdirt_stack_3->SetBinError(18,0.9884288);
   hdirt_stack_3->SetBinError(19,0.5618727);
   hdirt_stack_3->SetBinError(20,0.5201503);
   hdirt_stack_3->SetBinError(21,1.54863);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVcoh_stack_5 = new TH1F("hNCpi0inFVcoh_stack_5","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVqe_stack_6 = new TH1F("hNCpi0inFVqe_stack_6","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVres_stack_7 = new TH1F("hNCpi0inFVres_stack_7","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVdis_stack_8 = new TH1F("hNCpi0inFVdis_stack_8","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVmec_stack_9 = new TH1F("hNCpi0inFVmec_stack_9","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVother_stack_10 = new TH1F("hNCpi0inFVother_stack_10","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hCCpi0inFV_stack_11 = new TH1F("hCCpi0inFV_stack_11","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCinFV_stack_12 = new TH1F("hNCinFV_stack_12","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hnumuCCinFV_stack_13 = new TH1F("hnumuCCinFV_stack_13","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hnueCCinFV_stack_14 = new TH1F("hnueCCinFV_stack_14","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hmcerror__5 = new TH1F("hmcerror__5","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
   hmcerror__5->SetBinContent(3,18.38057);
   hmcerror__5->SetBinContent(4,123.759);
   hmcerror__5->SetBinContent(5,265.9851);
   hmcerror__5->SetBinContent(6,355.1314);
   hmcerror__5->SetBinContent(7,369.3515);
   hmcerror__5->SetBinContent(8,325.6635);
   hmcerror__5->SetBinContent(9,297.3157);
   hmcerror__5->SetBinContent(10,229.5107);
   hmcerror__5->SetBinContent(11,188.4933);
   hmcerror__5->SetBinContent(12,136.4703);
   hmcerror__5->SetBinContent(13,102.3822);
   hmcerror__5->SetBinContent(14,83.09233);
   hmcerror__5->SetBinContent(15,54.21477);
   hmcerror__5->SetBinContent(16,44.81942);
   hmcerror__5->SetBinContent(17,35.21712);
   hmcerror__5->SetBinContent(18,29.93476);
   hmcerror__5->SetBinContent(19,18.46378);
   hmcerror__5->SetBinContent(20,16.08291);
   hmcerror__5->SetBinContent(21,48.84295);
   hmcerror__5->SetBinError(1,0.3895343);
   hmcerror__5->SetBinError(2,0.3895343);
   hmcerror__5->SetBinError(3,5.881207);
   hmcerror__5->SetBinError(4,30.40408);
   hmcerror__5->SetBinError(5,60.72344);
   hmcerror__5->SetBinError(6,87.0378);
   hmcerror__5->SetBinError(7,90.56668);
   hmcerror__5->SetBinError(8,82.18397);
   hmcerror__5->SetBinError(9,75.3152);
   hmcerror__5->SetBinError(10,60.61406);
   hmcerror__5->SetBinError(11,51.65811);
   hmcerror__5->SetBinError(12,37.06803);
   hmcerror__5->SetBinError(13,30.9408);
   hmcerror__5->SetBinError(14,24.49809);
   hmcerror__5->SetBinError(15,20.24515);
   hmcerror__5->SetBinError(16,16.04723);
   hmcerror__5->SetBinError(17,13.77452);
   hmcerror__5->SetBinError(18,11.16426);
   hmcerror__5->SetBinError(19,7.495432);
   hmcerror__5->SetBinError(20,8.546613);
   hmcerror__5->SetBinError(21,19.86179);
   ...
   Graph_Graph3005->SetMaximum(334.3352);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hdirt_stack_3","Dirt, 183.8","F");
   ...
   pt->SetLineWidth(2);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all");
   pt->Draw();
   pad1->Modified();
   canvas2->cd();
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3008->SetMinimum(0.1223501);
   Graph_Graph3008->SetMaximum(10.98641);
   ...
   TH1F *hist__6 = new TH1F("hist__6","NCpi0BDT_FC_Np_bnb_12_corrected_visible_energy_all",20,0,1500);
