...
//=========  (Thu Jun  2 20:48:06 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hmc__1 = new TH1F("hmc__1","NCpi0BDT_0p_bnb_12_pi0_energy_all",20,0,1200);
   hmc__1->SetBinContent(1,23.90795);
   hmc__1->SetBinContent(2,171.2805);
   hmc__1->SetBinContent(3,594.533);
   hmc__1->SetBinContent(4,812.2406);
   hmc__1->SetBinContent(5,666.2184);
   hmc__1->SetBinContent(6,482.3256);
   hmc__1->SetBinContent(7,352.3173);
   hmc__1->SetBinContent(8,231.6505);
   hmc__1->SetBinContent(9,149.8015);
   hmc__1->SetBinContent(10,107.4681);
   hmc__1->SetBinContent(11,71.03204);
   hmc__1->SetBinContent(12,43.69177);
   hmc__1->SetBinContent(13,30.20955);
   hmc__1->SetBinContent(14,19.84194);
   hmc__1->SetBinContent(15,13.77467);
   hmc__1->SetBinContent(16,10.06423);
   hmc__1->SetBinContent(17,4.151111);
   hmc__1->SetBinContent(18,7.06076);
   hmc__1->SetBinContent(19,4.750748);
   hmc__1->SetBinContent(20,2.088168);
   hmc__1->SetBinContent(21,22.59269);
   hmc__1->SetBinError(1,9.024059);
   hmc__1->SetBinError(2,35.50235);
   hmc__1->SetBinError(3,124.3049);
   hmc__1->SetBinError(4,165.2073);
   hmc__1->SetBinError(5,136.4418);
   hmc__1->SetBinError(6,102.1552);
   hmc__1->SetBinError(7,73.8482);
   hmc__1->SetBinError(8,48.58591);
   hmc__1->SetBinError(9,32.44377);
   hmc__1->SetBinError(10,23.74218);
   hmc__1->SetBinError(11,16.2995);
   hmc__1->SetBinError(12,11.87208);
   hmc__1->SetBinError(13,9.659617);
   hmc__1->SetBinError(14,5.48168);
   hmc__1->SetBinError(15,4.930307);
   hmc__1->SetBinError(16,5.672091);
   hmc__1->SetBinError(17,2.453901);
   hmc__1->SetBinError(18,3.177195);
   hmc__1->SetBinError(19,2.143253);
   hmc__1->SetBinError(20,1.921983);
   hmc__1->SetBinError(21,8.45098);
   hmc__1->SetMinimum(-17.24);
   hmc__1->SetMaximum(1810.2);
   ...
   hs1_stack_1->SetMaximum(852.8526);
   ...
   hext_stack_2->SetBinContent(1,0.8602919);
   hext_stack_2->SetBinContent(2,6.055994);
   hext_stack_2->SetBinContent(3,16.86231);
   hext_stack_2->SetBinContent(4,14.92624);
   hext_stack_2->SetBinContent(5,7.308882);
   hext_stack_2->SetBinContent(6,4.026556);
   hext_stack_2->SetBinContent(7,3.680526);
   hext_stack_2->SetBinContent(8,0.7028415);
   hext_stack_2->SetBinContent(9,1.298596);
   hext_stack_2->SetBinContent(10,1.330832);
   hext_stack_2->SetBinError(1,0.4684579);
   hext_stack_2->SetBinError(2,1.253017);
   hext_stack_2->SetBinError(3,2.119862);
   hext_stack_2->SetBinError(4,2.027609);
   hext_stack_2->SetBinError(5,1.419685);
   hext_stack_2->SetBinError(6,1.09428);
   hext_stack_2->SetBinError(7,1.270392);
   hext_stack_2->SetBinError(8,0.4537404);
   hext_stack_2->SetBinError(9,0.6867118);
   ...
   hdirt_stack_3->SetBinContent(1,8.235662);
   hdirt_stack_3->SetBinContent(2,38.86847);
   hdirt_stack_3->SetBinContent(3,117.9041);
   hdirt_stack_3->SetBinContent(4,121.5175);
   hdirt_stack_3->SetBinContent(5,78.61906);
   hdirt_stack_3->SetBinContent(6,47.17034);
   hdirt_stack_3->SetBinContent(7,28.79011);
   hdirt_stack_3->SetBinContent(8,13.09167);
   hdirt_stack_3->SetBinContent(9,8.407247);
   hdirt_stack_3->SetBinContent(10,7.467185);
   hdirt_stack_3->SetBinContent(11,3.636211);
   hdirt_stack_3->SetBinContent(13,1.137595);
   hdirt_stack_3->SetBinContent(14,0.4065989);
   hdirt_stack_3->SetBinContent(15,0.4065989);
   hdirt_stack_3->SetBinContent(18,0.3243973);
   hdirt_stack_3->SetBinContent(19,0.7309963);
   hdirt_stack_3->SetBinContent(21,0.7309963);
   hdirt_stack_3->SetBinError(1,2.023203);
   hdirt_stack_3->SetBinError(2,4.139131);
   hdirt_stack_3->SetBinError(3,7.234694);
   hdirt_stack_3->SetBinError(4,7.530116);
   hdirt_stack_3->SetBinError(5,5.964947);
   hdirt_stack_3->SetBinError(6,4.60617);
   hdirt_stack_3->SetBinError(7,3.63243);
   hdirt_stack_3->SetBinError(8,2.491863);
   hdirt_stack_3->SetBinError(9,2.003079);
   hdirt_stack_3->SetBinError(10,1.739811);
   hdirt_stack_3->SetBinError(11,1.272817);
   hdirt_stack_3->SetBinError(13,0.6602113);
   hdirt_stack_3->SetBinError(14,0.4065989);
   hdirt_stack_3->SetBinError(15,0.4065989);
   hdirt_stack_3->SetBinError(18,0.3243973);
   hdirt_stack_3->SetBinError(19,0.5201503);
   ...
   TH1F *hmcerror__2 = new TH1F("hmcerror__2","NCpi0BDT_0p_bnb_12_pi0_energy_all",20,0,1200);
   hmcerror__2->SetBinContent(1,23.90795);
   hmcerror__2->SetBinContent(2,171.2805);
   hmcerror__2->SetBinContent(3,594.533);
   hmcerror__2->SetBinContent(4,812.2406);
   hmcerror__2->SetBinContent(5,666.2184);
   hmcerror__2->SetBinContent(6,482.3256);
   hmcerror__2->SetBinContent(7,352.3173);
   hmcerror__2->SetBinContent(8,231.6505);
   hmcerror__2->SetBinContent(9,149.8015);
   hmcerror__2->SetBinContent(10,107.4681);
   hmcerror__2->SetBinContent(11,71.03204);
   hmcerror__2->SetBinContent(12,43.69177);
   hmcerror__2->SetBinContent(13,30.20955);
   hmcerror__2->SetBinContent(14,19.84194);
   hmcerror__2->SetBinContent(15,13.77467);
   hmcerror__2->SetBinContent(16,10.06423);
   hmcerror__2->SetBinContent(17,4.151111);
   hmcerror__2->SetBinContent(18,7.06076);
   hmcerror__2->SetBinContent(19,4.750748);
   hmcerror__2->SetBinContent(20,2.088168);
   hmcerror__2->SetBinContent(21,22.59269);
   hmcerror__2->SetBinError(1,9.024059);
   hmcerror__2->SetBinError(2,35.50235);
   hmcerror__2->SetBinError(3,124.3049);
   hmcerror__2->SetBinError(4,165.2073);
   hmcerror__2->SetBinError(5,136.4418);
   hmcerror__2->SetBinError(6,102.1552);
   hmcerror__2->SetBinError(7,73.8482);
   hmcerror__2->SetBinError(8,48.58591);
   hmcerror__2->SetBinError(9,32.44377);
   hmcerror__2->SetBinError(10,23.74218);
   hmcerror__2->SetBinError(11,16.2995);
   hmcerror__2->SetBinError(12,11.87208);
   hmcerror__2->SetBinError(13,9.659617);
   hmcerror__2->SetBinError(14,5.48168);
   hmcerror__2->SetBinError(15,4.930307);
   hmcerror__2->SetBinError(16,5.672091);
   hmcerror__2->SetBinError(17,2.453901);
   hmcerror__2->SetBinError(18,3.177195);
   hmcerror__2->SetBinError(19,2.143253);
   hmcerror__2->SetBinError(20,1.921983);
   hmcerror__2->SetBinError(21,8.45098);
   ...
   Graph_Graph3001->SetMaximum(980.3255);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hdirt_stack_3","Dirt, 476.7","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3004->SetMinimum(0.2170946);
   Graph_Graph3004->SetMaximum(3.144674);
   ...
   TH1F *hist__3 = new TH1F("hist__3","NCpi0BDT_0p_bnb_12_pi0_energy_all",20,0,1200);
