...
//=========  (Thu Jun  2 18:07:17 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hmc__1 = new TH1F("hmc__1","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   hmc__1->SetBinContent(2,12.99491);
   hmc__1->SetBinContent(3,328.0982);
   hmc__1->SetBinContent(4,636.9826);
   ...
   hmc__1->SetBinError(2,4.987236);
   hmc__1->SetBinError(3,66.44274);
   hmc__1->SetBinError(4,137.7198);
   hmc__1->SetBinError(5,130.8967);
   hmc__1->SetBinError(6,111.9376);
   hmc__1->SetBinError(7,88.16025);
   hmc__1->SetBinError(8,69.99473);
   hmc__1->SetBinError(9,53.04121);
   hmc__1->SetBinError(10,39.03212);
   hmc__1->SetBinError(11,30.51697);
   hmc__1->SetBinError(12,23.43417);
   hmc__1->SetBinError(13,16.46442);
   hmc__1->SetBinError(14,18.32957);
   hmc__1->SetBinError(15,11.37594);
   hmc__1->SetBinError(16,7.144145);
   hmc__1->SetBinError(17,7.644437);
   hmc__1->SetBinError(18,6.485959);
   hmc__1->SetBinError(19,6.688951);
   hmc__1->SetBinError(20,7.030968);
   hmc__1->SetBinError(21,10.65066);
   hmc__1->SetMinimum(-15.2);
   hmc__1->SetMaximum(1596);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   hext_stack_2->SetBinContent(2,0.15957);
   hext_stack_2->SetBinContent(3,11.99885);
   hext_stack_2->SetBinContent(4,15.8927);
   hext_stack_2->SetBinContent(5,9.01361);
   hext_stack_2->SetBinContent(6,6.285785);
   hext_stack_2->SetBinContent(7,4.000139);
   hext_stack_2->SetBinContent(8,3.309026);
   hext_stack_2->SetBinContent(9,2.085518);
   hext_stack_2->SetBinContent(10,2.388492);
   hext_stack_2->SetBinContent(11,0.7116182);
   ...
   hext_stack_2->SetBinError(3,1.884843);
   hext_stack_2->SetBinError(4,1.989635);
   hext_stack_2->SetBinError(5,1.59489);
   hext_stack_2->SetBinError(6,1.288626);
   hext_stack_2->SetBinError(7,1.062735);
   hext_stack_2->SetBinError(8,1.205156);
   hext_stack_2->SetBinError(9,0.811466);
   hext_stack_2->SetBinError(10,1.250739);
   hext_stack_2->SetBinError(11,0.4614828);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   hdirt_stack_3->SetBinContent(2,2.592407);
   hdirt_stack_3->SetBinContent(3,85.44942);
   hdirt_stack_3->SetBinContent(4,102.5935);
   hdirt_stack_3->SetBinContent(5,88.56886);
   hdirt_stack_3->SetBinContent(6,60.29514);
   hdirt_stack_3->SetBinContent(7,41.86584);
   hdirt_stack_3->SetBinContent(8,24.97954);
   hdirt_stack_3->SetBinContent(9,19.51782);
   hdirt_stack_3->SetBinContent(10,12.48319);
   hdirt_stack_3->SetBinContent(11,10.51803);
   hdirt_stack_3->SetBinContent(12,2.841783);
   hdirt_stack_3->SetBinContent(13,5.807659);
   hdirt_stack_3->SetBinContent(14,3.737183);
   hdirt_stack_3->SetBinContent(15,2.510206);
   hdirt_stack_3->SetBinContent(16,2.192989);
   hdirt_stack_3->SetBinContent(17,4.994461);
   hdirt_stack_3->SetBinContent(18,1.544194);
   hdirt_stack_3->SetBinContent(19,0.973192);
   hdirt_stack_3->SetBinContent(20,0.4065989);
   hdirt_stack_3->SetBinContent(21,3.57278);
   hdirt_stack_3->SetBinError(2,1.085446);
   hdirt_stack_3->SetBinError(3,6.501617);
   hdirt_stack_3->SetBinError(4,6.7667);
   hdirt_stack_3->SetBinError(5,6.302592);
   hdirt_stack_3->SetBinError(6,5.172668);
   hdirt_stack_3->SetBinError(7,4.243168);
   hdirt_stack_3->SetBinError(8,3.462923);
   hdirt_stack_3->SetBinError(9,2.908286);
   hdirt_stack_3->SetBinError(10,2.264515);
   hdirt_stack_3->SetBinError(11,2.182638);
   hdirt_stack_3->SetBinError(12,1.011007);
   hdirt_stack_3->SetBinError(13,1.742221);
   hdirt_stack_3->SetBinError(14,1.188642);
   hdirt_stack_3->SetBinError(15,1.057404);
   hdirt_stack_3->SetBinError(16,0.9009267);
   hdirt_stack_3->SetBinError(17,1.644594);
   hdirt_stack_3->SetBinError(18,0.7753719);
   hdirt_stack_3->SetBinError(19,0.5618727);
   hdirt_stack_3->SetBinError(20,0.4065989);
   hdirt_stack_3->SetBinError(21,1.136966);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVcoh_stack_5 = new TH1F("hNCpi0inFVcoh_stack_5","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVqe_stack_6 = new TH1F("hNCpi0inFVqe_stack_6","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVres_stack_7 = new TH1F("hNCpi0inFVres_stack_7","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVdis_stack_8 = new TH1F("hNCpi0inFVdis_stack_8","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVmec_stack_9 = new TH1F("hNCpi0inFVmec_stack_9","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCpi0inFVother_stack_10 = new TH1F("hNCpi0inFVother_stack_10","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hCCpi0inFV_stack_11 = new TH1F("hCCpi0inFV_stack_11","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hNCinFV_stack_12 = new TH1F("hNCinFV_stack_12","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hnumuCCinFV_stack_13 = new TH1F("hnumuCCinFV_stack_13","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hnueCCinFV_stack_14 = new TH1F("hnueCCinFV_stack_14","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   ...
   TH1F *hmcerror__2 = new TH1F("hmcerror__2","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
   hmcerror__2->SetBinContent(2,12.99491);
   hmcerror__2->SetBinContent(3,328.0982);
   hmcerror__2->SetBinContent(4,636.9826);
   ...
   hmcerror__2->SetBinError(2,4.987236);
   hmcerror__2->SetBinError(3,66.44274);
   hmcerror__2->SetBinError(4,137.7198);
   hmcerror__2->SetBinError(5,130.8967);
   hmcerror__2->SetBinError(6,111.9376);
   hmcerror__2->SetBinError(7,88.16025);
   hmcerror__2->SetBinError(8,69.99473);
   hmcerror__2->SetBinError(9,53.04121);
   hmcerror__2->SetBinError(10,39.03212);
   hmcerror__2->SetBinError(11,30.51697);
   hmcerror__2->SetBinError(12,23.43417);
   hmcerror__2->SetBinError(13,16.46442);
   hmcerror__2->SetBinError(14,18.32957);
   hmcerror__2->SetBinError(15,11.37594);
   hmcerror__2->SetBinError(16,7.144145);
   hmcerror__2->SetBinError(17,7.644437);
   hmcerror__2->SetBinError(18,6.485959);
   hmcerror__2->SetBinError(19,6.688951);
   hmcerror__2->SetBinError(20,7.030968);
   hmcerror__2->SetBinError(21,10.65066);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hdirt_stack_3","Dirt, 473.9","F");
   ...
   pt->SetLineWidth(2);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("NCpi0BDT_0p_bnb_12_corrected_visible_energy_all");
   pt->Draw();
   pad1->Modified();
   canvas1->cd();
...
// ------------>Primitives in pad: pad2
   ...
   TH1F *hist__3 = new TH1F("hist__3","NCpi0BDT_0p_bnb_12_corrected_visible_energy_all",20,0,1500);
