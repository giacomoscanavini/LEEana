...
//=========  (Sun Jun  5 00:36:30 2022) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinError(1,12.72123);
   hmc__1->SetBinError(2,70.29044);
   hmc__1->SetBinError(3,231.1089);
   hmc__1->SetBinError(4,312.5708);
   hmc__1->SetBinError(5,261.57);
   hmc__1->SetBinError(6,187.0686);
   hmc__1->SetBinError(7,135.9251);
   hmc__1->SetBinError(8,95.15302);
   hmc__1->SetBinError(9,62.88812);
   hmc__1->SetBinError(10,41.78754);
   hmc__1->SetBinError(11,31.65526);
   hmc__1->SetBinError(12,20.86335);
   hmc__1->SetBinError(13,16.22673);
   hmc__1->SetBinError(14,10.25138);
   hmc__1->SetBinError(15,9.119678);
   hmc__1->SetBinError(16,10.45473);
   hmc__1->SetBinError(17,7.048768);
   hmc__1->SetBinError(18,4.924511);
   hmc__1->SetBinError(19,2.839491);
   hmc__1->SetBinError(20,2.77763);
   hmc__1->SetBinError(21,12.92999);
   ...
   hext_stack_2->SetBinContent(1,16.64291);
   hext_stack_2->SetBinContent(2,69.99279);
   hext_stack_2->SetBinContent(3,180.4616);
   hext_stack_2->SetBinContent(4,174.5115);
   hext_stack_2->SetBinContent(5,124.3102);
   hext_stack_2->SetBinContent(6,71.0829);
   hext_stack_2->SetBinContent(7,44.95858);
   hext_stack_2->SetBinContent(8,21.05484);
   hext_stack_2->SetBinContent(9,21.74987);
   hext_stack_2->SetBinContent(10,12.32319);
   hext_stack_2->SetBinContent(11,4.367208);
   ...
   hext_stack_2->SetBinError(1,2.847047);
   hext_stack_2->SetBinError(2,5.602764);
   hext_stack_2->SetBinError(3,9.138037);
   hext_stack_2->SetBinError(4,9.074923);
   hext_stack_2->SetBinError(5,7.637108);
   hext_stack_2->SetBinError(6,5.735758);
   hext_stack_2->SetBinError(7,4.546692);
   hext_stack_2->SetBinError(8,3.043112);
   hext_stack_2->SetBinError(9,3.444925);
   hext_stack_2->SetBinError(10,2.267812);
   hext_stack_2->SetBinError(11,1.374998);
   ...
   hmcerror__2->SetBinError(1,12.72123);
   hmcerror__2->SetBinError(2,70.29044);
   hmcerror__2->SetBinError(3,231.1089);
   hmcerror__2->SetBinError(4,312.5708);
   hmcerror__2->SetBinError(5,261.57);
   hmcerror__2->SetBinError(6,187.0686);
   hmcerror__2->SetBinError(7,135.9251);
   hmcerror__2->SetBinError(8,95.15302);
   hmcerror__2->SetBinError(9,62.88812);
   hmcerror__2->SetBinError(10,41.78754);
   hmcerror__2->SetBinError(11,31.65526);
   hmcerror__2->SetBinError(12,20.86335);
   hmcerror__2->SetBinError(13,16.22673);
   hmcerror__2->SetBinError(14,10.25138);
   hmcerror__2->SetBinError(15,9.119678);
   hmcerror__2->SetBinError(16,10.45473);
   hmcerror__2->SetBinError(17,7.048768);
   hmcerror__2->SetBinError(18,4.924511);
   hmcerror__2->SetBinError(19,2.839491);
   hmcerror__2->SetBinError(20,2.77763);
   hmcerror__2->SetBinError(21,12.92999);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hext_stack_2","EXT, 747.1","F");
