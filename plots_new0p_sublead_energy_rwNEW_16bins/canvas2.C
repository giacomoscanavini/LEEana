...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-61.53846,-24.98976,451.2821,2763.341);
   pad1->SetFillColor(0);
   ...
   hmc__4->SetBinContent(1,908.9741);
   hmc__4->SetBinContent(2,1249.488);
   hmc__4->SetBinContent(3,1124.009);
   hmc__4->SetBinContent(4,839.4969);
   hmc__4->SetBinContent(5,586.3175);
   hmc__4->SetBinContent(6,356.6909);
   hmc__4->SetBinContent(7,226.1937);
   ...
   hmc__4->SetBinError(1,206.906);
   hmc__4->SetBinError(2,293.4429);
   hmc__4->SetBinError(3,276.7965);
   hmc__4->SetBinError(4,226.514);
   hmc__4->SetBinError(5,171.3867);
   hmc__4->SetBinError(6,114.9561);
   hmc__4->SetBinError(7,76.93079);
   hmc__4->SetBinError(8,55.82497);
   hmc__4->SetBinError(9,37.31723);
   hmc__4->SetBinError(10,21.99301);
   hmc__4->SetBinError(11,18.60802);
   hmc__4->SetBinError(12,13.19408);
   hmc__4->SetBinError(13,8.377817);
   hmc__4->SetBinError(14,7.831995);
   hmc__4->SetBinError(15,6.464901);
   hmc__4->SetBinError(16,4.321088);
   hmc__4->SetBinError(17,7.167351);
   hmc__4->SetMinimum(-24.98976);
   hmc__4->SetMaximum(2623.925);
   ...
   hs2_stack_2->SetMaximum(1311.962);
   ...
   hext_stack_2->SetBinContent(1,84.67615);
   hext_stack_2->SetBinContent(2,109.6222);
   hext_stack_2->SetBinContent(3,80.97934);
   hext_stack_2->SetBinContent(4,40.48605);
   hext_stack_2->SetBinContent(5,30.55061);
   hext_stack_2->SetBinContent(6,10.60742);
   hext_stack_2->SetBinContent(7,9.145422);
   ...
   hext_stack_2->SetBinError(1,6.093394);
   hext_stack_2->SetBinError(2,6.771332);
   hext_stack_2->SetBinError(3,5.789239);
   hext_stack_2->SetBinError(4,4.186102);
   hext_stack_2->SetBinError(5,3.602633);
   hext_stack_2->SetBinError(6,2.150068);
   hext_stack_2->SetBinError(7,2.020317);
   ...
   hmcerror__5->SetBinContent(1,908.9741);
   hmcerror__5->SetBinContent(2,1249.488);
   hmcerror__5->SetBinContent(3,1124.009);
   hmcerror__5->SetBinContent(4,839.4969);
   hmcerror__5->SetBinContent(5,586.3175);
   hmcerror__5->SetBinContent(6,356.6909);
   hmcerror__5->SetBinContent(7,226.1937);
   ...
   hmcerror__5->SetBinError(1,206.906);
   hmcerror__5->SetBinError(2,293.4429);
   hmcerror__5->SetBinError(3,276.7965);
   hmcerror__5->SetBinError(4,226.514);
   hmcerror__5->SetBinError(5,171.3867);
   hmcerror__5->SetBinError(6,114.9561);
   hmcerror__5->SetBinError(7,76.93079);
   hmcerror__5->SetBinError(8,55.82497);
   hmcerror__5->SetBinError(9,37.31723);
   hmcerror__5->SetBinError(10,21.99301);
   hmcerror__5->SetBinError(11,18.60802);
   hmcerror__5->SetBinError(12,13.19408);
   hmcerror__5->SetBinError(13,8.377817);
   hmcerror__5->SetBinError(14,7.831995);
   hmcerror__5->SetBinError(15,6.464901);
   hmcerror__5->SetBinError(16,4.321088);
   hmcerror__5->SetBinError(17,7.167351);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=3.4/16","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
