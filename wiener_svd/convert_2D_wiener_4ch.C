...
*/
void convert_2D_wiener_4ch(int RW=1, int nbin_mom=12, int nbin_cos=4){
  gStyle->SetOptStat(0);
  ...
  for (int i=0;i<nbin_cos;i++) {
    for (int j=0;j<nbin_mom;j++) {
      ...
      */
      ...
      std::cout << "Indexes = " << index1 << " " << index2 << " " << index3 << " " << index4 << " " << index5 << " " << index6 << " " << index7 << " " << index8 << " " << index9 << " " << index10 << " " << index11 << " " << index12 << std::endl;
