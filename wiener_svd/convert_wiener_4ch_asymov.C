...
*/
void convert_wiener_4ch_asymov(int RW=1){
  gStyle->SetOptStat(0);
  ...
  TH1F *hdata_obsch_1 = (TH1F*)file1->Get("histo_1"); // Asymov FC 0p
  TH1F *hdata_obsch_2 = (TH1F*)file1->Get("histo_2"); // Asymov FC Np
  TH1F *hdata_obsch_3 = (TH1F*)file1->Get("histo_3"); // Asymov PC 0p
  TH1F *hdata_obsch_4 = (TH1F*)file1->Get("histo_4"); // Asymov PC Np
  ...
  for (Int_t i=0;i!=hdata_obsch_1->GetNbinsX()+1;i++){
    ...
    hextbnb_N->SetBinContent(i+1, histo_ext_1->GetBinContent(i+1) + histo_ext_2->GetBinContent(i+1) + histo_ext_3->GetBinContent(i+1) + histo_ext_4->GetBinContent(i+1));
  }
