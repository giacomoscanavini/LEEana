...
*/
void convert_wiener_2ch(int RW=1){
  gStyle->SetOptStat(0);
  ...
  TH1F *histo_bkg_1 = (TH1F*)file1->Get("histo_3"); // MC bkg (dirt included) FC 0p
  TH1F *histo_bkg_2 = (TH1F*)file1->Get("histo_4"); // MC bkg (dirt included) FC Np

  TH1F *histo_ext_1 = (TH1F*)file1->Get("histo_5");  // EXT FC 0p
  TH1F *histo_ext_2 = (TH1F*)file1->Get("histo_6"); // EXT FC Np
