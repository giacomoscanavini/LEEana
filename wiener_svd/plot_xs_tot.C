...
void plot_xs_tot(int opt=2){
  ...
  // 0. xsec model
  TFile *file1 = new TFile("/data1/wgu/WC-LEE/LEEana.Xs/genie/xsec_graphs_v2_tune1.root");
  TFile *file2 = new TFile("/data1/wgu/WC-LEE/LEEana.Xs/genie/xsec_graphs_v3_10a_02_11a.root");
