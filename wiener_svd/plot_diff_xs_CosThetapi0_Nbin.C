...
// main function
void plot_diff_xs_CosThetapi0_Nbin(){

  double xbins[] = {-1.0, -0.62, -0.34, -0.13, 0.06, 0.20, 0.32, 0.42, 0.52, 0.6, 0.67, 0.73, 0.78, 0.83, 0.87, 0.91, 0.95, 0.975, 1.0};  // Bin separators - GeV
  double NUCLEONS = 40.;
  //double NUCLEONS = 1.;
