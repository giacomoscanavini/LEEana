/*
  ...
  It works specifically for 2 reconstructed channels [FC, PC] (order must be kept in cov_input.txt)
  
  To run use: 
    root -l --web=off 'convert_wiener_2ch.C(1)'   (yes reweighting)
    root -l --web=off 'convert_wiener_2ch.C(0)'   (no reweighting)
*/
void convert_wiener_2ch_fake(int RW=1){
  ...
  TH1F *histo_sig_1 = (TH1F*)file1->Get("histo_1"); // MC signal FC 
  TH1F *histo_sig_2 = (TH1F*)file1->Get("histo_2"); // MC signal PC

  TH1F *histo_bkg_1 = (TH1F*)file1->Get("histo_3"); // MC bkg (dirt included) FC 
  TH1F *histo_bkg_2 = (TH1F*)file1->Get("histo_4"); // MC bkg (dirt included) PC

  //TH1F *histo_ext_1 = (TH1F*)file1->Get("histo_5");  // EXT FC 
  //TH1F *histo_ext_2 = (TH1F*)file1->Get("histo_6"); // EXT PC
