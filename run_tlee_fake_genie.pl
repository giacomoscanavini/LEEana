...
if ($num1 == 0){
	system("cp ./configurations/tlee_mom_fake_genie/cov_input.txt ./configurations/cov_input.txt");
}elsif ($num1 == 1){
	system("cp ./configurations/tlee_cos_fake_genie/cov_input.txt ./configurations/cov_input.txt");
}
