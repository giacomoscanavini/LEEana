...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-184.6154,-28.22992,1353.846,3121.635);
   pad1->SetFillColor(0);
   ...
   hmc__4->SetBinContent(1,636.3318);
   hmc__4->SetBinContent(2,1411.496);
   hmc__4->SetBinContent(3,1165.158);
   hmc__4->SetBinContent(4,785.9854);
   hmc__4->SetBinContent(5,518.2802);
   hmc__4->SetBinContent(6,310.1619);
   hmc__4->SetBinContent(7,181.0175);
   hmc__4->SetBinContent(8,110.1675);
   hmc__4->SetBinContent(9,84.1174);
   hmc__4->SetBinContent(10,55.88068);
   hmc__4->SetBinContent(11,51.32436);
   hmc__4->SetBinContent(12,43.43119);
   hmc__4->SetBinContent(13,346.1605);
   hmc__4->SetBinError(1,141.6085);
   hmc__4->SetBinError(2,347.9275);
   hmc__4->SetBinError(3,315.5806);
   hmc__4->SetBinError(4,234.8147);
   hmc__4->SetBinError(5,160.8765);
   hmc__4->SetBinError(6,88.45956);
   hmc__4->SetBinError(7,48.15467);
   hmc__4->SetBinError(8,30.95908);
   hmc__4->SetBinError(9,26.23137);
   hmc__4->SetBinError(10,19.34872);
   hmc__4->SetBinError(11,21.56499);
   hmc__4->SetBinError(12,16.68023);
   hmc__4->SetBinError(13,90.56744);
   hmc__4->SetMinimum(-28.22992);
   hmc__4->SetMaximum(2964.142);
   ...
   hs2_stack_2->SetMaximum(1482.071);
   ...
   hext_stack_2->SetBinContent(1,55.52851);
   hext_stack_2->SetBinContent(2,100.4856);
   hext_stack_2->SetBinContent(3,66.71693);
   hext_stack_2->SetBinContent(4,34.83839);
   hext_stack_2->SetBinContent(5,31.53098);
   hext_stack_2->SetBinContent(6,21.60266);
   hext_stack_2->SetBinContent(7,15.97817);
   hext_stack_2->SetBinContent(8,7.925626);
   hext_stack_2->SetBinContent(9,8.57883);
   hext_stack_2->SetBinContent(10,3.897177);
   hext_stack_2->SetBinContent(11,5.340399);
   hext_stack_2->SetBinContent(12,2.510206);
   hext_stack_2->SetBinContent(13,22.57585);
   hext_stack_2->SetBinError(1,4.949682);
   hext_stack_2->SetBinError(2,6.483787);
   hext_stack_2->SetBinError(3,5.247829);
   hext_stack_2->SetBinError(4,3.804362);
   hext_stack_2->SetBinError(5,3.618489);
   hext_stack_2->SetBinError(6,3.110979);
   hext_stack_2->SetBinError(7,2.548677);
   hext_stack_2->SetBinError(8,1.893598);
   hext_stack_2->SetBinError(9,1.982751);
   hext_stack_2->SetBinError(10,1.182339);
   hext_stack_2->SetBinError(11,1.485368);
   hext_stack_2->SetBinError(12,1.057404);
   hext_stack_2->SetBinError(13,3.161312);
   ...
   hmcerror__5->SetBinContent(1,636.3318);
   hmcerror__5->SetBinContent(2,1411.496);
   hmcerror__5->SetBinContent(3,1165.158);
   hmcerror__5->SetBinContent(4,785.9854);
   hmcerror__5->SetBinContent(5,518.2802);
   hmcerror__5->SetBinContent(6,310.1619);
   hmcerror__5->SetBinContent(7,181.0175);
   hmcerror__5->SetBinContent(8,110.1675);
   hmcerror__5->SetBinContent(9,84.1174);
   hmcerror__5->SetBinContent(10,55.88068);
   hmcerror__5->SetBinContent(11,51.32436);
   hmcerror__5->SetBinContent(12,43.43119);
   hmcerror__5->SetBinContent(13,346.1605);
   hmcerror__5->SetBinError(1,141.6085);
   hmcerror__5->SetBinError(2,347.9275);
   hmcerror__5->SetBinError(3,315.5806);
   hmcerror__5->SetBinError(4,234.8147);
   hmcerror__5->SetBinError(5,160.8765);
   hmcerror__5->SetBinError(6,88.45956);
   hmcerror__5->SetBinError(7,48.15467);
   hmcerror__5->SetBinError(8,30.95908);
   hmcerror__5->SetBinError(9,26.23137);
   hmcerror__5->SetBinError(10,19.34872);
   hmcerror__5->SetBinError(11,21.56499);
   hmcerror__5->SetBinError(12,16.68023);
   hmcerror__5->SetBinError(13,90.56744);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=5.9/12","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hext_stack_2","EXT, 354.9","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3008->SetMinimum(0.4017599);
   Graph_Graph3008->SetMaximum(1.280928);
