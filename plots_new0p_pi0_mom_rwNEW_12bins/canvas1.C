...
//=========  (Thu Mar  9 12:32:22 2023) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-184.6154,-35.64742,1353.846,3941.855);
   pad1->SetFillColor(0);
   ...
   hmc__1->SetBinContent(1,804.8101);
   hmc__1->SetBinContent(2,1782.371);
   hmc__1->SetBinContent(3,1465.836);
   hmc__1->SetBinContent(4,1024.664);
   hmc__1->SetBinContent(5,672.283);
   hmc__1->SetBinContent(6,414.9685);
   hmc__1->SetBinContent(7,239.6591);
   hmc__1->SetBinContent(8,148.222);
   hmc__1->SetBinContent(9,111.8056);
   hmc__1->SetBinContent(10,78.54018);
   hmc__1->SetBinContent(11,69.11031);
   hmc__1->SetBinContent(12,57.38585);
   hmc__1->SetBinContent(13,464.6496);
   hmc__1->SetBinError(1,170.761);
   hmc__1->SetBinError(2,414.5482);
   hmc__1->SetBinError(3,375.5044);
   hmc__1->SetBinError(4,285.5399);
   hmc__1->SetBinError(5,198.3804);
   hmc__1->SetBinError(6,108.9047);
   hmc__1->SetBinError(7,60.39288);
   hmc__1->SetBinError(8,39.48293);
   hmc__1->SetBinError(9,32.38989);
   hmc__1->SetBinError(10,22.11416);
   hmc__1->SetBinError(11,25.53683);
   hmc__1->SetBinError(12,18.87927);
   hmc__1->SetBinError(13,108.7559);
   hmc__1->SetMinimum(-35.64742);
   hmc__1->SetMaximum(3742.98);
   ...
   hs1_stack_1->SetMaximum(1871.49);
   ...
   hext_stack_2->SetBinContent(1,75.4557);
   hext_stack_2->SetBinContent(2,157.662);
   hext_stack_2->SetBinContent(3,107.1423);
   hext_stack_2->SetBinContent(4,64.12447);
   hext_stack_2->SetBinContent(5,52.25701);
   hext_stack_2->SetBinContent(6,40.23944);
   hext_stack_2->SetBinContent(7,25.7768);
   hext_stack_2->SetBinContent(8,12.62882);
   hext_stack_2->SetBinContent(9,13.6958);
   hext_stack_2->SetBinContent(10,8.510989);
   hext_stack_2->SetBinContent(11,8.741595);
   hext_stack_2->SetBinContent(12,5.027592);
   hext_stack_2->SetBinContent(13,43.57003);
   hext_stack_2->SetBinError(1,5.725948);
   hext_stack_2->SetBinError(2,8.16067);
   hext_stack_2->SetBinError(3,6.663293);
   hext_stack_2->SetBinError(4,5.262312);
   hext_stack_2->SetBinError(5,4.702514);
   hext_stack_2->SetBinError(6,4.164515);
   hext_stack_2->SetBinError(7,3.305);
   hext_stack_2->SetBinError(8,2.348507);
   hext_stack_2->SetBinError(9,2.413545);
   hext_stack_2->SetBinError(10,1.862475);
   hext_stack_2->SetBinError(11,1.892098);
   hext_stack_2->SetBinError(12,1.426537);
   hext_stack_2->SetBinError(13,4.311697);
   ...
   hmcerror__2->SetBinContent(1,804.8101);
   hmcerror__2->SetBinContent(2,1782.371);
   hmcerror__2->SetBinContent(3,1465.836);
   hmcerror__2->SetBinContent(4,1024.664);
   hmcerror__2->SetBinContent(5,672.283);
   hmcerror__2->SetBinContent(6,414.9685);
   hmcerror__2->SetBinContent(7,239.6591);
   hmcerror__2->SetBinContent(8,148.222);
   hmcerror__2->SetBinContent(9,111.8056);
   hmcerror__2->SetBinContent(10,78.54018);
   hmcerror__2->SetBinContent(11,69.11031);
   hmcerror__2->SetBinContent(12,57.38585);
   hmcerror__2->SetBinContent(13,464.6496);
   hmcerror__2->SetBinError(1,170.761);
   hmcerror__2->SetBinError(2,414.5482);
   hmcerror__2->SetBinError(3,375.5044);
   hmcerror__2->SetBinError(4,285.5399);
   hmcerror__2->SetBinError(5,198.3804);
   hmcerror__2->SetBinError(6,108.9047);
   hmcerror__2->SetBinError(7,60.39288);
   hmcerror__2->SetBinError(8,39.48293);
   hmcerror__2->SetBinError(9,32.38989);
   hmcerror__2->SetBinError(10,22.11416);
   hmcerror__2->SetBinError(11,25.53683);
   hmcerror__2->SetBinError(12,18.87927);
   hmcerror__2->SetBinError(13,108.7559);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hext_stack_2","EXT, 571.3","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3004->SetMinimum(0.4894687);
   Graph_Graph3004->SetMaximum(1.241495);
