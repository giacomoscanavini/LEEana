...
// ------------>Primitives in pad: pad1
   ...
   hmc__16->SetBinContent(1,463.0005);
   hmc__16->SetBinContent(2,842.4261);
   hmc__16->SetBinContent(3,733.691);
   hmc__16->SetBinContent(4,508.4622);
   hmc__16->SetBinContent(5,339.8324);
   hmc__16->SetBinContent(6,213.8157);
   hmc__16->SetBinContent(7,127.154);
   hmc__16->SetBinContent(8,75.24523);
   hmc__16->SetBinContent(9,62.68201);
   hmc__16->SetBinContent(10,40.15513);
   hmc__16->SetBinContent(11,35.71924);
   hmc__16->SetBinContent(12,28.2751);
   hmc__16->SetBinContent(13,212.5468);
   hmc__16->SetBinError(1,103.0415);
   hmc__16->SetBinError(2,189.697);
   hmc__16->SetBinError(3,174.5308);
   hmc__16->SetBinError(4,139.1597);
   hmc__16->SetBinError(5,97.41714);
   hmc__16->SetBinError(6,58.84826);
   hmc__16->SetBinError(7,38.5314);
   hmc__16->SetBinError(8,22.98874);
   hmc__16->SetBinError(9,24.0517);
   hmc__16->SetBinError(10,14.57632);
   hmc__16->SetBinError(11,16.18425);
   hmc__16->SetBinError(12,12.22555);
   hmc__16->SetBinError(13,59.41177);
   hmc__16->SetMinimum(-17.42);
   hmc__16->SetMaximum(1829.1);
   ...
   hs6_stack_6->SetMaximum(884.5473);
   ...
   hmcerror__17->SetBinContent(1,463.0005);
   hmcerror__17->SetBinContent(2,842.4261);
   hmcerror__17->SetBinContent(3,733.691);
   hmcerror__17->SetBinContent(4,508.4622);
   hmcerror__17->SetBinContent(5,339.8324);
   hmcerror__17->SetBinContent(6,213.8157);
   hmcerror__17->SetBinContent(7,127.154);
   hmcerror__17->SetBinContent(8,75.24523);
   hmcerror__17->SetBinContent(9,62.68201);
   hmcerror__17->SetBinContent(10,40.15513);
   hmcerror__17->SetBinContent(11,35.71924);
   hmcerror__17->SetBinContent(12,28.2751);
   hmcerror__17->SetBinContent(13,212.5468);
   hmcerror__17->SetBinError(1,103.0415);
   hmcerror__17->SetBinError(2,189.697);
   hmcerror__17->SetBinError(3,174.5308);
   hmcerror__17->SetBinError(4,139.1597);
   hmcerror__17->SetBinError(5,97.41714);
   hmcerror__17->SetBinError(6,58.84826);
   hmcerror__17->SetBinError(7,38.5314);
   hmcerror__17->SetBinError(8,22.98874);
   hmcerror__17->SetBinError(9,24.0517);
   hmcerror__17->SetBinError(10,14.57632);
   hmcerror__17->SetBinError(11,16.18425);
   hmcerror__17->SetBinError(12,12.22555);
   hmcerror__17->SetBinError(13,59.41177);
   ...
   Graph_Graph3021->SetMaximum(989.2923);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3024->SetMinimum(0.2651007);
   Graph_Graph3024->SetMaximum(1.356043);
