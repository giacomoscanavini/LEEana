...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.2307692,-15.30666,6.641026,1692.594);
   pad1->SetFillColor(0);
   ...
   hmc__4->SetBinContent(4,603.4193);
   hmc__4->SetBinContent(5,765.3329);
   hmc__4->SetBinContent(6,731.0988);
   hmc__4->SetBinContent(7,657.1608);
   hmc__4->SetBinContent(8,574.1522);
   hmc__4->SetBinContent(9,526.8583);
   hmc__4->SetBinContent(10,465.7198);
   hmc__4->SetBinContent(11,426.5103);
   hmc__4->SetBinContent(12,365.2957);
   hmc__4->SetBinContent(13,269.1668);
   ...
   hmc__4->SetBinError(4,123.0564);
   hmc__4->SetBinError(5,153.2742);
   hmc__4->SetBinError(6,154.4041);
   hmc__4->SetBinError(7,140.2675);
   hmc__4->SetBinError(8,127.9472);
   hmc__4->SetBinError(9,129.418);
   hmc__4->SetBinError(10,114.2532);
   hmc__4->SetBinError(11,108.8345);
   hmc__4->SetBinError(12,93.76365);
   hmc__4->SetBinError(13,72.38574);
   hmc__4->SetBinError(14,44.29628);
   hmc__4->SetBinError(15,24.32048);
   hmc__4->SetBinError(16,15.96601);
   hmc__4->SetBinError(17,9.412328);
   hmc__4->SetBinError(18,4.340795);
   hmc__4->SetBinError(19,2.544961);
   hmc__4->SetBinError(20,0.6451368);
   hmc__4->SetBinError(21,3.870157);
   hmc__4->SetMinimum(-15.30666);
   hmc__4->SetMaximum(1607.199);
   ...
   hs2_stack_2->SetMaximum(803.5995);
   ...
   hext_stack_2->SetBinContent(4,64.11012);
   hext_stack_2->SetBinContent(5,73.98772);
   hext_stack_2->SetBinContent(6,60.68025);
   hext_stack_2->SetBinContent(7,53.66111);
   hext_stack_2->SetBinContent(8,41.8962);
   hext_stack_2->SetBinContent(9,30.59968);
   hext_stack_2->SetBinContent(10,21.05761);
   hext_stack_2->SetBinContent(11,14.97185);
   hext_stack_2->SetBinContent(12,8.040958);
   ...
   hext_stack_2->SetBinError(4,5.300409);
   hext_stack_2->SetBinError(5,5.505306);
   hext_stack_2->SetBinError(6,5.118106);
   hext_stack_2->SetBinError(7,4.653465);
   hext_stack_2->SetBinError(8,4.203703);
   hext_stack_2->SetBinError(9,3.702531);
   hext_stack_2->SetBinError(10,2.987341);
   hext_stack_2->SetBinError(11,2.6172);
   hext_stack_2->SetBinError(12,1.725143);
   ...
   hmcerror__5->SetBinContent(4,603.4193);
   hmcerror__5->SetBinContent(5,765.3329);
   hmcerror__5->SetBinContent(6,731.0988);
   hmcerror__5->SetBinContent(7,657.1608);
   hmcerror__5->SetBinContent(8,574.1522);
   hmcerror__5->SetBinContent(9,526.8583);
   hmcerror__5->SetBinContent(10,465.7198);
   hmcerror__5->SetBinContent(11,426.5103);
   hmcerror__5->SetBinContent(12,365.2957);
   hmcerror__5->SetBinContent(13,269.1668);
   ...
   hmcerror__5->SetBinError(4,123.0564);
   hmcerror__5->SetBinError(5,153.2742);
   hmcerror__5->SetBinError(6,154.4041);
   hmcerror__5->SetBinError(7,140.2675);
   hmcerror__5->SetBinError(8,127.9472);
   hmcerror__5->SetBinError(9,129.418);
   hmcerror__5->SetBinError(10,114.2532);
   hmcerror__5->SetBinError(11,108.8345);
   hmcerror__5->SetBinError(12,93.76365);
   hmcerror__5->SetBinError(13,72.38574);
   hmcerror__5->SetBinError(14,44.29628);
   hmcerror__5->SetBinError(15,24.32048);
   hmcerror__5->SetBinError(16,15.96601);
   hmcerror__5->SetBinError(17,9.412328);
   hmcerror__5->SetBinError(18,4.340795);
   hmcerror__5->SetBinError(19,2.544961);
   hmcerror__5->SetBinError(20,0.6451368);
   hmcerror__5->SetBinError(21,3.870157);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=5.0/20","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
