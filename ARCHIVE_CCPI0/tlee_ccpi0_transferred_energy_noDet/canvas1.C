...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinError(1,3.475591);
   hmc__1->SetBinError(2,18.50611);
   hmc__1->SetBinError(3,72.06529);
   hmc__1->SetBinError(4,161.2873);
   hmc__1->SetBinError(5,219.1967);
   hmc__1->SetBinError(6,239.0535);
   hmc__1->SetBinError(7,219.1478);
   hmc__1->SetBinError(8,182.9054);
   hmc__1->SetBinError(9,147.0174);
   hmc__1->SetBinError(10,121.4617);
   hmc__1->SetBinError(11,99.9066);
   hmc__1->SetBinError(12,75.64806);
   hmc__1->SetBinError(13,57.66841);
   hmc__1->SetBinError(14,42.90469);
   hmc__1->SetBinError(15,33.5175);
   hmc__1->SetBinError(16,24.2646);
   hmc__1->SetBinError(17,16.39547);
   hmc__1->SetBinError(18,16.21253);
   hmc__1->SetBinError(19,10.38487);
   hmc__1->SetBinError(20,8.174717);
   hmc__1->SetBinError(21,24.65819);
   ...
   hmcerror__2->SetBinError(1,3.475591);
   hmcerror__2->SetBinError(2,18.50611);
   hmcerror__2->SetBinError(3,72.06529);
   hmcerror__2->SetBinError(4,161.2873);
   hmcerror__2->SetBinError(5,219.1967);
   hmcerror__2->SetBinError(6,239.0535);
   hmcerror__2->SetBinError(7,219.1478);
   hmcerror__2->SetBinError(8,182.9054);
   hmcerror__2->SetBinError(9,147.0174);
   hmcerror__2->SetBinError(10,121.4617);
   hmcerror__2->SetBinError(11,99.9066);
   hmcerror__2->SetBinError(12,75.64806);
   hmcerror__2->SetBinError(13,57.66841);
   hmcerror__2->SetBinError(14,42.90469);
   hmcerror__2->SetBinError(15,33.5175);
   hmcerror__2->SetBinError(16,24.2646);
   hmcerror__2->SetBinError(17,16.39547);
   hmcerror__2->SetBinError(18,16.21253);
   hmcerror__2->SetBinError(19,10.38487);
   hmcerror__2->SetBinError(20,8.174717);
   hmcerror__2->SetBinError(21,24.65819);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=65.0/20","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
