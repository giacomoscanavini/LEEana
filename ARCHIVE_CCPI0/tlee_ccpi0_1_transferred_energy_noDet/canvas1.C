...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinError(9,166.9293);
   hmc__1->SetBinError(10,144.4211);
   hmc__1->SetBinError(11,123.2676);
   hmc__1->SetBinError(12,99.31347);
   hmc__1->SetBinError(13,90.24515);
   hmc__1->SetBinError(14,76.209);
   hmc__1->SetBinError(15,58.40849);
   hmc__1->SetBinError(16,48.56571);
   hmc__1->SetBinError(17,40.55292);
   hmc__1->SetBinError(18,30.17595);
   hmc__1->SetBinError(19,23.7015);
   hmc__1->SetBinError(20,19.66968);
   hmc__1->SetBinError(21,13.87255);
   hmc__1->SetBinError(22,14.73601);
   hmc__1->SetBinError(23,10.08312);
   hmc__1->SetBinError(24,7.513278);
   hmc__1->SetBinError(25,6.588474);
   ...
   hmcerror__2->SetBinError(2,8.487954);
   ...
   hmcerror__2->SetBinError(9,166.9293);
   hmcerror__2->SetBinError(10,144.4211);
   hmcerror__2->SetBinError(11,123.2676);
   hmcerror__2->SetBinError(12,99.31347);
   hmcerror__2->SetBinError(13,90.24515);
   hmcerror__2->SetBinError(14,76.209);
   hmcerror__2->SetBinError(15,58.40849);
   hmcerror__2->SetBinError(16,48.56571);
   hmcerror__2->SetBinError(17,40.55292);
   hmcerror__2->SetBinError(18,30.17595);
   hmcerror__2->SetBinError(19,23.7015);
   hmcerror__2->SetBinError(20,19.66968);
   hmcerror__2->SetBinError(21,13.87255);
   hmcerror__2->SetBinError(22,14.73601);
   hmcerror__2->SetBinError(23,10.08312);
   hmcerror__2->SetBinError(24,7.513278);
   hmcerror__2->SetBinError(25,6.588474);
