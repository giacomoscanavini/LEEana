...
// ------------>Primitives in pad: pad1
   ...
   hmc__4->SetBinError(2,45.7189);
   hmc__4->SetBinError(3,232.8144);
   hmc__4->SetBinError(4,216.3044);
   hmc__4->SetBinError(5,226.4852);
   hmc__4->SetBinError(6,195.7299);
   hmc__4->SetBinError(7,137.6289);
   hmc__4->SetBinError(8,96.91938);
   hmc__4->SetBinError(9,61.6113);
   hmc__4->SetBinError(10,43.5788);
   hmc__4->SetBinError(11,36.36426);
   hmc__4->SetBinError(12,28.664);
   hmc__4->SetBinError(13,25.10076);
   hmc__4->SetBinError(14,17.78514);
   hmc__4->SetBinError(15,16.25044);
   hmc__4->SetBinError(16,24.55966);
   ...
   hmcerror__5->SetBinError(2,45.7189);
   hmcerror__5->SetBinError(3,232.8144);
   hmcerror__5->SetBinError(4,216.3044);
   hmcerror__5->SetBinError(5,226.4852);
   hmcerror__5->SetBinError(6,195.7299);
   hmcerror__5->SetBinError(7,137.6289);
   hmcerror__5->SetBinError(8,96.91938);
   hmcerror__5->SetBinError(9,61.6113);
   hmcerror__5->SetBinError(10,43.5788);
   hmcerror__5->SetBinError(11,36.36426);
   hmcerror__5->SetBinError(12,28.664);
   hmcerror__5->SetBinError(13,25.10076);
   hmcerror__5->SetBinError(14,17.78514);
   hmcerror__5->SetBinError(15,16.25044);
   hmcerror__5->SetBinError(16,24.55966);
