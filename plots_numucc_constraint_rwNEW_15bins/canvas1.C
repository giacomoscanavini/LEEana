...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinError(2,46.74626);
   hmc__1->SetBinError(3,250.3302);
   hmc__1->SetBinError(4,298.1394);
   hmc__1->SetBinError(5,385.4075);
   hmc__1->SetBinError(6,349.5338);
   hmc__1->SetBinError(7,266.168);
   hmc__1->SetBinError(8,185.9042);
   hmc__1->SetBinError(9,133.7009);
   hmc__1->SetBinError(10,86.95702);
   hmc__1->SetBinError(11,58.53718);
   hmc__1->SetBinError(12,42.65487);
   hmc__1->SetBinError(13,35.89301);
   hmc__1->SetBinError(14,26.6758);
   hmc__1->SetBinError(15,24.11224);
   hmc__1->SetBinError(16,37.9656);
   ...
   hmcerror__2->SetBinError(2,46.74626);
   hmcerror__2->SetBinError(3,250.3302);
   hmcerror__2->SetBinError(4,298.1394);
   hmcerror__2->SetBinError(5,385.4075);
   hmcerror__2->SetBinError(6,349.5338);
   hmcerror__2->SetBinError(7,266.168);
   hmcerror__2->SetBinError(8,185.9042);
   hmcerror__2->SetBinError(9,133.7009);
   hmcerror__2->SetBinError(10,86.95702);
   hmcerror__2->SetBinError(11,58.53718);
   hmcerror__2->SetBinError(12,42.65487);
   hmcerror__2->SetBinError(13,35.89301);
   hmcerror__2->SetBinError(14,26.6758);
   hmcerror__2->SetBinError(15,24.11224);
   hmcerror__2->SetBinError(16,37.9656);
