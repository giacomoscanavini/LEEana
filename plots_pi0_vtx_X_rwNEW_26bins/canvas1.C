...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-40,-6.759654,293.3333,747.4754);
   pad1->SetFillColor(0);
   ...
   hmc__1->SetBinContent(1,168.7527);
   hmc__1->SetBinContent(2,224.9355);
   hmc__1->SetBinContent(3,262.1017);
   hmc__1->SetBinContent(4,266.1038);
   hmc__1->SetBinContent(5,274.4716);
   hmc__1->SetBinContent(6,283.7156);
   hmc__1->SetBinContent(7,268.039);
   hmc__1->SetBinContent(8,293.3833);
   hmc__1->SetBinContent(9,292.2586);
   hmc__1->SetBinContent(10,298.5097);
   hmc__1->SetBinContent(11,302.7966);
   hmc__1->SetBinContent(12,298.758);
   hmc__1->SetBinContent(13,303.1667);
   hmc__1->SetBinContent(14,310.6532);
   hmc__1->SetBinContent(15,295.4957);
   hmc__1->SetBinContent(16,303.3467);
   hmc__1->SetBinContent(17,327.2117);
   hmc__1->SetBinContent(18,320.3364);
   hmc__1->SetBinContent(19,313.0111);
   hmc__1->SetBinContent(20,333.2001);
   hmc__1->SetBinContent(21,336.9723);
   hmc__1->SetBinContent(22,328.4174);
   hmc__1->SetBinContent(23,337.9827);
   hmc__1->SetBinContent(24,310.1203);
   hmc__1->SetBinContent(25,262.9383);
   hmc__1->SetBinContent(26,134.208);
   hmc__1->SetBinContent(27,10.34641);
   hmc__1->SetBinError(0,1.770004);
   hmc__1->SetBinError(1,43.47332);
   hmc__1->SetBinError(2,59.90804);
   hmc__1->SetBinError(3,67.98057);
   hmc__1->SetBinError(4,63.72143);
   hmc__1->SetBinError(5,81.83075);
   hmc__1->SetBinError(6,73.70833);
   hmc__1->SetBinError(7,73.85035);
   hmc__1->SetBinError(8,80.17888);
   hmc__1->SetBinError(9,76.57376);
   hmc__1->SetBinError(10,75.5867);
   hmc__1->SetBinError(11,79.94046);
   hmc__1->SetBinError(12,79.3638);
   hmc__1->SetBinError(13,78.72);
   hmc__1->SetBinError(14,82.78655);
   hmc__1->SetBinError(15,74.86905);
   hmc__1->SetBinError(16,77.12491);
   hmc__1->SetBinError(17,78.79661);
   hmc__1->SetBinError(18,84.49994);
   hmc__1->SetBinError(19,83.10081);
   hmc__1->SetBinError(20,80.30314);
   hmc__1->SetBinError(21,89.42976);
   hmc__1->SetBinError(22,77.21811);
   hmc__1->SetBinError(23,85.57147);
   hmc__1->SetBinError(24,73.37662);
   hmc__1->SetBinError(25,60.30931);
   hmc__1->SetBinError(26,38.82841);
   hmc__1->SetBinError(27,8.32464);
   hmc__1->SetMinimum(-6.759654);
   hmc__1->SetMaximum(709.7637);
   ...
   hs1_stack_1->SetMaximum(354.8819);
   ...
   hmcerror__2->SetBinContent(1,168.7527);
   hmcerror__2->SetBinContent(2,224.9355);
   hmcerror__2->SetBinContent(3,262.1017);
   hmcerror__2->SetBinContent(4,266.1038);
   hmcerror__2->SetBinContent(5,274.4716);
   hmcerror__2->SetBinContent(6,283.7156);
   hmcerror__2->SetBinContent(7,268.039);
   hmcerror__2->SetBinContent(8,293.3833);
   hmcerror__2->SetBinContent(9,292.2586);
   hmcerror__2->SetBinContent(10,298.5097);
   hmcerror__2->SetBinContent(11,302.7966);
   hmcerror__2->SetBinContent(12,298.758);
   hmcerror__2->SetBinContent(13,303.1667);
   hmcerror__2->SetBinContent(14,310.6532);
   hmcerror__2->SetBinContent(15,295.4957);
   hmcerror__2->SetBinContent(16,303.3467);
   hmcerror__2->SetBinContent(17,327.2117);
   hmcerror__2->SetBinContent(18,320.3364);
   hmcerror__2->SetBinContent(19,313.0111);
   hmcerror__2->SetBinContent(20,333.2001);
   hmcerror__2->SetBinContent(21,336.9723);
   hmcerror__2->SetBinContent(22,328.4174);
   hmcerror__2->SetBinContent(23,337.9827);
   hmcerror__2->SetBinContent(24,310.1203);
   hmcerror__2->SetBinContent(25,262.9383);
   hmcerror__2->SetBinContent(26,134.208);
   hmcerror__2->SetBinContent(27,10.34641);
   hmcerror__2->SetBinError(0,1.770004);
   hmcerror__2->SetBinError(1,43.47332);
   hmcerror__2->SetBinError(2,59.90804);
   hmcerror__2->SetBinError(3,67.98057);
   hmcerror__2->SetBinError(4,63.72143);
   hmcerror__2->SetBinError(5,81.83075);
   hmcerror__2->SetBinError(6,73.70833);
   hmcerror__2->SetBinError(7,73.85035);
   hmcerror__2->SetBinError(8,80.17888);
   hmcerror__2->SetBinError(9,76.57376);
   hmcerror__2->SetBinError(10,75.5867);
   hmcerror__2->SetBinError(11,79.94046);
   hmcerror__2->SetBinError(12,79.3638);
   hmcerror__2->SetBinError(13,78.72);
   hmcerror__2->SetBinError(14,82.78655);
   hmcerror__2->SetBinError(15,74.86905);
   hmcerror__2->SetBinError(16,77.12491);
   hmcerror__2->SetBinError(17,78.79661);
   hmcerror__2->SetBinError(18,84.49994);
   hmcerror__2->SetBinError(19,83.10081);
   hmcerror__2->SetBinError(20,80.30314);
   hmcerror__2->SetBinError(21,89.42976);
   hmcerror__2->SetBinError(22,77.21811);
   hmcerror__2->SetBinError(23,85.57147);
   hmcerror__2->SetBinError(24,73.37662);
   hmcerror__2->SetBinError(25,60.30931);
   hmcerror__2->SetBinError(26,38.82841);
   hmcerror__2->SetBinError(27,8.32464);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=7.1/26","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3004->SetMinimum(0.6422841);
   Graph_Graph3004->SetMaximum(1.060754);
