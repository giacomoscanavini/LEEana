...
//=========  (Sat Feb 18 20:31:00 2023) by ROOT version 6.26/00
   TCanvas *canvas16 = new TCanvas("canvas16", "channel16",34,57,1200,900);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   hmc__46->SetBinContent(1,6.060304);
   hmc__46->SetBinContent(2,25.25197);
   hmc__46->SetBinContent(3,25.34882);
   hmc__46->SetBinContent(4,27.55915);
   hmc__46->SetBinContent(5,24.99064);
   hmc__46->SetBinContent(6,11.46069);
   hmc__46->SetBinContent(7,9.244857);
   hmc__46->SetBinContent(8,4.991816);
   hmc__46->SetBinContent(9,2.734073);
   hmc__46->SetBinContent(10,3.496576);
   hmc__46->SetBinContent(11,4.35296);
   hmc__46->SetBinContent(12,2.900743);
   hmc__46->SetBinContent(13,18.52404);
   hmc__46->SetBinError(1,5.409766);
   hmc__46->SetBinError(2,16.41287);
   hmc__46->SetBinError(3,13.73549);
   hmc__46->SetBinError(4,21.28487);
   hmc__46->SetBinError(5,12.86869);
   hmc__46->SetBinError(6,8.785063);
   hmc__46->SetBinError(7,9.09958);
   hmc__46->SetBinError(8,5.945734);
   hmc__46->SetBinError(9,3.661044);
   hmc__46->SetBinError(10,5.94909);
   hmc__46->SetBinError(11,8.413262);
   hmc__46->SetBinError(12,2.98874);
   hmc__46->SetBinError(13,12.26805);
   ...
   hs16_stack_16->SetMaximum(28.93711);
   ...
   hbadmatch_stack_1->SetBinContent(6,0.5901461);
   ...
   hbadmatch_stack_1->SetBinError(6,0.340721);
   ...
   houtFV_stack_4->SetBinContent(2,4.488105);
   houtFV_stack_4->SetBinContent(3,3.740299);
   houtFV_stack_4->SetBinContent(4,3.516127);
   houtFV_stack_4->SetBinContent(5,5.553816);
   houtFV_stack_4->SetBinContent(6,1.905448);
   houtFV_stack_4->SetBinContent(7,1.947476);
   houtFV_stack_4->SetBinContent(8,1.125918);
   houtFV_stack_4->SetBinContent(9,0.7336084);
   houtFV_stack_4->SetBinContent(10,1.608988);
   houtFV_stack_4->SetBinContent(11,1.22606);
   houtFV_stack_4->SetBinContent(12,0.5884556);
   houtFV_stack_4->SetBinContent(13,2.876109);
   houtFV_stack_4->SetBinError(2,1.107499);
   houtFV_stack_4->SetBinError(3,1.0114);
   houtFV_stack_4->SetBinError(4,0.940871);
   houtFV_stack_4->SetBinError(5,1.212127);
   houtFV_stack_4->SetBinError(6,0.6496038);
   houtFV_stack_4->SetBinError(7,0.7600326);
   houtFV_stack_4->SetBinError(8,0.6557195);
   houtFV_stack_4->SetBinError(9,0.4394482);
   houtFV_stack_4->SetBinError(10,0.6801404);
   houtFV_stack_4->SetBinError(11,0.5910499);
   houtFV_stack_4->SetBinError(12,0.3397478);
   houtFV_stack_4->SetBinError(13,0.8993325);
   ...
   hNCpi0inFVqe_stack_6->SetBinContent(3,0.3909362);
   ...
   hNCpi0inFVqe_stack_6->SetBinError(3,0.2764336);
   ...
   hNCpi0inFVres_stack_7->SetBinContent(1,1.099894);
   hNCpi0inFVres_stack_7->SetBinContent(2,3.721501);
   hNCpi0inFVres_stack_7->SetBinContent(3,5.257346);
   hNCpi0inFVres_stack_7->SetBinContent(4,7.223308);
   hNCpi0inFVres_stack_7->SetBinContent(5,5.131127);
   hNCpi0inFVres_stack_7->SetBinContent(6,3.347184);
   hNCpi0inFVres_stack_7->SetBinContent(7,2.190162);
   hNCpi0inFVres_stack_7->SetBinContent(8,1.004072);
   hNCpi0inFVres_stack_7->SetBinContent(9,0.9060901);
   hNCpi0inFVres_stack_7->SetBinContent(10,0.66844);
   hNCpi0inFVres_stack_7->SetBinContent(11,0.3620359);
   hNCpi0inFVres_stack_7->SetBinContent(12,0.307068);
   hNCpi0inFVres_stack_7->SetBinContent(13,2.593548);
   hNCpi0inFVres_stack_7->SetBinError(1,0.3327621);
   hNCpi0inFVres_stack_7->SetBinError(2,0.5257417);
   hNCpi0inFVres_stack_7->SetBinError(3,0.7624226);
   hNCpi0inFVres_stack_7->SetBinError(4,0.8949489);
   hNCpi0inFVres_stack_7->SetBinError(5,0.7204262);
   hNCpi0inFVres_stack_7->SetBinError(6,0.6026605);
   hNCpi0inFVres_stack_7->SetBinError(7,0.52716);
   hNCpi0inFVres_stack_7->SetBinError(8,0.3271594);
   hNCpi0inFVres_stack_7->SetBinError(9,0.3332495);
   hNCpi0inFVres_stack_7->SetBinError(10,0.2800467);
   hNCpi0inFVres_stack_7->SetBinError(11,0.1536621);
   hNCpi0inFVres_stack_7->SetBinError(12,0.2032767);
   hNCpi0inFVres_stack_7->SetBinError(13,0.5259893);
   ...
   hNCpi0inFVdis_stack_8->SetBinContent(1,0.6556541);
   hNCpi0inFVdis_stack_8->SetBinContent(2,0.8228858);
   hNCpi0inFVdis_stack_8->SetBinContent(3,1.47854);
   hNCpi0inFVdis_stack_8->SetBinContent(4,1.937398);
   hNCpi0inFVdis_stack_8->SetBinContent(5,1.45064);
   hNCpi0inFVdis_stack_8->SetBinContent(6,0.9193717);
   hNCpi0inFVdis_stack_8->SetBinContent(7,0.9906222);
   hNCpi0inFVdis_stack_8->SetBinContent(8,0.3620359);
   hNCpi0inFVdis_stack_8->SetBinContent(9,0.334968);
   hNCpi0inFVdis_stack_8->SetBinContent(10,0.404386);
   hNCpi0inFVdis_stack_8->SetBinContent(11,0.460186);
   hNCpi0inFVdis_stack_8->SetBinContent(12,0.2512681);
   hNCpi0inFVdis_stack_8->SetBinContent(13,1.771326);
   hNCpi0inFVdis_stack_8->SetBinError(1,0.3009266);
   hNCpi0inFVdis_stack_8->SetBinError(2,0.2499367);
   hNCpi0inFVdis_stack_8->SetBinError(3,0.3911843);
   hNCpi0inFVdis_stack_8->SetBinError(4,0.4820369);
   hNCpi0inFVdis_stack_8->SetBinError(5,0.3901881);
   hNCpi0inFVdis_stack_8->SetBinError(6,0.2295059);
   hNCpi0inFVdis_stack_8->SetBinError(7,0.3642206);
   hNCpi0inFVdis_stack_8->SetBinError(8,0.1536621);
   hNCpi0inFVdis_stack_8->SetBinError(9,0.2051824);
   hNCpi0inFVdis_stack_8->SetBinError(10,0.2253713);
   hNCpi0inFVdis_stack_8->SetBinError(11,0.2287991);
   hNCpi0inFVdis_stack_8->SetBinError(12,0.1994106);
   hNCpi0inFVdis_stack_8->SetBinError(13,0.4479997);
   ...
   hNCinFV_stack_11->SetBinContent(1,1.513708);
   hNCinFV_stack_11->SetBinContent(2,2.732646);
   ...
   hNCinFV_stack_11->SetBinError(1,0.5875827);
   hNCinFV_stack_11->SetBinError(2,0.8554385);
   ...
   hmcerror__47->SetBinContent(1,6.060304);
   hmcerror__47->SetBinContent(2,25.25197);
   hmcerror__47->SetBinContent(3,25.34882);
   hmcerror__47->SetBinContent(4,27.55915);
   hmcerror__47->SetBinContent(5,24.99064);
   hmcerror__47->SetBinContent(6,11.46069);
   hmcerror__47->SetBinContent(7,9.244857);
   hmcerror__47->SetBinContent(8,4.991816);
   hmcerror__47->SetBinContent(9,2.734073);
   hmcerror__47->SetBinContent(10,3.496576);
   hmcerror__47->SetBinContent(11,4.35296);
   hmcerror__47->SetBinContent(12,2.900743);
   hmcerror__47->SetBinContent(13,18.52404);
   hmcerror__47->SetBinError(1,5.409766);
   hmcerror__47->SetBinError(2,16.41287);
   hmcerror__47->SetBinError(3,13.73549);
   hmcerror__47->SetBinError(4,21.28487);
   hmcerror__47->SetBinError(5,12.86869);
   hmcerror__47->SetBinError(6,8.785063);
   hmcerror__47->SetBinError(7,9.09958);
   hmcerror__47->SetBinError(8,5.945734);
   hmcerror__47->SetBinError(9,3.661044);
   hmcerror__47->SetBinError(10,5.94909);
   hmcerror__47->SetBinError(11,8.413262);
   hmcerror__47->SetBinError(12,2.98874);
   hmcerror__47->SetBinError(13,12.26805);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=0.92#pm0.36","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=0.7/12","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hbadmatch_stack_1","Cosmic, 2.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  31.2","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVdis_stack_8","NC#pi^{0} DIS,  10.1","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 12.2","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3064->SetMaximum(1.900696);
