...
// ------------>Primitives in pad: pad1
   ...
   hmc__4->SetBinContent(1,91.33689);
   hmc__4->SetBinContent(2,187.9225);
   hmc__4->SetBinContent(3,146.1846);
   hmc__4->SetBinContent(4,84.79259);
   hmc__4->SetBinContent(5,46.63012);
   hmc__4->SetBinContent(6,26.17618);
   hmc__4->SetBinContent(7,20.10267);
   hmc__4->SetBinContent(8,9.975119);
   hmc__4->SetBinContent(9,14.52368);
   hmc__4->SetBinContent(10,4.491996);
   hmc__4->SetBinContent(11,6.62814);
   hmc__4->SetBinContent(12,4.329118);
   hmc__4->SetBinContent(13,29.42734);
   hmc__4->SetBinError(1,30.96);
   hmc__4->SetBinError(2,49.79545);
   hmc__4->SetBinError(3,44.47827);
   hmc__4->SetBinError(4,36.94585);
   hmc__4->SetBinError(5,20.18109);
   hmc__4->SetBinError(6,11.20183);
   hmc__4->SetBinError(7,8.736395);
   hmc__4->SetBinError(8,5.845201);
   hmc__4->SetBinError(9,7.084321);
   hmc__4->SetBinError(10,4.706862);
   hmc__4->SetBinError(11,3.925767);
   hmc__4->SetBinError(12,4.272908);
   hmc__4->SetBinError(13,15.87972);
   ...
   hs2_stack_2->SetMaximum(197.3187);
   ...
   houtFV_stack_4->SetBinContent(1,14.67612);
   houtFV_stack_4->SetBinContent(2,17.83552);
   houtFV_stack_4->SetBinContent(3,13.21379);
   houtFV_stack_4->SetBinContent(4,9.985076);
   houtFV_stack_4->SetBinContent(5,5.212921);
   houtFV_stack_4->SetBinContent(6,3.863591);
   houtFV_stack_4->SetBinContent(7,2.926225);
   houtFV_stack_4->SetBinContent(8,0.7932131);
   ...
   houtFV_stack_4->SetBinContent(13,4.617312);
   houtFV_stack_4->SetBinError(1,1.908898);
   houtFV_stack_4->SetBinError(2,2.166199);
   houtFV_stack_4->SetBinError(3,1.774888);
   houtFV_stack_4->SetBinError(4,1.566789);
   houtFV_stack_4->SetBinError(5,1.144576);
   houtFV_stack_4->SetBinError(6,1.020926);
   houtFV_stack_4->SetBinError(7,0.8802632);
   houtFV_stack_4->SetBinError(8,0.4691671);
   ...
   houtFV_stack_4->SetBinError(13,1.07591);
   ...
   hNCpi0inFVcoh_stack_5->SetBinContent(1,1.200435);
   hNCpi0inFVcoh_stack_5->SetBinContent(2,0.4620954);
   hNCpi0inFVcoh_stack_5->SetBinContent(3,1.051525);
   hNCpi0inFVcoh_stack_5->SetBinContent(4,0.6172448);
   hNCpi0inFVcoh_stack_5->SetBinContent(5,0.08294211);
   hNCpi0inFVcoh_stack_5->SetBinContent(6,0.03635368);
   hNCpi0inFVcoh_stack_5->SetBinContent(13,0.324737);
   hNCpi0inFVcoh_stack_5->SetBinError(1,0.4313588);
   hNCpi0inFVcoh_stack_5->SetBinError(2,0.1490414);
   hNCpi0inFVcoh_stack_5->SetBinError(3,0.3931147);
   hNCpi0inFVcoh_stack_5->SetBinError(4,0.3411511);
   hNCpi0inFVcoh_stack_5->SetBinError(5,0.05224462);
   hNCpi0inFVcoh_stack_5->SetBinError(6,0.03635368);
   hNCpi0inFVcoh_stack_5->SetBinError(13,0.2972523);
   ...
   hNCpi0inFVqe_stack_6->SetBinContent(1,0.2067779);
   hNCpi0inFVqe_stack_6->SetBinContent(2,0.1840191);
   hNCpi0inFVqe_stack_6->SetBinContent(3,0.3509374);
   hNCpi0inFVqe_stack_6->SetBinContent(4,0.1349013);
   hNCpi0inFVqe_stack_6->SetBinContent(5,0.1085937);
   hNCpi0inFVqe_stack_6->SetBinContent(6,0.01269218);
   hNCpi0inFVqe_stack_6->SetBinContent(7,0.04427161);
   hNCpi0inFVqe_stack_6->SetBinContent(8,0.0750488);
   hNCpi0inFVqe_stack_6->SetBinContent(13,0.04222719);
   hNCpi0inFVqe_stack_6->SetBinError(1,0.151263);
   hNCpi0inFVqe_stack_6->SetBinError(2,0.0704951);
   hNCpi0inFVqe_stack_6->SetBinError(3,0.1512293);
   hNCpi0inFVqe_stack_6->SetBinError(4,0.06072409);
   hNCpi0inFVqe_stack_6->SetBinError(5,0.07314766);
   hNCpi0inFVqe_stack_6->SetBinError(6,0.01269218);
   hNCpi0inFVqe_stack_6->SetBinError(7,0.04427161);
   hNCpi0inFVqe_stack_6->SetBinError(8,0.0750488);
   hNCpi0inFVqe_stack_6->SetBinError(13,0.04222718);
   ...
   hNCpi0inFVres_stack_7->SetBinContent(1,26.78793);
   hNCpi0inFVres_stack_7->SetBinContent(2,75.62415);
   hNCpi0inFVres_stack_7->SetBinContent(3,69.70245);
   hNCpi0inFVres_stack_7->SetBinContent(4,39.96443);
   hNCpi0inFVres_stack_7->SetBinContent(5,15.6123);
   hNCpi0inFVres_stack_7->SetBinContent(6,6.850429);
   hNCpi0inFVres_stack_7->SetBinContent(7,5.973742);
   hNCpi0inFVres_stack_7->SetBinContent(8,3.352447);
   hNCpi0inFVres_stack_7->SetBinContent(9,2.534568);
   hNCpi0inFVres_stack_7->SetBinContent(10,1.302711);
   hNCpi0inFVres_stack_7->SetBinContent(11,1.17685);
   hNCpi0inFVres_stack_7->SetBinContent(12,1.208552);
   hNCpi0inFVres_stack_7->SetBinContent(13,6.409151);
   hNCpi0inFVres_stack_7->SetBinError(1,1.800805);
   hNCpi0inFVres_stack_7->SetBinError(2,3.040623);
   hNCpi0inFVres_stack_7->SetBinError(3,2.977655);
   hNCpi0inFVres_stack_7->SetBinError(4,2.236146);
   hNCpi0inFVres_stack_7->SetBinError(5,1.286305);
   hNCpi0inFVres_stack_7->SetBinError(6,0.8255541);
   hNCpi0inFVres_stack_7->SetBinError(7,0.9378598);
   hNCpi0inFVres_stack_7->SetBinError(8,0.6803391);
   hNCpi0inFVres_stack_7->SetBinError(9,0.5512564);
   hNCpi0inFVres_stack_7->SetBinError(10,0.4015072);
   hNCpi0inFVres_stack_7->SetBinError(11,0.3613131);
   hNCpi0inFVres_stack_7->SetBinError(12,0.4081081);
   hNCpi0inFVres_stack_7->SetBinError(13,0.8619139);
   ...
   hNCpi0inFVdis_stack_8->SetBinContent(1,4.476361);
   hNCpi0inFVdis_stack_8->SetBinContent(2,11.8283);
   hNCpi0inFVdis_stack_8->SetBinContent(3,7.513932);
   hNCpi0inFVdis_stack_8->SetBinContent(4,4.769101);
   hNCpi0inFVdis_stack_8->SetBinContent(5,2.4938);
   hNCpi0inFVdis_stack_8->SetBinContent(6,1.251913);
   hNCpi0inFVdis_stack_8->SetBinContent(7,1.006647);
   hNCpi0inFVdis_stack_8->SetBinContent(8,0.7718152);
   hNCpi0inFVdis_stack_8->SetBinContent(9,0.2989014);
   hNCpi0inFVdis_stack_8->SetBinContent(10,0.1895911);
   hNCpi0inFVdis_stack_8->SetBinContent(11,0.1805187);
   hNCpi0inFVdis_stack_8->SetBinContent(12,0.1555051);
   hNCpi0inFVdis_stack_8->SetBinContent(13,1.024184);
   hNCpi0inFVdis_stack_8->SetBinError(1,0.5923928);
   hNCpi0inFVdis_stack_8->SetBinError(2,1.32075);
   hNCpi0inFVdis_stack_8->SetBinError(3,0.8913358);
   hNCpi0inFVdis_stack_8->SetBinError(4,0.7381595);
   hNCpi0inFVdis_stack_8->SetBinError(5,0.5079882);
   hNCpi0inFVdis_stack_8->SetBinError(6,0.3729141);
   hNCpi0inFVdis_stack_8->SetBinError(7,0.2835067);
   hNCpi0inFVdis_stack_8->SetBinError(8,0.3123252);
   hNCpi0inFVdis_stack_8->SetBinError(9,0.1316164);
   hNCpi0inFVdis_stack_8->SetBinError(10,0.0810659);
   hNCpi0inFVdis_stack_8->SetBinError(11,0.1314055);
   hNCpi0inFVdis_stack_8->SetBinError(12,0.08390282);
   hNCpi0inFVdis_stack_8->SetBinError(13,0.3523101);
   ...
   hNCpi0inFVmec_stack_9->SetBinContent(2,0.01822845);
   hNCpi0inFVmec_stack_9->SetBinError(1,0.06548985);
   hNCpi0inFVmec_stack_9->SetBinError(2,0.01822846);
   ...
   hNCinFV_stack_11->SetBinContent(1,5.370349);
   hNCinFV_stack_11->SetBinContent(2,9.083329);
   hNCinFV_stack_11->SetBinContent(3,9.620198);
   hNCinFV_stack_11->SetBinContent(4,2.721393);
   hNCinFV_stack_11->SetBinContent(5,3.029869);
   hNCinFV_stack_11->SetBinContent(6,2.267627);
   hNCinFV_stack_11->SetBinContent(7,1.638713);
   hNCinFV_stack_11->SetBinContent(8,0.2995255);
   hNCinFV_stack_11->SetBinContent(9,0.7275017);
   hNCinFV_stack_11->SetBinContent(13,1.299896);
   hNCinFV_stack_11->SetBinError(1,1.104361);
   hNCinFV_stack_11->SetBinError(2,1.469116);
   hNCinFV_stack_11->SetBinError(3,1.646451);
   hNCinFV_stack_11->SetBinError(4,0.6962569);
   hNCinFV_stack_11->SetBinError(5,1.057428);
   hNCinFV_stack_11->SetBinError(6,0.7930279);
   hNCinFV_stack_11->SetBinError(7,0.6015678);
   hNCinFV_stack_11->SetBinError(8,0.2219614);
   hNCinFV_stack_11->SetBinError(9,0.415131);
   hNCinFV_stack_11->SetBinError(13,0.5729451);
   ...
   hmcerror__5->SetBinContent(1,91.33689);
   hmcerror__5->SetBinContent(2,187.9225);
   hmcerror__5->SetBinContent(3,146.1846);
   hmcerror__5->SetBinContent(4,84.79259);
   hmcerror__5->SetBinContent(5,46.63012);
   hmcerror__5->SetBinContent(6,26.17618);
   hmcerror__5->SetBinContent(7,20.10267);
   hmcerror__5->SetBinContent(8,9.975119);
   hmcerror__5->SetBinContent(9,14.52368);
   hmcerror__5->SetBinContent(10,4.491996);
   hmcerror__5->SetBinContent(11,6.62814);
   hmcerror__5->SetBinContent(12,4.329118);
   hmcerror__5->SetBinContent(13,29.42734);
   hmcerror__5->SetBinError(1,30.96);
   hmcerror__5->SetBinError(2,49.79545);
   hmcerror__5->SetBinError(3,44.47827);
   hmcerror__5->SetBinError(4,36.94585);
   hmcerror__5->SetBinError(5,20.18109);
   hmcerror__5->SetBinError(6,11.20183);
   hmcerror__5->SetBinError(7,8.736395);
   hmcerror__5->SetBinError(8,5.845201);
   hmcerror__5->SetBinError(9,7.084321);
   hmcerror__5->SetBinError(10,4.706862);
   hmcerror__5->SetBinError(11,3.925767);
   hmcerror__5->SetBinError(12,4.272908);
   hmcerror__5->SetBinError(13,15.87972);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=1.03#pm0.27","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=6.3/12","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hbadmatch_stack_1","Cosmic, 16.3","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("houtFV_stack_4","Out FV, 73.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  250.1","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVdis_stack_8","NC#pi^{0} DIS,  34.9","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 34.8","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3008->SetMaximum(1.573615);
