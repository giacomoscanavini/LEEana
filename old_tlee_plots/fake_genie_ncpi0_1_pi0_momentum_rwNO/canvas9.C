...
// ------------>Primitives in pad: pad1
   ...
   hmc__25->SetBinContent(1,69.37355);
   hmc__25->SetBinContent(2,178.916);
   hmc__25->SetBinContent(3,131.8127);
   hmc__25->SetBinContent(4,102.7016);
   hmc__25->SetBinContent(5,62.54008);
   hmc__25->SetBinContent(6,45.66901);
   hmc__25->SetBinContent(7,26.00215);
   hmc__25->SetBinContent(8,14.41253);
   hmc__25->SetBinContent(9,10.91033);
   hmc__25->SetBinContent(10,10.91033);
   hmc__25->SetBinContent(11,13.66044);
   hmc__25->SetBinContent(12,5.456155);
   hmc__25->SetBinContent(13,33.55899);
   hmc__25->SetBinError(1,29.95569);
   hmc__25->SetBinError(2,61.86651);
   hmc__25->SetBinError(3,41.83535);
   hmc__25->SetBinError(4,36.24091);
   hmc__25->SetBinError(5,21.66473);
   hmc__25->SetBinError(6,21.35536);
   hmc__25->SetBinError(7,21.59237);
   hmc__25->SetBinError(8,11.58092);
   hmc__25->SetBinError(9,8.865017);
   hmc__25->SetBinError(10,10.66921);
   hmc__25->SetBinError(11,14.91722);
   hmc__25->SetBinError(12,6.427763);
   hmc__25->SetBinError(13,17.77995);
   ...
   hs9_stack_9->SetMaximum(187.8618);
   ...
   hbadmatch_stack_1->SetBinContent(2,7.094947);
   hbadmatch_stack_1->SetBinContent(3,7.049906);
   hbadmatch_stack_1->SetBinContent(4,4.123856);
   ...
   hbadmatch_stack_1->SetBinError(2,2.685088);
   hbadmatch_stack_1->SetBinError(3,2.666285);
   hbadmatch_stack_1->SetBinError(4,2.066213);
   ...
   houtFV_stack_4->SetBinContent(1,12.90338);
   houtFV_stack_4->SetBinContent(2,30.36234);
   houtFV_stack_4->SetBinContent(3,21.83649);
   houtFV_stack_4->SetBinContent(4,18.85879);
   houtFV_stack_4->SetBinContent(5,17.12078);
   ...
   houtFV_stack_4->SetBinContent(11,4.235997);
   houtFV_stack_4->SetBinContent(12,2.977704);
   houtFV_stack_4->SetBinContent(13,9.382067);
   houtFV_stack_4->SetBinError(1,3.578754);
   houtFV_stack_4->SetBinError(2,5.559304);
   houtFV_stack_4->SetBinError(3,4.655556);
   houtFV_stack_4->SetBinError(4,4.326503);
   houtFV_stack_4->SetBinError(5,4.159315);
   ...
   houtFV_stack_4->SetBinError(11,2.130464);
   houtFV_stack_4->SetBinError(12,1.719178);
   houtFV_stack_4->SetBinError(13,3.155871);
   ...
   hNCpi0inFVcoh_stack_5->SetBinContent(3,0.4952944);
   hNCpi0inFVcoh_stack_5->SetBinContent(5,0.4952944);
   hNCpi0inFVcoh_stack_5->SetBinContent(11,0.4952944);
   hNCpi0inFVcoh_stack_5->SetBinError(3,0.4952944);
   hNCpi0inFVcoh_stack_5->SetBinError(5,0.4952944);
   ...
   hNCpi0inFVres_stack_7->SetBinContent(1,9.905888);
   hNCpi0inFVres_stack_7->SetBinContent(2,42.59532);
   hNCpi0inFVres_stack_7->SetBinContent(3,33.68002);
   hNCpi0inFVres_stack_7->SetBinContent(4,27.73649);
   hNCpi0inFVres_stack_7->SetBinContent(5,15.84942);
   hNCpi0inFVres_stack_7->SetBinContent(6,11.39177);
   hNCpi0inFVres_stack_7->SetBinContent(7,3.467061);
   hNCpi0inFVres_stack_7->SetBinContent(8,2.476472);
   hNCpi0inFVres_stack_7->SetBinContent(9,3.962355);
   hNCpi0inFVres_stack_7->SetBinContent(10,3.467061);
   hNCpi0inFVres_stack_7->SetBinContent(11,1.485883);
   hNCpi0inFVres_stack_7->SetBinContent(12,1.485883);
   hNCpi0inFVres_stack_7->SetBinContent(13,6.438827);
   hNCpi0inFVres_stack_7->SetBinError(1,2.215024);
   hNCpi0inFVres_stack_7->SetBinError(2,4.593171);
   hNCpi0inFVres_stack_7->SetBinError(3,4.084302);
   hNCpi0inFVres_stack_7->SetBinError(4,3.706444);
   hNCpi0inFVres_stack_7->SetBinError(5,2.801808);
   hNCpi0inFVres_stack_7->SetBinError(6,2.375348);
   hNCpi0inFVres_stack_7->SetBinError(7,1.310426);
   hNCpi0inFVres_stack_7->SetBinError(8,1.107512);
   hNCpi0inFVres_stack_7->SetBinError(9,1.400904);
   hNCpi0inFVres_stack_7->SetBinError(10,1.310426);
   hNCpi0inFVres_stack_7->SetBinError(11,0.857875);
   hNCpi0inFVres_stack_7->SetBinError(12,0.857875);
   hNCpi0inFVres_stack_7->SetBinError(13,1.785809);
   ...
   hNCpi0inFVdis_stack_8->SetBinContent(1,2.476472);
   hNCpi0inFVdis_stack_8->SetBinContent(2,5.448238);
   hNCpi0inFVdis_stack_8->SetBinContent(3,7.92471);
   hNCpi0inFVdis_stack_8->SetBinContent(4,8.915298);
   hNCpi0inFVdis_stack_8->SetBinContent(5,3.467061);
   hNCpi0inFVdis_stack_8->SetBinContent(6,2.476472);
   hNCpi0inFVdis_stack_8->SetBinContent(7,1.981178);
   hNCpi0inFVdis_stack_8->SetBinContent(8,1.485883);
   hNCpi0inFVdis_stack_8->SetBinContent(10,0.4952944);
   hNCpi0inFVdis_stack_8->SetBinContent(11,0.4952944);
   hNCpi0inFVdis_stack_8->SetBinContent(13,1.981178);
   hNCpi0inFVdis_stack_8->SetBinError(1,1.107512);
   hNCpi0inFVdis_stack_8->SetBinError(2,1.642706);
   hNCpi0inFVdis_stack_8->SetBinError(3,1.981178);
   hNCpi0inFVdis_stack_8->SetBinError(4,2.101356);
   hNCpi0inFVdis_stack_8->SetBinError(5,1.310426);
   hNCpi0inFVdis_stack_8->SetBinError(6,1.107512);
   hNCpi0inFVdis_stack_8->SetBinError(7,0.9905888);
   hNCpi0inFVdis_stack_8->SetBinError(8,0.857875);
   hNCpi0inFVdis_stack_8->SetBinError(10,0.4952944);
   hNCpi0inFVdis_stack_8->SetBinError(11,0.4952944);
   hNCpi0inFVdis_stack_8->SetBinError(13,0.9905888);
   ...
   hNCinFV_stack_11->SetBinContent(2,7.940543);
   hNCinFV_stack_11->SetBinContent(3,3.970271);
   hNCinFV_stack_11->SetBinContent(4,9.925678);
   hNCinFV_stack_11->SetBinContent(5,2.977704);
   hNCinFV_stack_11->SetBinContent(6,2.977704);
   hNCinFV_stack_11->SetBinContent(7,1.985136);
   hNCinFV_stack_11->SetBinContent(8,1.985136);
   ...
   hNCinFV_stack_11->SetBinError(2,2.807406);
   hNCinFV_stack_11->SetBinError(3,1.985136);
   hNCinFV_stack_11->SetBinError(4,3.138775);
   hNCinFV_stack_11->SetBinError(5,1.719178);
   hNCinFV_stack_11->SetBinError(6,1.719178);
   hNCinFV_stack_11->SetBinError(7,1.403703);
   hNCinFV_stack_11->SetBinError(8,1.403703);
   ...
   hmcerror__26->SetBinContent(1,69.37355);
   hmcerror__26->SetBinContent(2,178.916);
   hmcerror__26->SetBinContent(3,131.8127);
   hmcerror__26->SetBinContent(4,102.7016);
   hmcerror__26->SetBinContent(5,62.54008);
   hmcerror__26->SetBinContent(6,45.66901);
   hmcerror__26->SetBinContent(7,26.00215);
   hmcerror__26->SetBinContent(8,14.41253);
   hmcerror__26->SetBinContent(9,10.91033);
   hmcerror__26->SetBinContent(10,10.91033);
   hmcerror__26->SetBinContent(11,13.66044);
   hmcerror__26->SetBinContent(12,5.456155);
   hmcerror__26->SetBinContent(13,33.55899);
   hmcerror__26->SetBinError(1,29.95569);
   hmcerror__26->SetBinError(2,61.86651);
   hmcerror__26->SetBinError(3,41.83535);
   hmcerror__26->SetBinError(4,36.24091);
   hmcerror__26->SetBinError(5,21.66473);
   hmcerror__26->SetBinError(6,21.35536);
   hmcerror__26->SetBinError(7,21.59237);
   hmcerror__26->SetBinError(8,11.58092);
   hmcerror__26->SetBinError(9,8.865017);
   hmcerror__26->SetBinError(10,10.66921);
   hmcerror__26->SetBinError(11,14.91722);
   hmcerror__26->SetBinError(12,6.427763);
   hmcerror__26->SetBinError(13,17.77995);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=1.07#pm0.28","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hbadmatch_stack_1","Cosmic, 22.4","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("houtFV_stack_4","Out FV, 136.3","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVcoh_stack_5","NC#pi^{0} COH,  1.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  157.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 37.7","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3036->SetMaximum(1.706807);
