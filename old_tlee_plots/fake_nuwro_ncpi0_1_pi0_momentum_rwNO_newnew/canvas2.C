...
//=========  (Mon Jan 16 03:24:33 2023) by ROOT version 6.26/00
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hmc__4 = new TH1F("hmc__4","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   hmc__4->SetBinError(1,122.726);
   hmc__4->SetBinError(2,288.1485);
   hmc__4->SetBinError(3,263.0186);
   hmc__4->SetBinError(4,182.7843);
   hmc__4->SetBinError(5,116.8261);
   hmc__4->SetBinError(6,68.69165);
   hmc__4->SetBinError(7,39.86502);
   hmc__4->SetBinError(8,27.48276);
   hmc__4->SetBinError(9,23.21275);
   hmc__4->SetBinError(10,17.47638);
   hmc__4->SetBinError(11,20.08061);
   hmc__4->SetBinError(12,14.53808);
   hmc__4->SetBinError(13,83.22081);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hNCpi0inFVcoh_stack_5 = new TH1F("hNCpi0inFVcoh_stack_5","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hNCpi0inFVqe_stack_6 = new TH1F("hNCpi0inFVqe_stack_6","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hNCpi0inFVres_stack_7 = new TH1F("hNCpi0inFVres_stack_7","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hNCpi0inFVdis_stack_8 = new TH1F("hNCpi0inFVdis_stack_8","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hNCpi0inFVmec_stack_9 = new TH1F("hNCpi0inFVmec_stack_9","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hCCpi0inFV_stack_10 = new TH1F("hCCpi0inFV_stack_10","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hNCinFV_stack_11 = new TH1F("hNCinFV_stack_11","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hnumuCCinFV_stack_12 = new TH1F("hnumuCCinFV_stack_12","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hnueCCinFV_stack_13 = new TH1F("hnueCCinFV_stack_13","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   TH1F *hmcerror__5 = new TH1F("hmcerror__5","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
   ...
   hmcerror__5->SetBinError(1,122.726);
   hmcerror__5->SetBinError(2,288.1485);
   hmcerror__5->SetBinError(3,263.0186);
   hmcerror__5->SetBinError(4,182.7843);
   hmcerror__5->SetBinError(5,116.8261);
   hmcerror__5->SetBinError(6,68.69165);
   hmcerror__5->SetBinError(7,39.86502);
   hmcerror__5->SetBinError(8,27.48276);
   hmcerror__5->SetBinError(9,23.21275);
   hmcerror__5->SetBinError(10,17.47638);
   hmcerror__5->SetBinError(11,20.08061);
   hmcerror__5->SetBinError(12,14.53808);
   hmcerror__5->SetBinError(13,83.22081);
   ...
   pt->SetLineWidth(2);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("NCpi0BDT_FC_bnb_6_pi0_momentum_all");
   pt->Draw();
   pad1->Modified();
   canvas2->cd();
...
// ------------>Primitives in pad: pad2
   ...
   TH1F *hist__6 = new TH1F("hist__6","NCpi0BDT_FC_bnb_6_pi0_momentum_all",12,0,1200);
