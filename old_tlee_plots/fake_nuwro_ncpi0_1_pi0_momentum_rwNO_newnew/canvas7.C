...
// ------------>Primitives in pad: pad1
   ...
   hmc__19->SetBinError(1,56.88094);
   hmc__19->SetBinError(2,174.4861);
   hmc__19->SetBinError(3,160.2692);
   hmc__19->SetBinError(4,102.4416);
   hmc__19->SetBinError(5,69.47669);
   hmc__19->SetBinError(6,39.69843);
   hmc__19->SetBinError(7,22.01265);
   hmc__19->SetBinError(8,17.50114);
   hmc__19->SetBinError(9,11.54077);
   hmc__19->SetBinError(10,12.35006);
   hmc__19->SetBinError(11,14.11242);
   hmc__19->SetBinError(12,10.77774);
   hmc__19->SetBinError(13,51.42564);
   ...
   hmcerror__20->SetBinError(1,56.88094);
   hmcerror__20->SetBinError(2,174.4861);
   hmcerror__20->SetBinError(3,160.2692);
   hmcerror__20->SetBinError(4,102.4416);
   hmcerror__20->SetBinError(5,69.47669);
   hmcerror__20->SetBinError(6,39.69843);
   hmcerror__20->SetBinError(7,22.01265);
   hmcerror__20->SetBinError(8,17.50114);
   hmcerror__20->SetBinError(9,11.54077);
   hmcerror__20->SetBinError(10,12.35006);
   hmcerror__20->SetBinError(11,14.11242);
   hmcerror__20->SetBinError(12,10.77774);
   hmcerror__20->SetBinError(13,51.42564);
