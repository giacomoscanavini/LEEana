...
// ------------>Primitives in pad: pad1
   ...
   hmc__13->SetBinError(1,67.9752);
   hmc__13->SetBinError(2,211.9668);
   hmc__13->SetBinError(3,190.675);
   hmc__13->SetBinError(4,127.3478);
   hmc__13->SetBinError(5,83.03835);
   hmc__13->SetBinError(6,45.37645);
   hmc__13->SetBinError(7,32.32856);
   hmc__13->SetBinError(8,21.36922);
   hmc__13->SetBinError(9,14.30439);
   hmc__13->SetBinError(10,14.20115);
   hmc__13->SetBinError(11,16.54963);
   hmc__13->SetBinError(12,11.52091);
   hmc__13->SetBinError(13,62.35985);
   ...
   hmcerror__14->SetBinError(1,67.9752);
   hmcerror__14->SetBinError(2,211.9668);
   hmcerror__14->SetBinError(3,190.675);
   hmcerror__14->SetBinError(4,127.3478);
   hmcerror__14->SetBinError(5,83.03835);
   hmcerror__14->SetBinError(6,45.37645);
   hmcerror__14->SetBinError(7,32.32856);
   hmcerror__14->SetBinError(8,21.36922);
   hmcerror__14->SetBinError(9,14.30439);
   hmcerror__14->SetBinError(10,14.20115);
   hmcerror__14->SetBinError(11,16.54963);
   hmcerror__14->SetBinError(12,11.52091);
   hmcerror__14->SetBinError(13,62.35985);
