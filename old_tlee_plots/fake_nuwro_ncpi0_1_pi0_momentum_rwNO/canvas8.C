...
// ------------>Primitives in pad: pad1
   ...
   hmc__22->SetBinError(1,32.65218);
   hmc__22->SetBinError(2,48.17802);
   hmc__22->SetBinError(3,42.51704);
   hmc__22->SetBinError(4,36.007);
   hmc__22->SetBinError(5,35.70846);
   hmc__22->SetBinError(6,21.92411);
   hmc__22->SetBinError(7,11.25006);
   hmc__22->SetBinError(8,12.12922);
   hmc__22->SetBinError(9,9.920566);
   hmc__22->SetBinError(10,9.743908);
   hmc__22->SetBinError(11,4.909549);
   hmc__22->SetBinError(12,7.163234);
   hmc__22->SetBinError(13,22.15218);
   ...
   hmcerror__23->SetBinError(1,32.65218);
   hmcerror__23->SetBinError(2,48.17802);
   hmcerror__23->SetBinError(3,42.51704);
   hmcerror__23->SetBinError(4,36.007);
   hmcerror__23->SetBinError(5,35.70846);
   hmcerror__23->SetBinError(6,21.92411);
   hmcerror__23->SetBinError(7,11.25006);
   hmcerror__23->SetBinError(8,12.12922);
   hmcerror__23->SetBinError(9,9.920566);
   hmcerror__23->SetBinError(10,9.743908);
   hmcerror__23->SetBinError(11,4.909549);
   hmcerror__23->SetBinError(12,7.163234);
   hmcerror__23->SetBinError(13,22.15218);
