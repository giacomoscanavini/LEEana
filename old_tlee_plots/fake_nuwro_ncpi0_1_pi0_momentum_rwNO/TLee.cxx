...
void TLee::Plotting_systematics()
{
  ...
  int color_flux       = kRed;
  int color_Xs         = kBlue;
  int color_genie      = kBlue;
  int color_genat4     = kBlue-7;
  ...
  int color_reweight_tot  = kYellow+1;
    
  int rows = bins_newworld;
  int num_ch = map_data_spectrum_ch_bin.size();
  
  if( color_flux+color_Xs+color_genie+color_genat4+color_detector+color_additional+color_mc_stat+color_total+rows+num_ch==0 ) cout<<" test "<<endl;
...
void TLee::Set_Spectra_MatrixCov()
{
  ...
  map_input_spectrum_ch_str[10] = "ext"; //"bnb9";
  map_input_spectrum_ch_str[11] = "ext1"; //"bnb10";
  map_input_spectrum_ch_str[12] = "ext2"; //"bnb11";
  map_input_spectrum_ch_str[13] = "ext3"; //"bnb12";
  map_input_spectrum_ch_str[14] = "ext4"; //"bnb13";
  map_input_spectrum_ch_str[15] = "ext5"; //"bnb14";
  map_input_spectrum_ch_str[16] = "ext6"; //"bnb15";
  map_input_spectrum_ch_str[17] = "ext7"; //"ext";
  map_input_spectrum_ch_str[18] = "ext8"; //"ext1";
  */
  ...
  //*/
  /*
  //map_input_spectrum_ch_str[19] = "ext2";
  //map_input_spectrum_ch_str[20] = "ext3";
  //map_input_spectrum_ch_str[21] = "ext4";
  //map_input_spectrum_ch_str[22] = "ext5";
  //map_input_spectrum_ch_str[23] = "ext6";
  //map_input_spectrum_ch_str[24] = "ext7";
  //map_input_spectrum_ch_str[25] = "ext8";
  //map_input_spectrum_ch_str[26] = "ext9";
  //map_input_spectrum_ch_str[27] = "ext10";
  //map_input_spectrum_ch_str[28] = "ext11";
...
*/  
  ...
  for( auto it=map_detectorfile_str.begin(); it!=map_detectorfile_str.end(); it++ ) {
    ...
    matrix_detector_frac += (*map_matrix_detector_frac[idx]);  // Comment out No DET SYS (turn off)
