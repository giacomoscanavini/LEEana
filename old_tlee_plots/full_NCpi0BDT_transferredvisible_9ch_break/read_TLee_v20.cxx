...
int main(int argc, char** argv)
{
  ...
  if(1){
    int bins_h1 = 20; // number of bins in cov_input for obsr 1
    int bins_h2 = 20; // number of bins in cov_input for obsr 2
    int bins_h3 = 20; // number of bins in cov_input for obsr 3
    int bins_h4 = 20; // number of bins in cov_input for obsr 4
    int bins_h5 = 20; // number of bins in cov_input for obsr 5
    int bins_h6 = 20; // number of bins in cov_input for obsr 6
    int bins_h7 = 20; // number of bins in cov_input for obsr 7
    int bins_h8 = 20; // number of bins in cov_input for obsr 8
    int bins_h9 = 20; // number of bins in cov_input for obsr 9
