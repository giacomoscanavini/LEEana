...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-184.6154,-15.2475,1353.846,1686.053);
   pad1->SetFillColor(0);
   ...
   hmc__13->SetBinContent(1,288.0728);
   hmc__13->SetBinContent(2,762.3752);
   hmc__13->SetBinContent(3,605.3163);
   hmc__13->SetBinContent(4,410.8682);
   hmc__13->SetBinContent(5,283.0611);
   hmc__13->SetBinContent(6,172.5272);
   hmc__13->SetBinContent(7,108.6599);
   hmc__13->SetBinContent(8,63.00926);
   hmc__13->SetBinContent(9,44.74158);
   hmc__13->SetBinContent(10,35.23596);
   hmc__13->SetBinContent(11,32.22511);
   hmc__13->SetBinContent(12,28.65591);
   hmc__13->SetBinContent(13,214.895);
   hmc__13->SetBinError(1,94.2928);
   hmc__13->SetBinError(2,314.5139);
   hmc__13->SetBinError(3,242.1323);
   hmc__13->SetBinError(4,153.9487);
   hmc__13->SetBinError(5,96.59602);
   hmc__13->SetBinError(6,51.34661);
   hmc__13->SetBinError(7,34.36869);
   hmc__13->SetBinError(8,21.91844);
   hmc__13->SetBinError(9,15.652);
   hmc__13->SetBinError(10,14.97698);
   hmc__13->SetBinError(11,15.71754);
   hmc__13->SetBinError(12,12.16851);
   hmc__13->SetBinError(13,59.4794);
   hmc__13->SetMinimum(-15.2475);
   hmc__13->SetMaximum(1600.988);
   ...
   hs5_stack_5->SetMaximum(800.4939);
   ...
   hbadmatch_stack_1->SetBinContent(1,12.29024);
   hbadmatch_stack_1->SetBinContent(2,19.802);
   hbadmatch_stack_1->SetBinContent(3,14.72097);
   hbadmatch_stack_1->SetBinContent(4,7.310267);
   hbadmatch_stack_1->SetBinContent(5,5.543101);
   hbadmatch_stack_1->SetBinContent(6,3.535358);
   hbadmatch_stack_1->SetBinContent(7,2.439495);
   hbadmatch_stack_1->SetBinContent(8,1.744771);
   hbadmatch_stack_1->SetBinContent(9,1.725098);
   hbadmatch_stack_1->SetBinContent(10,1.455463);
   ...
   hbadmatch_stack_1->SetBinError(1,1.856589);
   hbadmatch_stack_1->SetBinError(2,3.096742);
   hbadmatch_stack_1->SetBinError(3,2.009506);
   hbadmatch_stack_1->SetBinError(4,1.317417);
   hbadmatch_stack_1->SetBinError(5,1.247591);
   hbadmatch_stack_1->SetBinError(6,1.030007);
   hbadmatch_stack_1->SetBinError(7,0.8152822);
   hbadmatch_stack_1->SetBinError(8,0.7950867);
   hbadmatch_stack_1->SetBinError(9,0.8197973);
   hbadmatch_stack_1->SetBinError(10,0.6459088);
   ...
   houtFV_stack_4->SetBinContent(1,18.60808);
   houtFV_stack_4->SetBinContent(2,39.94586);
   houtFV_stack_4->SetBinContent(3,40.54666);
   houtFV_stack_4->SetBinContent(4,24.20637);
   houtFV_stack_4->SetBinContent(5,20.20094);
   houtFV_stack_4->SetBinContent(6,11.90302);
   houtFV_stack_4->SetBinContent(7,8.254915);
   houtFV_stack_4->SetBinContent(8,4.335661);
   houtFV_stack_4->SetBinContent(9,4.630158);
   houtFV_stack_4->SetBinContent(10,4.816898);
   houtFV_stack_4->SetBinContent(11,2.95811);
   houtFV_stack_4->SetBinContent(12,3.643207);
   houtFV_stack_4->SetBinContent(13,19.01972);
   houtFV_stack_4->SetBinError(1,2.125726);
   houtFV_stack_4->SetBinError(2,3.14233);
   houtFV_stack_4->SetBinError(3,3.139585);
   houtFV_stack_4->SetBinError(4,2.479046);
   houtFV_stack_4->SetBinError(5,2.271685);
   houtFV_stack_4->SetBinError(6,1.765585);
   houtFV_stack_4->SetBinError(7,1.411575);
   houtFV_stack_4->SetBinError(8,1.145351);
   houtFV_stack_4->SetBinError(9,1.170629);
   houtFV_stack_4->SetBinError(10,1.285861);
   houtFV_stack_4->SetBinError(11,0.8931856);
   houtFV_stack_4->SetBinError(12,0.9118069);
   houtFV_stack_4->SetBinError(13,2.188833);
   ...
   hNCpi0inFVcoh_stack_5->SetBinContent(2,0.7001317);
   hNCpi0inFVcoh_stack_5->SetBinContent(3,1.651998);
   hNCpi0inFVcoh_stack_5->SetBinContent(4,0.6389689);
   hNCpi0inFVcoh_stack_5->SetBinContent(5,0.6332626);
   hNCpi0inFVcoh_stack_5->SetBinContent(6,0.3322204);
   hNCpi0inFVcoh_stack_5->SetBinContent(7,0.09948429);
   hNCpi0inFVcoh_stack_5->SetBinContent(8,0.1086633);
   hNCpi0inFVcoh_stack_5->SetBinContent(10,0.1420471);
   hNCpi0inFVcoh_stack_5->SetBinContent(11,0.1848961);
   hNCpi0inFVcoh_stack_5->SetBinContent(12,0.05652677);
   hNCpi0inFVcoh_stack_5->SetBinContent(13,0.7962698);
   hNCpi0inFVcoh_stack_5->SetBinError(1,0.09063352);
   hNCpi0inFVcoh_stack_5->SetBinError(2,0.2673123);
   hNCpi0inFVcoh_stack_5->SetBinError(3,0.4881448);
   hNCpi0inFVcoh_stack_5->SetBinError(4,0.2377494);
   hNCpi0inFVcoh_stack_5->SetBinError(5,0.2218541);
   hNCpi0inFVcoh_stack_5->SetBinError(6,0.1780179);
   hNCpi0inFVcoh_stack_5->SetBinError(7,0.05174643);
   hNCpi0inFVcoh_stack_5->SetBinError(8,0.0678294);
   hNCpi0inFVcoh_stack_5->SetBinError(10,0.06870455);
   hNCpi0inFVcoh_stack_5->SetBinError(11,0.1175188);
   hNCpi0inFVcoh_stack_5->SetBinError(12,0.03997376);
   hNCpi0inFVcoh_stack_5->SetBinError(13,0.2648006);
   ...
   hNCpi0inFVqe_stack_6->SetBinContent(1,1.488152);
   hNCpi0inFVqe_stack_6->SetBinContent(2,3.828741);
   hNCpi0inFVqe_stack_6->SetBinContent(3,2.62106);
   hNCpi0inFVqe_stack_6->SetBinContent(4,2.134986);
   hNCpi0inFVqe_stack_6->SetBinContent(5,0.4988099);
   hNCpi0inFVqe_stack_6->SetBinContent(6,0.1910472);
   hNCpi0inFVqe_stack_6->SetBinContent(7,0.2296005);
   ...
   hNCpi0inFVqe_stack_6->SetBinContent(13,0.4521932);
   hNCpi0inFVqe_stack_6->SetBinError(1,0.2676263);
   hNCpi0inFVqe_stack_6->SetBinError(2,0.5581458);
   hNCpi0inFVqe_stack_6->SetBinError(3,0.4284736);
   hNCpi0inFVqe_stack_6->SetBinError(4,0.5085339);
   hNCpi0inFVqe_stack_6->SetBinError(5,0.1562171);
   hNCpi0inFVqe_stack_6->SetBinError(6,0.1340302);
   hNCpi0inFVqe_stack_6->SetBinError(7,0.08771718);
   ...
   hNCpi0inFVqe_stack_6->SetBinError(13,0.1743399);
   ...
   hNCpi0inFVres_stack_7->SetBinContent(1,73.07378);
   hNCpi0inFVres_stack_7->SetBinContent(2,259.829);
   hNCpi0inFVres_stack_7->SetBinContent(3,232.0424);
   hNCpi0inFVres_stack_7->SetBinContent(4,155.5678);
   hNCpi0inFVres_stack_7->SetBinContent(5,102.6798);
   hNCpi0inFVres_stack_7->SetBinContent(6,55.79164);
   hNCpi0inFVres_stack_7->SetBinContent(7,30.38152);
   hNCpi0inFVres_stack_7->SetBinContent(8,16.80753);
   hNCpi0inFVres_stack_7->SetBinContent(9,14.56759);
   hNCpi0inFVres_stack_7->SetBinContent(10,9.613868);
   hNCpi0inFVres_stack_7->SetBinContent(11,7.959413);
   hNCpi0inFVres_stack_7->SetBinContent(12,5.825256);
   hNCpi0inFVres_stack_7->SetBinContent(13,53.53104);
   hNCpi0inFVres_stack_7->SetBinError(1,2.519112);
   hNCpi0inFVres_stack_7->SetBinError(2,4.578359);
   hNCpi0inFVres_stack_7->SetBinError(3,4.470202);
   hNCpi0inFVres_stack_7->SetBinError(4,3.663264);
   hNCpi0inFVres_stack_7->SetBinError(5,3.132823);
   hNCpi0inFVres_stack_7->SetBinError(6,2.49287);
   hNCpi0inFVres_stack_7->SetBinError(7,1.949195);
   hNCpi0inFVres_stack_7->SetBinError(8,1.382262);
   hNCpi0inFVres_stack_7->SetBinError(9,1.470023);
   hNCpi0inFVres_stack_7->SetBinError(10,1.195514);
   hNCpi0inFVres_stack_7->SetBinError(11,1.022876);
   hNCpi0inFVres_stack_7->SetBinError(12,0.9916129);
   hNCpi0inFVres_stack_7->SetBinError(13,2.563644);
   ...
   hNCpi0inFVdis_stack_8->SetBinContent(1,19.98485);
   hNCpi0inFVdis_stack_8->SetBinContent(2,52.17248);
   hNCpi0inFVdis_stack_8->SetBinContent(3,41.55816);
   hNCpi0inFVdis_stack_8->SetBinContent(4,31.73201);
   hNCpi0inFVdis_stack_8->SetBinContent(5,23.81243);
   hNCpi0inFVdis_stack_8->SetBinContent(6,15.45287);
   hNCpi0inFVdis_stack_8->SetBinContent(7,9.633424);
   hNCpi0inFVdis_stack_8->SetBinContent(8,6.349647);
   hNCpi0inFVdis_stack_8->SetBinContent(9,5.400152);
   hNCpi0inFVdis_stack_8->SetBinContent(10,2.673704);
   hNCpi0inFVdis_stack_8->SetBinContent(11,2.567807);
   hNCpi0inFVdis_stack_8->SetBinContent(12,3.260552);
   hNCpi0inFVdis_stack_8->SetBinContent(13,20.90054);
   hNCpi0inFVdis_stack_8->SetBinError(1,1.458914);
   hNCpi0inFVdis_stack_8->SetBinError(2,2.194767);
   hNCpi0inFVdis_stack_8->SetBinError(3,2.058109);
   hNCpi0inFVdis_stack_8->SetBinError(4,1.836512);
   hNCpi0inFVdis_stack_8->SetBinError(5,1.836294);
   hNCpi0inFVdis_stack_8->SetBinError(6,1.387428);
   hNCpi0inFVdis_stack_8->SetBinError(7,1.224577);
   hNCpi0inFVdis_stack_8->SetBinError(8,0.8398462);
   hNCpi0inFVdis_stack_8->SetBinError(9,0.9684411);
   hNCpi0inFVdis_stack_8->SetBinError(10,0.5515582);
   hNCpi0inFVdis_stack_8->SetBinError(11,0.7293845);
   hNCpi0inFVdis_stack_8->SetBinError(12,0.7983641);
   hNCpi0inFVdis_stack_8->SetBinError(13,1.891974);
   ...
   hNCpi0inFVmec_stack_9->SetBinContent(1,0.2585419);
   hNCpi0inFVmec_stack_9->SetBinContent(2,0.4769952);
   hNCpi0inFVmec_stack_9->SetBinContent(3,0.05527143);
   hNCpi0inFVmec_stack_9->SetBinContent(5,0.03762904);
   hNCpi0inFVmec_stack_9->SetBinContent(8,0.04222719);
   hNCpi0inFVmec_stack_9->SetBinError(1,0.1354477);
   hNCpi0inFVmec_stack_9->SetBinError(2,0.1917227);
   hNCpi0inFVmec_stack_9->SetBinError(3,0.03191456);
   ...
   hNCinFV_stack_11->SetBinContent(1,36.34021);
   hNCinFV_stack_11->SetBinContent(2,75.71756);
   hNCinFV_stack_11->SetBinContent(3,49.20485);
   hNCinFV_stack_11->SetBinContent(4,29.9483);
   hNCinFV_stack_11->SetBinContent(5,22.57551);
   hNCinFV_stack_11->SetBinContent(6,18.09171);
   hNCinFV_stack_11->SetBinContent(7,10.82097);
   hNCinFV_stack_11->SetBinContent(8,6.694695);
   hNCinFV_stack_11->SetBinContent(9,2.318169);
   hNCinFV_stack_11->SetBinContent(10,3.251019);
   hNCinFV_stack_11->SetBinContent(11,3.749928);
   hNCinFV_stack_11->SetBinContent(12,2.994885);
   hNCinFV_stack_11->SetBinContent(13,21.70734);
   hNCinFV_stack_11->SetBinError(1,3.217681);
   hNCinFV_stack_11->SetBinError(2,4.873843);
   hNCinFV_stack_11->SetBinError(3,3.818677);
   hNCinFV_stack_11->SetBinError(4,2.967951);
   hNCinFV_stack_11->SetBinError(5,2.570788);
   hNCinFV_stack_11->SetBinError(6,2.478794);
   hNCinFV_stack_11->SetBinError(7,1.810805);
   hNCinFV_stack_11->SetBinError(8,1.516023);
   hNCinFV_stack_11->SetBinError(9,0.8760869);
   hNCinFV_stack_11->SetBinError(10,1.041955);
   hNCinFV_stack_11->SetBinError(11,1.000866);
   hNCinFV_stack_11->SetBinError(12,1.175751);
   hNCinFV_stack_11->SetBinError(13,2.593501);
   ...
   hmcerror__14->SetBinContent(1,288.0728);
   hmcerror__14->SetBinContent(2,762.3752);
   hmcerror__14->SetBinContent(3,605.3163);
   hmcerror__14->SetBinContent(4,410.8682);
   hmcerror__14->SetBinContent(5,283.0611);
   hmcerror__14->SetBinContent(6,172.5272);
   hmcerror__14->SetBinContent(7,108.6599);
   hmcerror__14->SetBinContent(8,63.00926);
   hmcerror__14->SetBinContent(9,44.74158);
   hmcerror__14->SetBinContent(10,35.23596);
   hmcerror__14->SetBinContent(11,32.22511);
   hmcerror__14->SetBinContent(12,28.65591);
   hmcerror__14->SetBinContent(13,214.895);
   hmcerror__14->SetBinError(1,94.2928);
   hmcerror__14->SetBinError(2,314.5139);
   hmcerror__14->SetBinError(3,242.1323);
   hmcerror__14->SetBinError(4,153.9487);
   hmcerror__14->SetBinError(5,96.59602);
   hmcerror__14->SetBinError(6,51.34661);
   hmcerror__14->SetBinError(7,34.36869);
   hmcerror__14->SetBinError(8,21.91844);
   hmcerror__14->SetBinError(9,15.652);
   hmcerror__14->SetBinError(10,14.97698);
   hmcerror__14->SetBinError(11,15.71754);
   hmcerror__14->SetBinError(12,12.16851);
   hmcerror__14->SetBinError(13,59.4794);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hbadmatch_stack_1","Cosmic, 72.3","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("houtFV_stack_4","Out FV, 184.0","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVcoh_stack_5","NC#pi^{0} COH,  4.8","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  964.1","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVdis_stack_8","NC#pi^{0} DIS,  214.6","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 261.7","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3020->SetMinimum(0.3384608);
   Graph_Graph3020->SetMaximum(1.233899);
