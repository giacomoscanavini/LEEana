void plot_check_xs(){
  ...
  // TVectorD *vec_mean_14 = (TVectorD*)file->Get("vec_mean_14");
  // TVectorD *vec_signal_14 = (TVectorD*)file->Get("vec_signal_14");
  // TMatrixD *mat_R_14 = (TMatrixD*)file->Get("mat_R_14");
  ...
  // // for (Int_t i=0;i!=pred_covch_1_R->GetNbinsX()+1;i++){
  // //   g3->SetPoint(i,i+1, (*vec_mean_14)[i]);
  // // }
  // // g3->Draw("*same");
