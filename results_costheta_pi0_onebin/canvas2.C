...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.307692,-4.876263,1.25641,410.8893);
   pad1->SetFillColor(0);
   ...
   TH1F *hmc__4 = new TH1F("hmc__4","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hmc__4->SetBinContent(1,243.8131);
   hmc__4->SetBinError(1,56.33406);
   hmc__4->SetBinError(2,0.125509);
   hmc__4->SetMinimum(-4.876263);
   hmc__4->SetMaximum(390.101);
   ...
   hs2_stack_2->SetMaximum(256.0038);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hbadmatch_stack_1->SetBinContent(1,4.129786);
   hbadmatch_stack_1->SetBinError(1,0.5747394);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hext_stack_2->SetBinContent(1,12.53732);
   hext_stack_2->SetBinError(1,1.45749);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hdirt_stack_3->SetBinContent(1,1.19145);
   hdirt_stack_3->SetBinError(1,0.3521235);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   houtFV_stack_4->SetBinContent(1,8.892303);
   houtFV_stack_4->SetBinError(1,0.7060518);
   ...
   TH1F *hNCpi0inFV_stack_5 = new TH1F("hNCpi0inFV_stack_5","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hNCpi0inFV_stack_5->SetBinContent(1,146.0189);
   hNCpi0inFV_stack_5->SetBinError(1,2.805523);
   ...
   TH1F *hCCpi0inFV_stack_6 = new TH1F("hCCpi0inFV_stack_6","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hCCpi0inFV_stack_6->SetBinContent(1,37.74147);
   hCCpi0inFV_stack_6->SetBinError(1,1.436704);
   ...
   TH1F *hNCinFV_stack_7 = new TH1F("hNCinFV_stack_7","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hNCinFV_stack_7->SetBinContent(1,12.5234);
   hNCinFV_stack_7->SetBinError(1,0.8215192);
   ...
   TH1F *hnumuCCinFV_stack_8 = new TH1F("hnumuCCinFV_stack_8","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hnumuCCinFV_stack_8->SetBinContent(1,19.97487);
   hnumuCCinFV_stack_8->SetBinError(1,1.3043);
   ...
   TH1F *hnueCCinFV_stack_9 = new TH1F("hnueCCinFV_stack_9","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hnueCCinFV_stack_9->SetBinContent(1,0.8036058);
   hnueCCinFV_stack_9->SetBinError(1,0.2020235);
   ...
   TH1F *hmcerror__5 = new TH1F("hmcerror__5","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
   hmcerror__5->SetBinContent(1,243.8131);
   hmcerror__5->SetBinError(1,56.33406);
   ...
   Graph_Graph3005->SetMinimum(141.012);
   Graph_Graph3005->SetMaximum(170.988);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=2.26/1","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3006->GetXaxis()->SetTitle("Reconstructed cos#theta");
   ...
   Graph_Graph3008->SetMinimum(0.578361);
   Graph_Graph3008->SetMaximum(0.7013075);
   ...
   TH1F *hist__6 = new TH1F("hist__6","NCpi0BDT_FC_Np_bnb_10_pi0_costheta_all",1,-1,1);
