...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.7692308,-42.07249,5.641026,4652.332);
   pad1->SetFillColor(0);
   ...
   TH1F *hmc__19 = new TH1F("hmc__19","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   hmc__19->SetBinContent(2,2103.625);
   hmc__19->SetBinContent(3,552.1459);
   hmc__19->SetBinContent(4,140.2523);
   hmc__19->SetBinContent(5,36.14194);
   hmc__19->SetBinContent(6,10.4839);
   hmc__19->SetBinError(1,0.3895343);
   hmc__19->SetBinError(2,552.6925);
   hmc__19->SetBinError(3,180.598);
   hmc__19->SetBinError(4,61.69801);
   hmc__19->SetBinError(5,26.29352);
   hmc__19->SetBinError(6,11.66334);
   hmc__19->SetMinimum(-42.07249);
   hmc__19->SetMaximum(4417.611);
   ...
   hs7_stack_7->SetMaximum(2208.806);
   ...
   TH1F *hbadmatch_stack_1 = new TH1F("hbadmatch_stack_1","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hext_stack_2 = new TH1F("hext_stack_2","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hdirt_stack_3 = new TH1F("hdirt_stack_3","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *houtFV_stack_4 = new TH1F("houtFV_stack_4","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hNCpi0inFVcoh_stack_5 = new TH1F("hNCpi0inFVcoh_stack_5","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hNCpi0inFVqe_stack_6 = new TH1F("hNCpi0inFVqe_stack_6","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hNCpi0inFVres_stack_7 = new TH1F("hNCpi0inFVres_stack_7","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hNCpi0inFVdis_stack_8 = new TH1F("hNCpi0inFVdis_stack_8","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hNCpi0inFVmec_stack_9 = new TH1F("hNCpi0inFVmec_stack_9","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hCCpi0inFV_stack_10 = new TH1F("hCCpi0inFV_stack_10","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hNCinFV_stack_11 = new TH1F("hNCinFV_stack_11","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hnumuCCinFV_stack_12 = new TH1F("hnumuCCinFV_stack_12","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hnueCCinFV_stack_13 = new TH1F("hnueCCinFV_stack_13","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   ...
   TH1F *hmcerror__20 = new TH1F("hmcerror__20","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
   hmcerror__20->SetBinContent(2,2103.625);
   hmcerror__20->SetBinContent(3,552.1459);
   hmcerror__20->SetBinContent(4,140.2523);
   hmcerror__20->SetBinContent(5,36.14194);
   hmcerror__20->SetBinContent(6,10.4839);
   hmcerror__20->SetBinError(1,0.3895343);
   hmcerror__20->SetBinError(2,552.6925);
   hmcerror__20->SetBinError(3,180.598);
   hmcerror__20->SetBinError(4,61.69801);
   hmcerror__20->SetBinError(5,26.29352);
   hmcerror__20->SetBinError(6,11.66334);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=0.72#pm0.20","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=1.3/5","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCpi0inFVres_stack_7","NC#pi^{0} RES,  1310.5","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("hNCinFV_stack_11","NC Other, 239.1","F");
   ...
   pt->SetLineWidth(2);
   pt->SetTextFont(132);
   TText *pt_LaTex = pt->AddText("NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all");
   pt->Draw();
   pad1->Modified();
   canvas7->cd();
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3028->SetMinimum(0.4976371);
   Graph_Graph3028->SetMaximum(10.94471);
   ...
   TH1F *hist__21 = new TH1F("hist__21","NCpi0BDT_FC_Np_bnb_12_p_multi_reco_all",5,0,5);
