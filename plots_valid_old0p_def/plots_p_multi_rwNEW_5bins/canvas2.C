...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.7692308,-58.92215,5.641026,6515.549);
   pad1->SetFillColor(0);
   ...
   hmc__4->SetBinContent(1,2946.107);
   hmc__4->SetBinContent(2,2103.625);
   hmc__4->SetBinContent(3,552.1459);
   hmc__4->SetBinContent(4,140.2523);
   hmc__4->SetBinContent(5,36.14194);
   hmc__4->SetBinContent(6,10.4839);
   hmc__4->SetBinError(1,690.2731);
   hmc__4->SetBinError(2,552.6925);
   hmc__4->SetBinError(3,180.598);
   hmc__4->SetBinError(4,61.69801);
   hmc__4->SetBinError(5,26.29352);
   hmc__4->SetBinError(6,11.66334);
   hmc__4->SetMinimum(-58.92215);
   hmc__4->SetMaximum(6186.826);
   ...
   hs2_stack_2->SetMaximum(3093.413);
   ...
   hmcerror__5->SetBinContent(1,2946.107);
   hmcerror__5->SetBinContent(2,2103.625);
   hmcerror__5->SetBinContent(3,552.1459);
   hmcerror__5->SetBinContent(4,140.2523);
   hmcerror__5->SetBinContent(5,36.14194);
   hmcerror__5->SetBinContent(6,10.4839);
   hmcerror__5->SetBinError(1,690.2731);
   hmcerror__5->SetBinError(2,552.6925);
   hmcerror__5->SetBinError(3,180.598);
   hmcerror__5->SetBinError(4,61.69801);
   hmcerror__5->SetBinError(5,26.29352);
   hmcerror__5->SetBinError(6,11.66334);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Graph3008->SetMinimum(0.5066584);
   Graph_Graph3008->SetMaximum(1.061918);
