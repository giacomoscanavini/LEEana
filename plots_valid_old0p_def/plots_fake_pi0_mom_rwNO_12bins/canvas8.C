...
// ------------>Primitives in pad: pad1
   ...
   hmc__22->SetBinError(1,18.5512);
   hmc__22->SetBinError(2,29.62302);
   hmc__22->SetBinError(3,28.385);
   hmc__22->SetBinError(4,22.2082);
   hmc__22->SetBinError(5,14.1642);
   hmc__22->SetBinError(6,10.1405);
   hmc__22->SetBinError(7,5.302089);
   hmc__22->SetBinError(8,4.716965);
   hmc__22->SetBinError(9,3.30692);
   hmc__22->SetBinError(10,3.269218);
   hmc__22->SetBinError(11,1.895649);
   hmc__22->SetBinError(12,1.883395);
   hmc__22->SetBinError(13,10.67271);
   ...
   hmcerror__23->SetBinError(1,18.5512);
   hmcerror__23->SetBinError(2,29.62302);
   hmcerror__23->SetBinError(3,28.385);
   hmcerror__23->SetBinError(4,22.2082);
   hmcerror__23->SetBinError(5,14.1642);
   hmcerror__23->SetBinError(6,10.1405);
   hmcerror__23->SetBinError(7,5.302089);
   hmcerror__23->SetBinError(8,4.716965);
   hmcerror__23->SetBinError(9,3.30692);
   hmcerror__23->SetBinError(10,3.269218);
   hmcerror__23->SetBinError(11,1.895649);
   hmcerror__23->SetBinError(12,1.883395);
   hmcerror__23->SetBinError(13,10.67271);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","#SigmaData/#SigmaPrediction=1.05#pm0.21","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(132);
   entry=leg->AddEntry("NULL","#chi^{2}/ndf=18.4/12","");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
