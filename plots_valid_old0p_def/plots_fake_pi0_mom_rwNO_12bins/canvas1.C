...
// ------------>Primitives in pad: pad1
   ...
   hmc__1->SetBinError(1,136.4135);
   hmc__1->SetBinError(2,341.3546);
   hmc__1->SetBinError(3,313.0454);
   hmc__1->SetBinError(4,220.8817);
   hmc__1->SetBinError(5,133.5989);
   hmc__1->SetBinError(6,78.09862);
   hmc__1->SetBinError(7,43.12941);
   hmc__1->SetBinError(8,26.64047);
   hmc__1->SetBinError(9,20.8903);
   hmc__1->SetBinError(10,14.07458);
   hmc__1->SetBinError(11,11.5573);
   hmc__1->SetBinError(12,9.882503);
   hmc__1->SetBinError(13,82.17945);
   ...
   hmcerror__2->SetBinError(1,136.4135);
   hmcerror__2->SetBinError(2,341.3546);
   hmcerror__2->SetBinError(3,313.0454);
   hmcerror__2->SetBinError(4,220.8817);
   hmcerror__2->SetBinError(5,133.5989);
   hmcerror__2->SetBinError(6,78.09862);
   hmcerror__2->SetBinError(7,43.12941);
   hmcerror__2->SetBinError(8,26.64047);
   hmcerror__2->SetBinError(9,20.8903);
   hmcerror__2->SetBinError(10,14.07458);
   hmcerror__2->SetBinError(11,11.5573);
   hmcerror__2->SetBinError(12,9.882503);
   hmcerror__2->SetBinError(13,82.17945);
